...
**Melee**: A vampire gains a slam attack if the base creature didn’t have one. Damage for the slam depends on the vampire’s size (*Pathfinder Roleplaying Game Bestiary* 301–302). Its slam also causes energy drain (see below). Its natural weapons are treated as magic weapons for the purpose of overcoming damage reduction.
...
*Blood Drain (Su)*: A vampire can suck blood from a [[Grappled|grappled]] opponent; if the vampire establishes or maintains a pin, it drains blood, dealing 1d4 points of Constitution damage. The vampire heals 5 hit points or gains 5 temporary hit points for 1 hour (up to a maximum number of temporary hit points equal to its full normal hit points) each round it drains blood.
...
*Dominate (Su)*: A vampire can crush a humanoid opponent’s will as a standard action. Anyone the vampire targets must succeed on a Will save or fall instantly under the vampire’s influence, as though by a *[[Dominate Person (Spell)|dominate person]]* spell (caster level 12th). The ability has a range of 30 feet. At the GM’s discretion, some vampires might be able to affect different creature types with this power.
...
*Change Shape (Su)*: A vampire can use change shape to assume the form of a dire bat or wolf, as *[[Beast Shape II (Spell)|beast shape II]]*.

*Gaseous Form (Su)*: As a standard action, a vampire can assume *[[Gaseous Form (Spell)|gaseous form]]* speed of 20 feet with perfect maneuverability.

*Shadowless (Ex)*: A vampire casts no shadows and shows no reflection in a mirror.

*Spider Climb (Ex)*: A vampire can climb sheer surfaces as though under the effects of a *[[Spider Climb (Spell)|spider climb]]* spell.

**Ability Scores** Str +6, Dex +4, Int +2, Wis +2, Cha +4. As an undead creature, a vampire has no Constitution score.

**Skills** Vampires gain a +8 racial bonus on [[Bluff (Skill)|Bluff]], [[Perception (Skill)|Perception]], [[Sense Motive (Skill)|Sense Motive]], and [[Stealth (Skill)|Stealth]] checks.

**Feats** Vampires gain [[Alertness (Feat)|Alertness]], [[Combat Reflexes (Feat)|Combat Reflexes]], [[Dodge (Feat)|Dodge]], [[Improved Initiative (Feat)|Improved Initiative]], [[Lightning Reflexes (Feat)|Lightning Reflexes]], and [[Toughness (Feat)|Toughness]] as bonus feats.
...
Jason Bulmahn. *Pathfinder Roleplaying Game Bestiary.* Paizo Publishing, LLC. 2010 

**Additional Materials:**

Stuart Renton. *The Lords of Night: Vampires*. Bottled Imp Games. 2004

Peter M. Ball. *After Sunset Vampires.* Clockwork Golem Workshop. 2005

Mark Charke. *Complete Guide to Vampires*. Goodman Games. 2004

Jim Bishop. *Fang and Fury: A Guidebook to Vampires.* Green Ronin Publishing. 2003

Alex Riggs. *Liber Vampyr*. Necromancers of the Northwest, LLC. 2010

Alex Riggs, Joshua Zaback. *Scions of the Vampire: Blood, Shadow, and Smoke.* Necromancers of the Northwest, LLC. 2014


---
## Tags
#Sources/Bestiary-1 #Rule-System/Pathfinder #Rule/OGL #Publisher/Paizo #Rule/Core #Rule/Template
