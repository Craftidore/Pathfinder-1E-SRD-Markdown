...
**Using Drift Magic:** To use drift magic, a character must merely keep in mind her special knowledge of the desert. No checks are required. In natural areas of sand, dust, or ash, a practitioner can use drift magic as a free action. Other areas require the practitioner to expend a move action to utilize drift magic. Spells with a casting time of longer than 1 standard action cannot benefi t from drift magic.
...
---
## Tags
#Sources/Sandstorm #Rule-System/Pathfinder #Rule/NonOGL #Rule/3PP #Publisher/WotC
