...
If you have the [[Animal Affinity (Feat)|Animal Affinity]] feat, you get a bonus on Ride checks (see Chapter 5 of the *Pathfinder Core Rulebook*).

If you use a military saddle you get a +2 circumstance bonus on Ride checks related to staying in the saddle. 

Ride is a prerequisite for [[Mounted Archery (Feat)|Mounted Archery]], [[Mounted Combat (Feat)|Mounted Combat]], [[Ride-By Attack (Feat)|Ride-By Attack]], [[Spirited Charge (Feat)|Spirited Charge]], and [[Trample (Feat)|Trample]].
