...
In addition, a druid’s or ranger’s animal companion knows one or more bonus tricks, which don’t count against the normal limit on tricks known and don’t require any training time or Handle Animal checks to teach. If you have the [[Animal Affinity (Feat)|Animal Affinity]] feat, you get a bonus on Handle Animal checks (see Chapter 5 of the PFRG Core Rulebook 1).
...
**Source:** Complete Adventurer (WotC), pg. 100
