...
If you have the [[Self-Sufficient (Feat)|Self-Sufficient]] feat, you get a bonus on Survival checks (see Chapter 5 of the *Pathfinder Core Rulebook*).

You can tie knots more quickly than normal.

**Quick Knot-Tying:** You can try to tie a knot, a special knot, or a rope around yourself more quickly than normal. By accepting a –10 penalty on your Survival (v3.5 Use Rope) check, you can accomplish any one of these tasks as a move action (rather than a full-round action).

**Source:** Complete Adventurer (WotC), pg. 103
