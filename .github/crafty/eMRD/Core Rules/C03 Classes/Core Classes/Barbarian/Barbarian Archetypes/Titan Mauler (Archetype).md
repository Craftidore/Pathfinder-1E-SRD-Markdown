...
**Jotungrip (Ex)**: At 2nd level, a titan mauler may choose to wield a two-handed weapon in one hand with a –2 penalty on attack rolls while doing so. The weapon must be appropriately sized for her, and it is treated as one-handed when determining the effect of [[Power Attack (Feat)|Power Attack]], Strength bonus to damage, and the like. This ability replaces uncanny dodge.
...
**Titanic Rage (Su)**: At 14th level, a titan mauler may choose to gain the benefits of *[[Enlarge Person (Spell)|enlarge person]]* when she enters a rage. While using titanic rage, she must spend 2 rounds of rage per round, and she becomes [[Exhausted|exhausted]] rather than [[Fatigued|fatigued]] when the rage ends. This ability replaces indomitable will.
...
---
## Tags
#Rule-System/Pathfinder #Publisher/Paizo #Rule/Core #Rule/Archetype #Rule/Barbarian #Sources/Ultimate-Combat
