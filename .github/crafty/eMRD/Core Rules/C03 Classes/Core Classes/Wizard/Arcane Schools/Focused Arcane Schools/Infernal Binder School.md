...
**Planar Knowledge (Ex)**: As an infernal binder, you gain a +3 bonus on [[Knowledge (Skill)|Knowledge]] (planes) checks.
...
**Imp Familiar (Ex)**: At 7th level, you gain [[Improved Familiar (Feat)|Improved Familiar]] as a bonus feat, and must take an [[Devil, Imp (Bestiary 1)|imp]] as a familiar. The [[Devil, Imp (Bestiary 1)|imp]] replaces your current familiar.

**Source:** Inner Sea Primer, pg. 29
