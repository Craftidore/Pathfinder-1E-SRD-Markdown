...
**Parent Classes**: [[Fighter]] and [[Gunslinger|gunslinger]].

**Starting Wealth**: 5d6 × 10 gp (average 175 gp).

**Class Skills**

The swashbuckler’s class skills are [[Acrobatics (Skill)|Acrobatics]] (Dex), [[Bluff (Skill)|Bluff]] (Cha), [[Climb (Skill)|Climb]] (Str), [[Craft (Skill)|Craft]] (Int), [[Diplomacy (Skill)|Diplomacy]] (Cha), [[Escape Artist (Skill)|Escape Artist]] (Dex), [[Intimidate (Skill)|Intimidate]] (Cha), [[Knowledge (Skill)|Knowledge]] (local) (Int), [[Knowledge (Skill)|Knowledge]] (nobility) (Int), [[Perception (Skill)|Perception]] (Wis), [[Perform (Skill)|Perform]] (Cha), [[Profession (Skill)|Profession]] (Wis), [[Ride (Skill)|Ride]] (Dex), [[Sense Motive (Skill)|Sense Motive]] (Wis), [[Sleight of Hand (Skill)|Sleight of Hand]] (Dex), and [[Swim (Skill)|Swim]] (Str).

**Skill Ranks per Level**: 4 + Int modifier.

**Table 1–13: Swashbuckler**
...
*Derring-Do (Ex)*: At 1st level, a swashbuckler can spend 1 panache point when she makes an [[Acrobatics (Skill)|Acrobatics]], [[Climb (Skill)|Climb]], [[Escape Artist (Skill)|Escape Artist]], [[Fly (Skill)|Fly]], [[Ride (Skill)|Ride]], or [[Swim (Skill)|Swim]] check to roll 1d6 and add the result to the check. She can do this after she makes the check but before the result is revealed. If the result of the d6 roll is a natural 6, she rolls another 1d6 and adds it to the check. She can continue to do this as long as she rolls natural 6s, up to a number of times equal to her Dexterity modifier (minimum 1).
...
*Menacing Swordplay (Ex)*: At 3rd level, while she has at least 1 panache point, when a swashbuckler hits an opponent with a light or one-handed piercing melee weapon, she can choose to use [[Intimidate (Skill)|Intimidate]] to demoralize that opponent (*Pathfinder RPG Core Rulebook* 99) as a swift action instead of a standard action.
...
*Swashbuckler Initiative (Ex)*: At 3rd level, while the swashbuckler has at least 1 panache point, she gains a +2 bonus on initiative checks. In addition, if she has the [[Quick Draw (Feat)|Quick Draw]] feat, her hands are free and unrestrained, and she has any single light or one-handed piercing melee weapon that isn’t hidden, she can draw that weapon as part of the initiative check.

*Swashbuckler’s Grace (Ex)*: At 7th level, while the swashbuckler has at least 1 panache point, she takes no penalty for moving at full speed when she uses [[Acrobatics (Skill)|Acrobatics]] to attempt to move through a threatened area or an enemy’s space.
...
- *Head*: The target is [[Confused|confused]] for 1 round. This is a mind-affecting effect.
...
- *Torso or Wings*: The target is [[Staggered|staggered]] for 1 round.
...
*Swashbuckler’s Edge (Ex)*: At 15th level, while the swashbuckler has at least 1 panache point, she can take 10 on any [[Acrobatics (Skill)|Acrobatics]], [[Climb (Skill)|Climb]], [[Escape Artist (Skill)|Escape Artist]], [[Fly (Skill)|Fly]], [[Ride (Skill)|Ride]], or [[Swim (Skill)|Swim]] check, even while distracted or in immediate danger. She can use this ability in conjunction with the derring-do deed.
...
*Deadly Stab (Ex)*: At 19th level, when the swashbuckler confirms a critical hit with a light or one-handed piercing melee weapon, in addition to the normal damage, she can spend 1 panache point to inf lict a deadly stab. The target must succeed at a Fortitude saving throw or die. The DC of this save is 10 + 1/2 the swashbuckler’s level + the swashbuckler’s Dexterity modifier. This is a death attack. Performing this deed does not grant the swashbuckler a panache point.

*Stunning Stab (Ex)*: At 19th level, when a swashbuckler hits a creature with a light or one-handed piercing melee weapon, she can spend 2 panache points to stun the creature for 1 round. The creature must succeed at a Fortitude saving throw (DC = 10 + 1/2 the swashbuckler’s level + the swashbuckler’s Dexterity modifier) or be [[Stunned|stunned]] for 1 round. Creatures that are immune to critical hits are also immune to this effect.
...
**Swashbuckler Weapon Training (Ex)**: At 5th level, a swashbuckler gains a +1 bonus on attack and damage rolls with one-handed or light piercing melee weapons. While wielding such a weapon, she gains the benefit of the [[Improved Critical (Feat)|Improved Critical]] feat. These attack and damage bonuses increase by 1 for every 4 levels beyond 5th level (to a maximum of +4 at 17th level).
...
## Swashbuckler Build notes
Swashbuckler Build notes

[[Inspired Blade (Archetype)|Inspired blade]] (archetype)

   > [[Weapon Finesse (Feat)|Weapon finesse]]

   > [[Weapon Focus (Feat)|Weapon focus]] ([[Rapier|rapier]]) bonus feat

Heirloom weapon trait (+1 trait bonus to attack rolls)

Possible feats

   [[Combat Reflexes (Feat)|Combat Reflexes]] (tree)

   [[Extra Finesse (Feat)|Extra finesse]] (dex for dmg)

   [[Fencing Grace (Feat)|Fencing grace]]

   Piranha strike

   [[Deep Lunge (Feat)|Deep lunge]] or [[Lunge (Feat)|lunge]]

   Unarmored Defense Proficiency (tree)

   Outflank

   Attack with Opposition (Art of the Duel 4, *Sinister Adventures*)

   Challenge to a Duel (Art of the Duel 4, *Sinister Adventures*) 

   Cloaked Duelist (Art of the Duel 4, *Sinister Adventures*) 

   Come to Grips (Art of the Duel 4, *Sinister Adventures*)

   Dagger Defense (Art of the Duel 5, *Sinister Adventures*) 

   [[Deep Lunge (Feat)|Deep Lunge]] (Art of the Duel 5, *Sinister Adventures*) 

   Defensive Parry (Art of the Duel 4, *Sinister Adventures*) 

   Defensive Swordplay (Art of the Duel 5, *Sinister Adventures*)

   Responsive Duelist (Art of the Duel 5, *Sinister Adventures*) 

   Riposte (Art of the Duel 5, *Sinister Adventures*)

   Stop-thrust (Art of the Duel 5, *Sinister Adventures*)

   Counterattack (Swashbuckling Adventures 131, *AEG*)

   Dashing and Daring (Swashbuckling Adventures 131, *AEG*)

   Deflect Missile I (Swashbuckling Adventures 132, *AEG*)

   Flurry of Strikes (Swashbuckling Adventures 133, *AEG*)

   Legendary Trait (Swashbuckling Adventures 136, *AEG*)

   Lethal Strike (Swashbuckling Adventures 136, *AEG*)

   Parry (Swashbuckling Adventures 139, *AEG*)

   Riposte (Swashbuckling Adventures 141, *AEG*)

   Six Fingers(Swashbuckling Adventures 142, *AEG*)

   [[Tagging (Feat)|Tagging]] (Swashbuckling Adventures 144, *AEG*)

   Weapon Expert (Swashbuckling Adventures 147, *AEG*)

   Weapon Master (Swashbuckling Adventures 131, *AEG*)

   Signature Weapon (Adventuring Classes: A Fistful of Denarii)

   Signature Strike Style (People of the Wastes 10)

   [[Leadership (Feat)|Leadership]] !!! or [[Torchbearer (Feat)|Torchbearer]]
...
**Flashing Blade \[Combat]** 
You can use a light melee weapon with exceptional speed. 
Prerequisites: [[Weapon Finesse (Feat)|Weapon Finesse]], [[Weapon Focus (Feat)|Weapon Focus]], Dex 15+, BAB 4+ 
Benefit: Select a one-handed Finessable melee weapon for which you have [[Weapon Focus (Feat)|Weapon Focus]]. When making a full attack with this weapon with nothing in the other hand, you can make one extra attack per round. The attack is at your highest base attack bonus, but all attacks suffer a -2 penalty. 
Stackable; applies to a different weapon each time. 
A fighter may select this as a bonus feat. 

**Source:** Paizo forums ([https://paizo.com/threads/rzs2qg2o?Tell-the-Devs-we-want-Fencing-Style-Feats-here](https://paizo.com/threads/rzs2qg2o?Tell-the-Devs-we-want-Fencing-Style-Feats-here)<u>)</u>

Possible gear/enhancements

   [[Agile (MagWpnSpcAb)|Agile]] weapon ability?

   [[Keen (MagWpnSpcAb)|Keen]] weapon ability?

   Laminated/tempered

Spells

   Overcompensation (Rite Publishing)

   Weapons Storm (Rite Publishing)

Items

   Effortless lace (Fat Goblin Games)
