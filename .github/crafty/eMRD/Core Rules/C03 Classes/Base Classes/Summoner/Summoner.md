...
The summoner’s class skills are [[Craft (Skill)|Craft]] (Int), [[Fly (Skill)|Fly]] (Dex), [[Handle Animal (Skill)|Handle Animal]] (Cha), [[Knowledge (Skill)|Knowledge]] (all) (Int), [[Linguistics (Skill)|Linguistics]] (Int), [[Profession (Skill)|Profession]] (Wis), [[Ride (Skill)|Ride]] (Dex), [[Spellcraft (Skill)|Spellcraft]] (Int), and [[Use Magic Device (Skill)|Use Magic Device]] (Cha).
...
| 1st | +0 | +0 | +0 | +2 | Cantrips, eidolon, life link, *[[Summon Monster I (Spell)\|summon monster I]]* | 1 | — | — | — | — | — |
| 2nd | +1 | +0 | +0 | +3 | Bond senses | 2 | — | — | — | — | — |
| 3rd | +2 | +1 | +1 | +3 | *[[Summon Monster II (Spell)\|Summon monster II]]* | 3 | — | — | — | — | — |
| 4th | +3 | +1 | +1 | +4 | Shield ally | 3 | 1 | — | — | — | — |
| 5th | +3 | +1 | +1 | +4 | *[[Summon Monster III (Spell)\|Summon monster III]]* | 4 | 2 | — | — | — | — |
| 6th | +4 | +2 | +2 | +5 | Maker's call | 4 | 3 | — | — | — | — |
| 7th | +5 | +2 | +2 | +5 | *[[Summon Monster IV (Spell)\|Summon monster IV]]* | 4 | 3 | 1 | — | — | — |
| 8th | +6/+1 | +2 | +2 | +6 | Transposition | 4 | 4 | 2 | — | — | — |
| 9th | +6/+1 | +3 | +3 | +6 | *[[Summon Monster V (Spell)\|Summon monster V]]* | 5 | 4 | 3 | — | — | — |
| 10th | +7/+2 | +3 | +3 | +7 | Aspect | 5 | 4 | 3 | 1 | — | — |
| 11th | +8/+3 | +3 | +3 | +7 | *[[Summon Monster VI (Spell)\|Summon monster VI]]* | 5 | 4 | 4 | 2 | — | — |
| 12th | +9/+4 | +4 | +4 | +8 | Greater shield ally | 5 | 5 | 4 | 3 | — | — |
| 13th | +9/+4 | +4 | +4 | +8 | *[[Summon Monster VII (Spell)\|Summon monster VII]]* | 5 | 5 | 4 | 3 | 1 | — |
| 14th | +10/+5 | +4 | +4 | +9 | Life bond | 5 | 5 | 4 | 4 | 2 | — |
| 15th | +11/+6/+1 | +5 | +5 | +9 | *[[Summon Monster VIII (Spell)\|Summon monster VIII]]* | 5 | 5 | 5 | 4 | 3 | — |
| 16th | +12/+7/+2 | +5 | +5 | +10 | Merge forms | 5 | 5 | 5 | 4 | 3 | 1 |
| 17th | +12/+7/+2 | +5 | +5 | +10 | *[[Summon Monster IX (Spell)\|Summon monster IX]]* | 5 | 5 | 5 | 4 | 4 | 2 |
| 18th | +13/+8/+3 | +6 | +6 | +11 | Greater aspect | 5 | 5 | 5 | 5 | 4 | 3 |
| 19th | +14/+9/+4 | +6 | +6 | +11 | *[[Gate (Spell)\|Gate]]* | 5 | 5 | 5 | 5 | 5 | 4 |
...
**Spells**: A summoner casts arcane spells drawn from the summoner spell list (see page 64). He can cast any spell he knows without preparing it ahead of time, assuming he has not yet used up his allotment of spells per day for the spell’s level.
...
**Table 2-8: Summoner Spells Known**
...
***Summon Monster I* (Sp)**: Starting at 1st level, a summoner can cast *[[Summon Monster I (Spell)|summon monster I]]* as a spell-like ability a number of times per day equal to 3 + his Charisma modifier. Drawing upon this ability uses up the same power as the summoner uses to call his eidolon. As a result, he can only use this ability when his eidolon is not summoned. He can cast this spell as a standard action and the creatures remain for 1 minute per level (instead of 1 round per level). At 3rd level, and every 2 levels thereafter, the power of this ability increases by one spell level, allowing him to summon more powerful creatures (to a maximum of *[[Summon Monster IX (Spell)|summon monster IX]]* at 17th level). At 19th level, this ability can be used as *[[Gate (Spell)|gate]]* or *[[Summon Monster IX (Spell)|summon monster IX]]*. If used as *[[Gate (Spell)|gate]]*, the summoner must pay any required material components. A summoner cannot have more than one *summon monster* or *[[Gate (Spell)|gate]]* spell active in this way at one time. If this ability is used again, any existing *summon monster* or *[[Gate (Spell)|gate]]* immediately ends. These summon spells are considered to be part of his spell list for the purposes of spell trigger and spell completion items. In addition, he can expend uses of this ability to fufill the construction requirements of any magic item he creates, so long as he can use this ability to cast the required spell.
...
**Shield Ally (Ex)**: At 4th level, whenever a summoner is within his eidolon’s reach, the summoner receives a +2 shield bonus to his Armor Class and a +2 circumstance bonus on his saving throws. This bonus does not apply if the eidolon is [[Grappled|grappled]], [[Helpless|helpless]], [[Paralyzed|paralyzed]], [[Stunned|stunned]], or [[Unconscious|unconscious]].

**Maker’s Call (Su)**: At 6th level, as a standard action, a summoner can call his eidolon to his side. This functions as *[[Dimension Door (Spell)|dimension door]]*, using the summoner’s caster level. When used, the eidolon appears adjacent to the summoner (or as close as possible if all adjacent spaces are occupied). If the eidolon is out of range, the ability is wasted. The summoner can use this ability once per day at 6th level, plus one additional time per day for every four levels beyond 6th.
...
**Greater Shield Ally (Su)**: At 12th level, whenever an ally is within an eidolon’s reach, the ally receives a +2 shield bonus to its Armor Class and a +2 circumstance bonus on its saving throws. If this ally is the summoner, these bonuses increase to +4. This bonus does not apply if the eidolon is [[Grappled|grappled]], [[Helpless|helpless]], [[Paralyzed|paralyzed]], [[Stunned|stunned]], or [[Unconscious|unconscious]].

**Life Bond (Su)**: At 14th level, a summoner’s life becomes linked to his eidolon’s. As long as the eidolon has 1 or more hit points, the summoner cannot be killed. Damage in excess of that which would kill the summoner is instead transferred to the eidolon. This damage is transferred 1 point at a time, meaning that as soon as the eidolon is reduced to a number of negative hit points equal to its Constitution score, all excess damage remains with the summoner, killing him. Effects that cause death but not damage are unaffected by this ability. This ability does not affect spells like *[[Baleful Polymorph (Spell)|baleful polymorph]]*,* [[Flesh to Stone (Spell)|flesh to stone]]*, or *[[Imprisonment (Spell)|imprisonment]]*, or other spells that do not cause actual damage.
...
**Table 2–9: Eidolon Base Statistics**
...
| 9th | 7 | +7 | +5 | +2 | 28 | 4 | +6 | +3 | 13 | 5 | [[Multiattack (Bestiary 6 Apx)\|Multiattack]] |
...
| 14th | 11 | +11 | +7 | +3 | 44 | 6 | +10 | +5 | 19 | 6 | [[Improved Evasion\|Improved evasion]] |
...
*Multiattack*: An eidolon gains [[Multiattack (Bestiary 6 Apx)|Multiattack]] as a bonus feat if it has 3 or more natural attacks and does not already have that feat. If it does not have the requisite 3 or more natural attacks (or it is reduced to less than 3 attacks), the eidolon instead gains a second attack with one of its natural weapons, albeit at a –5 penalty. If the eidolon later gains 3 or more natural attacks, it loses this additional attack and instead gains [[Multiattack (Bestiary 6 Apx)|Multiattack]].

*Improved Evasion (Ex)*: When subjected to an attack that allows a Ref lex saving throw for half damage, an eidolon takes no damage if it makes a successful saving throw and only half damage if the saving throw fails.

**Eidolon Skills**

The following skills are class skills for eidolons: [[Bluff (Skill)|Bluff]] (Cha), [[Craft (Skill)|Craft]] (Int), [[Knowledge (Skill)|Knowledge]] (planes) (Int), [[Perception (Skill)|Perception]] (Wis), [[Sense Motive (Skill)|Sense Motive]] (Wis), and [[Stealth (Skill)|Stealth]] (Dex). In addition, at 1st level, the summoner can choose 4 additional skills to be class skills for his eidolon. Note that eidolons with a fly speed receive [[Fly (Skill)|Fly]] (Dex) as a free class skill, even if they do not gain a fly speed until a later level.
...
Alternatively, any one of these base forms can be used to make a Small eidolon. If the eidolon is Small, it gains a +2 bonus to its Dexterity score. It also takes a –4 penalty to its Strength and a –2 penalty to its Constitution. It also gains a +1 size bonus to its AC and attack rolls, a –1 penalty to its CMB and CMD scores, a +2 bonus on its [[Fly (Skill)|Fly]] skill checks, and a +4 bonus on its [[Stealth (Skill)|Stealth]] skill checks. Reduce the damage of all of its attacks by one step (1d6 becomes 1d4, 1d4 becomes 1d3). If this choice is made, the eidolon can be made Medium whenever the summoner can change the eidolon’s evolution pool (which causes it to lose these modifiers for being Small).
...
*Compression (Ex):* The eidolon can move through an area as small as one-quarter of its space without squeezing, or one-eighth its space while squeezing.

*Diseased (Ex):* The eidolon’s natural attack carries a disease. The eidolon must have the bite evolution to take this evolution. Whenever the eidolon’s bite attack hits, the target is diseased.

**Eidolon Disease**–type disease (injury); save Fort negates (see below for DC); onset 1d3 days; frequency 1/day; effect 1d2 Str damage and [[Dazzled|dazzled]] for 1 day; cure 2 consecutive saves.

The save DC for this disease is equal to 10 + half the eidolon’s Hit Dice + the eidolon’s Constitution modifier.

For an additional 2 evolution points, this disease deals 1d2 points of Constitution damage instead.

**Source:** Class Acts: Summoners (Abandoned Arts), pg. 2
...
*Stench (Ex):* The eidolon secretes a foul odor. All living creatures (except other creatures with this ability) within 30 feet must succeed on a Fortitude saving throw or be [[Sickened|sickened]] for 10 rounds. The save DC for this effect is equal to 10 + half the eidolon’s Hit Dice + the eidolon’s Constitution modifier. Any creature that successfully saves cannot be affected by the same eidolon’s stench for 24 hours. A *[[Delay Poison (Spell)|delay poison]]* or *[[Neutralize Poison (Spell)|neutralize poison]]* spell or effect removes the [[Sickened|sickened]] effect. Creatures with immunity to poison are unaffected, and creatures resistant to poison receive the usual bonus on their saving throws.

*Sticy Tongue (Ex):* The eidolon gains a sticky tongue attack with a reach 5 feet longer than his natural reach. This attack is a secondary attack and deals 1d2 points of bludgeoning damage (1d3 if Large, 1d4 if Huge). An eidolon with the pull evolution gains a +2 bonus on CMB checks made to use that ability with this natural attack.
...
*Tail (Ex)*: An eidolon grows a long, powerful tail. This grants it a +2 racial bonus on [[Acrobatics (Skill)|Acrobatics]] checks made to balance on a surface. This evolution can be selected more than once.
...
*Freeze (Ex):* The eidolon’s hide bears a close resemblance to stone or some other material or mineral. The eidolon can hold itself so still that it appears to be an inanimate object of the appropriate shape or size (a statue, a patch of vegetation, and so on). The eidolon can take 20 on its [[Stealth (Skill)|Stealth]] skill check to hide in plain sight as this kind of object.
...
*Mimicry (Ex):* The eidolon can perfectly imitate specific sounds and voices by making a [[Bluff (Skill)|Bluff]] skill check opposed by each listener’s [[Sense Motive (Skill)|Sense Motive]] skill check to recognize the mimicry. Listeners familiar with the sound gain a +8 bonus on their [[Sense Motive (Skill)|Sense Motive]] skill check, while unfamiliar listeners take a -8 penalty.
...
*Spines (Ex):* The eidolon’s back, tail, arms, or some other body part is covered in deadly spines, which can be flung in projectile fashion as a standard action. With a single volley, the eidolon can fling as many spines as its maximum limitation on natural attacks per round allows. These attacks are primary ranged attacks, and each spine deals 1d6 points of piercing damage (1d8 if Large, 2d6 if Huge). Each spine has a range of 100 feet with no range increment, and each target must be within 30 feet of each other target. Finally, the eidolon can launch only 24 spines in any 24-hour period.

For an additional evolution point, the eidolon may increase the 24-spines-per-day limit by an additional 24 spines.

**Source:** Class Acts: Summoners (Abandoned Arts), pg. 2

*Trample (Ex)*: An eidolon gains the ability to crush its foes underfoot, gaining the trample ability. As a full-round action, the eidolon can overrun any creature that is at least one size smaller than itself. This works like the overrun combat maneuver, but the eidolon does not need to make a check, it merely has to move over opponents in its path. The creatures take 1d6 points of damage (1d8 if Large, 2d6 if Huge), plus 1-1/2 times the eidolon’s Strength modifier. Targets of the trample can make attacks of opportunity at a –4 penalty. If a target forgoes the attack of opportunity, it can make a Ref lex save for half damage. The DC of this save is 10 + 1/2 the eidolon’s HD + the eidolon’s Strength modifier. A trampling eidolon can only deal trampling damage to a creature once per round. This evolution is only available to eidolons of the biped or quadruped base forms.
...
*Capsize (Ex):* The eidolon can attempt to capsize a boat or ship by ramming it with a charge attack and making a combat maneuver check with a DC of 25, or the result of the captain’s [[Profession (Skill)|Profession]] (sailor) skill check, whichever is higher. For each size category that the ship is larger than the eidolon, the eidolon takes a cumulative -10 penalty on this combat maneuver check. The eidolon must have both the large and swim evolutions to take this evolution.

**Source:** Class Acts: Summoners (Abandoned Arts), pg. 3
...
*Frightful Presence (Ex)*: An eidolon becomes unsettling to its foes, gaining the frightful presence ability. The eidolon can activate this ability as part of an offensive action, such as a charge or attack. Opponents within 30 feet of the eidolon must make a Will save or become [[Shaken|shaken]] for 3d6 rounds. The DC of this save is equal to 10 + 1/2 the eidolon’s HD + the eidolon’s Charisma modifier. If the eidolon has at least 4 more Hit Dice than an opponent, that opponent becomes [[Frightened|frightened]] instead. Foes with more HD than the eidolon are immune to this effect. The summoner must be at least 11th level before selecting this evolution.

*Quills (Ex):* The eidolon gains a primary quill slap attack. This attack deals 1d3 points of damage and may cause a quill to break off in the target’s flesh, causing great pain. Whenever a creature takes damage from the eidolon’s quill slap, that creature must succeed on a Reflex saving throw or have one quill break off in its flesh. The save DC for this effect is equal to 10 + half the eidolon’s Hit Dice + the eidolon’s Dexterity modifier. Removing a quill requires a DC 15 [[Heal (Skill)|Heal]] skill check performed as a full-round action. For every 5 points by which this DC check is exceeded, one additional quill can be removed. On a failed check, one quill is still removed, but the process deals 1d4 points of damage to the victim. As long as a creature suffers from at least one quill, that creature gains the [[Sickened|sickened]] condition.

*Resilient (Su):* The eidolon is supernaturally resistant to harm and ill fortune, gaining a +1 resistance bonus on all saving throws.

*Rock Catching (Ex):* The eidolon can catch rocks of up to Large size (including other projectiles of similar shape, such as a catapult’s payload). Once per round, the eidolon can attempt a Reflex saving throw to catch such a projectile that would normally hit it. The DC of this saving throw is equal to the attack roll of the projectile to be caught. The eidolon must be aware of such an attack in order to attempt to catch it. The eidolon must have both the large and rock throwing evolutions to take this evolution.

*Rock Throwing (Ex):* The eidolon is a talented rock thrower, and gains a +1 racial bonus on ranged attack rolls with thrown rocks. The eidolon can hurl a rock or rock-like projectile (such as a catapult’s payload) that is up to two size categories smaller than its size with a range increment of 20 feet. A thrown rock deals 4d6 points of damage (6d6 if Huge), adding one and a half times the eidolon’s Strength modifier. Throwing a rock requires two hands. The eidolon must have the large evolution to take this evolution.

**Source:** Class Acts: Summoners (Abandoned Arts), pg. 3

*Swallow Whole (Ex)*: An eidolon gains the swallow whole ability, giving it the ability to consume its foes. If the eidolon begins its turn with a creature [[Grappled|grappled]] using its bite attack (see the grab evolution), it can attempt a combat maneuver check to swallow the creature. The creature can be up to one size category smaller than the eidolon. Swallowed creatures take damage equal to the eidolon’s bite damage each round plus 1d6 points of bludgeoning damage. A swallowed creature keeps the [[Grappled|grappled]] condition, but can attempt to cut its way free with a light slashing or piercing weapon. The amount of damage needed to cut free is equal to 1/10 the eidolon’s total hit points. The eidolon’s AC against these attacks is equal to 10 + 1/2 its natural armor bonus. If a swallowed creature cuts its way out, the eidolon loses this ability until it heals this damage. Alternatively, the swallowed creature can attempt to escape the grapple as normal. Success indicates that it has returned to the eidolon’s mouth, where it can attempt to escape or be swallowed again. The eidolon must possess the grab evolution, tied to a bite attack, to take this evolution. The summoner must be at least 9th level before selecting this evolution.

*Web (Ex)*: An eidolon gains a pair of spinnerets, giving it the ability to spin webs. The eidolon can use these webs to support itself plus up to one creature of the same size. It can throw webbing as a ranged touch attack up to 8 times per day, entangling a creature up to one size larger than the eidolon. The webbing has a range of 50 feet and a 10-foot range increment. Creatures entangled by the web can escape with an [[Escape Artist (Skill)|Escape Artist]] check or a Strength check (at a –4 penalty). The DC of these checks is equal to 10 + 1/2 the eidolon’s HD + the eidolon’s Con modifier. The webs have a Hardness of 0 and a number of hits points equal to the eidolon’s total Hit Dice. The eidolon can climb its own webs at its climb speed and can pinpoint any creature touching its webs. The eidolon must possess the climb evolution to take this evolution. The summoner must be at least 7th level before selecting this evolution.
...
*Amorphous (Ex):* The eidolon’s body is malleable and shapeless. It is immune to precision damage (such as sneak attacks) and to critical hits. The eidolon must have the compression evolution and either the aquatic or serpentine base form to take this evolution. The summoner must be at least 9th level before selecting this evolution.
...
*Breath Weapon (Su)*: An eidolon learns to exhale a cone or line of magical energy, gaining a breath weapon. Select either acid, cold, electricity, or fire. The eidolon can breathe a 30-foot cone (or 60-foot line) that deals 1d6 points of damage of the selected type per HD it possesses. Those caught in the breath weapon can attempt a Ref lex save for half damage. The DC is equal to 10 + 1/2 the eidolon’s HD + the eidolon’s Constitution modifier. The eidolon can use this ability once per day. The eidolon can use this ability 1 additional time per day by spending an additional 1 evolution point (maximum 3/day). The summoner must be at least 9th level before selecting this evolution.
...
*Quill Defense (Ex):* The eidolon’s sharp quills comprise a prickly defense. When a creature strikes the eidolon with a non-reach melee weapon, an unarmed strike, or a natural weapon, that creature takes damage from the eidolon’s quills, and must succeed on a Reflex saving throw or have a quill break off in its flesh. The eidolon must have the quills evolution to take this evolution.
...
*Strangle (Ex):* An opponent grappled by the eidolon’s tentacle cannot speak or cast spells with verbal components. The eidolon must have both the grab and tentacle evolutions to take this evolution.

*Stunning Roar (Ex):* The eidolon can roar, filling a 30-foot cone with sonic energy. Any creatures caught in the cone must succeed on a Fortitude saving throw or be [[Stunned|stunned]] for 1 round. The save DC for this effect is equal to 10 + half the eidolon’s Hit Dice + the eidolon’s Constitution modifier. The eidolon can use this ability once per day. The eidolon can use this ability 1 additional time per day by spending one additional evolution point (maximum 3/day). The summoner must be at least 9th level before selecting this evolution.
...
**[[0 Level Summoner Spells|0-Level Summoner Spells]]**—*[[Acid Splash (Spell)|acid splash]]**,* *[[Arcane Mark (Spell)|arcane mark]]**,* *[[Daze (Spell)|daze]]**,* *[[Detect Magic (Spell)|detect magic]]**,* *[[Guidance (Spell)|guidance]]**,* *[[Light (Spell)|light]]**,* *[[Mage Hand (Spell)|mage hand]]**,* *[[Mending (Spell)|mending]]**,* *[[Message (Spell)|message]]**,* *[[Open_Close (Spell)|open/close]]**,* *[[Read Magic (Spell)|read magic]]**, resistance.*

**[[1st Level Summoner Spells|1st-Level Summoner Spells]]**—*[[Alarm (Spell)|alarm]]**, [[Ant Haul (Spell)|ant haul]],* *[[Daze Monster (Spell)|daze monster]]**,* *[[Endure Elements (Spell)|endure elements]]**,* *[[Enlarge Person (Spell)|enlarge person]]**,* *[[Expeditious Retreat (Spell)|expeditious retreat]]**,* *[[Feather Fall (Spell)|feather fall]]**,* *[[Grease (Spell)|grease]]**,* *[[Identify (Spell)|identify]]**,* *[[Jump (Spell)|jump]]**,* *[[Mage Armor (Spell)|mage armor]]**,* *[[Magic Fang (Spell)|magic fang]]**,* *[[Magic Mouth (Spell)|magic mouth]]**,* *[[Mount (Spell)|mount]]**,* *[[Protection From Chaos (Spell)|protection from chaos]]**/evil/good/law,* *[[Reduce Person (Spell)|reduce person]]**, rejuvenate eidolon (lesser),* *[[Shield (Spell)|shield]]**,* *[[Summon Monster I (Spell)|summon monster I]]**, unfetter,* *[[Unseen Servant (Spell)|unseen servant]]**,* *[[Ventriloquism (Spell)|ventriloquism]]**.*

**[[2nd Level Summoner Spells|2nd-Level Summoner Spells]]**—*[[Alter Self (Spell)|alter self]]**,* *[[Barkskin (Spell)|barkskin]]**,* *[[Bear's Endurance (Spell)|bear’s endurance]]**,* *[[Blur (Spell)|blur]]**,* *[[Bull's Strength (Spell)|bull’s strength]]**,* *[[Cat's Grace (Spell)|cat’s grace]]**, [[Create Pit (Spell)|create pit]],* *[[Detect Thoughts (Spell)|detect thoughts]]**,* *[[Eagle's Splendor (Spell)|eagle’s splendor]]**, evolution surge (lesser),* *[[Fox's Cunning (Spell)|fox’s cunning]]**, glide,* *[[Glitterdust (Spell)|glitterdust]]**,* *[[Haste (Spell)|haste]]**,* *[[Invisibility (Spell)|invisibility]]**,* *[[Levitate (Spell)|levitate]]**,* *[[Misdirection (Spell)|misdirection]]**,* *[[Owl's Wisdom (Spell)|owl’s wisdom]]**,* *[[Phantom Steed (Spell)|phantom steed]]**,* *[[Protection from Arrows (Spell)|protection from arrows]]**,* *[[Resist Energy (Spell)|resist energy]]**,* *[[See Invisibility (Spell)|see invisibility]]**,* *[[Slow (Spell)|slow]]**,* *[[Spider Climb (Spell)|spider climb]]**, summon eidolon,* *[[Summon Monster II (Spell)|summon monster II]]**,* *[[Summon Swarm (Spell)|summon swarm]]**,* *[[Wind Wall (Spell)|wind wall]]**.*

**[[3rd Level Summoner Spells|3rd-Level Summoner Spells]]**—*[[Aqueous Orb (Spell)|aqueous orb]],* *[[Black Tentacles (Spell)|black tentacles]]**,* *[[Charm Monster (Spell)|charm monster]]**, devolution,* *[[Dimension Door (Spell)|dimension door]]**,* *[[Dimensional Anchor (Spell)|dimensional anchor]]**,* *[[Dispel Magic (Spell)|dispel magic]]**,* *[[Displacement (Spell)|displacement]]**, [[Enlarge Person, Mass (Spell)|enlarge person (mass)]], evolution surge,* *[[Fire Shield (Spell)|fire shield]]**,* *[[Fly (Spell)|fly]]**,* *[[Heroism (Spell)|heroism]]**,* *[[Invisibility, Greater (Spell)|invisibility (greater)]]**,* *[[Locate Creature (Spell)|locate creature]]**,* *[[Magic Circle Against Chaos (Spell)|magic circle against chaos]]**/[[Magic Circle Against Evil (Spell)|evil]]/[[Magic Circle Against Good (Spell)|good]]/[[Magic Circle Against Law (Spell)|law]], magic fang (greater),* *[[Minor Creation (Spell)|minor creation]]**,* *[[Nondetection (Spell)|nondetection]]**,* *[[Protection From Energy (Spell)|protection from energy]]**,* *[[Rage (Spell)|rage]]**, reduce person (mass), rejuvenate eidolon, seek thoughts, spiked pit,* *[[Stoneskin (Spell)|stoneskin]]**,* *[[Summon Monster IV (Spell)|summon monster IV]]**,* *[[Tongues (Hex)|tongues]]**,* *[[Wall of Fire (Spell)|wall of fire]]**,* *[[Wall of Ice (Spell)|wall of ice]]**,* *[[Water Breathing (Spell)|water breathing]]**.*

**[[4th Level Summoner Spells|4th-Level Summoner Spells]]**—*[[Acid Pit (Spell)|acid pit]]**,* *[[Baleful Polymorph (Spell)|baleful polymorph]]**, bear’s endurance (mass), bull’s strength (mass), cat’s grace (mass), [[Contact Other Plane (Spell)|contact other plane]], [[Dismissal (Spell)|dismissal]], eagle’s splendor (mass), evolution surge (greater), fox’s cunning (mass), [[Hold Monster (Spell)|hold monster]], [[Insect Plague (Spell)|insect plague]], [[Mage's Faithful Hound (Spell)|mage’s faithful hound]], [[Magic Jar (Spell)|magic jar]], [[Major Creation (Spell)|major creation]], [[Overland Flight (Spell)|overland flight]], owl’s wisdom (mass), planar binding (lesser), purified calling, [[Sending (Spell)|sending]], [[Summon Monster V (Spell)|summon monster V]], [[Teleport (Spell)|teleport]], transmogrify, [[Wall of Stone (Spell)|wall of stone]].*

**[[5th Level Summoner Spells|5th-Level Summoner Spells]]**—*[[Banishment (Spell)|banishment]], [[Creeping Doom (Spell)|creeping doom]], dispel magic (greater) [[Ethereal Jaunt (Spell)|ethereal jaunt]], heroism (greater), hungry pit, invisibility (mass), planar adaptation, [[Planar Binding (Spell)|planar binding]], [[Plane Shift (Spell)|plane shift]], [[Repulsion (Spell)|repulsion]], rejuvenate eidolon (greater), [[Sequester (Spell)|sequester]], [[Simulacrum (Spell)|simulacrum]], [[Spell Turning|spell turning]], [[Summon Monster VII (Spell)|summon monster VII]], teleport (greater), [[True Seeing (Spell)|true seeing]], [[Wall of Iron (Spell)|wall of iron]].*

**[[6th Level Summoner Spells|6th-Level Summoner Spells]]**—*[[Antipathy (Spell)|antipathy]], [[Binding (Spell)|binding]], charm monster (mass), [[Dimensional Lock (Spell)|dimensional lock]], [[Discern Location (Spell)|discern location]], [[Dominate Monster (Spell)|dominate monster]], [[Incendiary Cloud (Spell)|incendiary cloud]], [[Maze (Spell)|maze]], planar adaptation (mass), planar binding (greater), [[Protection From Spells (Spell)|protection from spells]], [[Summon Monster VIII (Spell)|summon monster VIII]], [[Sympathy (Spell)|sympathy]], [[Teleportation Circle (Spell)|teleportation circle]].*

## Summoner Archetypes
The following archetypes are for the summoner base class:
...
Alexander Augunas, Tyler Beck, Anthony Li, Luis Loza, David N. Ross, Owen K.C. Stephens, and Linda Zayas-Palmer. *Pathfinder Player Companion: Monster Summoner’s Handbook.* Paizo Inc. 2015.

Daron Woodson. *Class Acts: Summoners.* Abandoned Arts. 2012.

Daron Woodson. *Class Acts: Summoner Archetypes.* Abandoned Arts. 2012.

Berin Kinsman. *Character Workbook: Revised Summoner.* Asparagus Jumpsuit. 2013, 2014.

Christopher Kentlea. *Fantastic Feats Volume 26 – Summoners.* Ennead Games. 2014.

John Buckley. *Player Paraphernalia #20 The Elemental Summoner (Summoner Archetype)*. The Knotty-Works. 2015.

Jason Nelson.* Mythic Minis 45: Summoner Feats.* Legendary Games. 2014.

Sigfried Trent. *Advanced Feasts: The Summoner's Circle.* Open Design, LLC. 2010.

Chris A. Field. *Eidonlons Unbound.* Otherverse Games. 2011.

Patrick Younts. *Fantasy Player’s Companion: A Menagerie of Summoner Options.* Ronin Arts. 2004.
...
---
## Tags
#Rule/OGL #Rule/Summoner #Rule/Class--Base- #Sources/Advanced-Player-s-Guide #Rule-System/Pathfinder #Rule/Core #Publisher/Paizo
