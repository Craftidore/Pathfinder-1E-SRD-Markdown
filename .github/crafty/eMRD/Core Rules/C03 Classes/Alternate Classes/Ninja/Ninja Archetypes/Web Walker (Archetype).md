...
|---|---|---|---|
| Acceleration of Form (Su) | — | Spend 1 ki point as a standard action to gain the benefits of displacement and haste for 1 round per 2 ninja levels. | Chronicle of Legends |
| Acrobatic Master | — | Expend 1 ki point to gain +20 bonus on one Acrobatics check | Ultimate Combat |
| Act Without Thought | — | Expend 1 ki point to act in surprise round, stop being flat-footed, and gain +4 to initiative | Power of the Ninja (Rogue Genius Games) |
| Bleeding Attack\* | — | Living opponent damaged by sneak attack also bleeds | Ultimate Combat |
| Blink Dash | — | When running or withdrawing, gain the benefit of blur effect | Power of the Ninja (Rogue Genius Games) |
...
| Choking Bomb | Poison bomb | Living creatures affected by smoke bomb are staggered | Ultimate Combat |
...
| Combat Trick | — | Gain a bonus combat feat | Ultimate Combat |
| Control Breathing | — | On failing a save vs an emotion or *fear* spell or effect, control breath to make a second save with a morale bonus | Power of the Ninja (Rogue Genius Games) |
| Crippling Shot | Ninja 4, Opportunities Aplenty | Choose to make opponents struck by opportunities aplenty attack save or be staggered | Secrets of Adventuring (Rite Publishing) |
| Darkvision | — | Expend 1 ki point to gain darkvision 60′ for 1 hour | Ultimate Combat |
| Deadly Range | — | Increase range of dealing sneak attack damage by 10 feet | Ultimate Combat |
| Deadly Strike | — | Expend 1 ki point to apply two tricks that apply to sneak attacks (\*) to the same sneak attack | Power of the Ninja (Rogue Genius Games) |
...
| Deflect Arrows | Improved Unarmed Strike | Gain Deflect Arrows as a bonus feat | Ultimate Combat |
| Disguise Aura | Sudden disguise | Expend 1 ki point to suppress one aspect of her alignment, presence of poison, surface thoughts, or presence of magic | Power of the Ninja (Rogue Genius Games) |
| Dislocate | — | Roll Escape Artist checks twice and takes the better of the two rolls | Power of the Ninja (Rogue Genius Games) |
| Emulate Aura | Disguise aura, sudden disguise | Make Disguise checks in place of Use Magic Device checks | Power of the Ninja (Rogue Genius Games) |
| Escape | — | Withdraw past additional opponents without becoming threatened | Power of the Ninja (Rogue Genius Games) |
| Face | — | Use Sense Motive in place of Diplomacy; use Sense Motive in place of the Knowledge checks to identify creature’s special powers or vulnerabilities. | Power of the Ninja (Rogue Genius Games) |
| Fast Stealth | — | Move at full speed using the Stealth skill without penalty | Ultimate Combat |
| Fatal Finesse | Weapon Finesse | Add Dexterity modifier to melee attack damage dealt with weapons modified by Weapon Finesse | Power of the Ninja (Rogue Genius Games) |
| Feather Fall | — | Expend 1 ki point to gain feather fall effect | Ultimate Combat |
| Fence | — | Use Appraise as swift action; use Appraise as standard action to roll twice taking better of the two results | Power of the Ninja (Rogue Genius Games) |
| Flurry of Stars | — | Expend 1 ki point to throw 2 more shuriken during full-attack | Ultimate Combat |
| Forgotten Trick | — | Expend 2 ki points to temporarily gain a new ninja trick | Ultimate Combat |
| Ghost Face | — | Expend 1 ki point to assume a horrific, inhuman face and posture enhancing Intimidate checks | Power of the Ninja (Rogue Genius Games) |
| Ghost Fingers | — | Expend 1 ki point to enhance Disable Device checks | Power of the Ninja (Rogue Genius Games) |
| Ghost Slayer | — | Expend 1 ki point to treat weapon attacks, unarmed attacks, and armor as force effects against incorporeal opponents | Power of the Ninja (Rogue Genius Games) |
| Healing Techniques | — | Gain Heal as class skill; spend 1 ki point for +4 bonus to Heal check | Power of the Ninja (Rogue Genius Games) |
...
| Feign Death | Master tricks, slow metabolism | Enter a death-like trance, hold breath for 20x as long; if poisoned, time between saving throws is multiplied by 20 | Power of the Ninja (Rogue Genius Games) |
...
Tyler Beck. *CLASSifieds: Nature’s Shadow - Ninja Archetype*. Fat Goblin Games. 2014
