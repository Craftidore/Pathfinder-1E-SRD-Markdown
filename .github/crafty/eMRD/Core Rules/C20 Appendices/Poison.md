...
Poisons can be made using [[Craft (Skill)|Craft]] (alchemy). The DC to make a poison is equal to its Fortitude save DC. Rolling a natural 1 on a [[Craft (Skill)|Craft]] skill check while making a poison exposes the crafter to the poison. Crafters with the poison use class feature do not risk poisoning themselves when using [[Craft (Skill)|Craft]] to make poison.
