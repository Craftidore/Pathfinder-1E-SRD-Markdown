...
The eldritch knight’s class skills (and the key ability for each skill) are [[Climb (Skill)|Climb]] (Str), [[Knowledge (Skill)|Knowledge]] (arcana) (Int), [[Knowledge (Skill)|Knowledge]] (nobility and royalty) (Int), [[Linguistics (PF Freeport Comp)|Linguistics]] (Int), [[Ride (Skill)|Ride]] (Dex), [[Sense Motive (Skill)|Sense Motive]] (Wis), [[Spellcraft (Skill)|Spellcraft]] (Int), and [[Swim (Skill)|Swim]] (Str).

**Skill Ranks at Each Level:** 2 + Int modifier.

**Table 11–6: Eldritch Knight**
...
**Source:** PF Core Rulebook (Paizo), pg 384


---
## Tags
#Rule-System/Pathfinder #Rule/OGL #Sources/PF-Core-Rulebook #Rule/Prestige-Class #Rule/Core #Publisher/Paizo #Utility/IP
