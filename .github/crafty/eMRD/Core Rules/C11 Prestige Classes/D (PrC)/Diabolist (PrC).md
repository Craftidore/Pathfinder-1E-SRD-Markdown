...
archdevils, the diabolist is not a servant of a specific powerful

fiend, but instead is usually a mortal being who has seen

the dark path as a means to gaining great power. She does

not serve devils—she wants to be one.
...
intimidate and destroy their enemies. Because of their diabolism

power, they are particularly skilled at dealing with

good foes, and they focus their power on good-aligned characters

when possible. It is common for a diabolist to have
...
Special: The character must offer her soul—but not necessarily

her loyalty—to the forces of hell in exchange for
...
The diabolist’s class skills (and the key ability for each skill)
...
Weapon and Armor Proficiency: Diabolists are proficient
...
This essentially means that she adds the new level of diabolist

to the level of whatever other spellcasting class the
...
attack bonus and save bonuses. If she next gains a level of sorcerer,

making her a 10th-level sorcerer/1st-level diabolist,
...
include herself ) gains the evil descriptor and deals +1d6 points of unholy damage to any good character affected by
...
is treated as a normal familiar, using the class level of the diabolist

as the wizard’s level (see the Familiars section in Chapter

3 of the Player’s Handbook for familiar abilities).

Vile Diabolism (Ex): An 8th-level diabolist

can use her diabolism power to deal
...
and 2d6 points of unholy damage. If the diabolist

then rolls a 7 for the 2d6 points of unholy
