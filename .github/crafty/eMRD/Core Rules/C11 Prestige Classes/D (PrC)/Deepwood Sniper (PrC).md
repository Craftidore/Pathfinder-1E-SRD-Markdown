...
Feats: [[Far Shot (Feat)|Far Shot]], [[Point-Blank Shot (Feat)|Point Blank Shot]], [[Weapon Focus (Feat)|Weapon Focus]] (any bow or crossbow).

Class Skills

The deepwood sniper’s class skills (and the key ability for each skill) are Balance (Dex), [[Climb (Skill)|Climb]] (Str), [[Craft (Skill)|Craft]] (bowmaking) (Int), [[Escape Artist (Skill)|Escape Artist]] (Dex), Intuit Direction (Wis), Hide (Dex), [[Jump (Spell)|Jump]] (Str), [[Knowledge (Domain)|Knowledge]] (nature) (Int). Listen (Wis), Move Silently (Dex), [[Profession (Skill)|Profession]] (Wis), Search (Int), [[Sense Motive (Skill)|Sense Motive]] (Wis), Spot (Wis), [[Swim (Skill)|Swim]] (Str), and Wilderness Lore (Wis).

Skill Points at Each Level: 4 + Int modifier.

Table 5–5: The Deepwood Sniper
...
**Source:** Masters of the Wild (WotC), pgs 53-32


---
## Tags
#Utility/IP #Rule-System/Pathfinder #Rule/Prestige-Class #Publisher/WotC #Rule/3PP #Rule/fm3
