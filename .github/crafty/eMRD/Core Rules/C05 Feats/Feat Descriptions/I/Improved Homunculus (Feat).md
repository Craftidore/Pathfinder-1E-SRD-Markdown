...
All special abilities are described below; those requiring additional information follow the chart. Unless otherwise specifi ed, an ability can only be taken once.
...
This feat applies to the character’s homunculus regardless of its type. For new types of homunculi, see Chapter 6 (of *Magic of Eberron)*.


| **Hit** | **Natural** | **Total** |
|---|---|---|
| **Dice** | **Armor** | **Special Abilities** |
| 1–2 | +0 | 0 |
| 3–5 | +2 | 1 |
| 6–8 | +4 | 2 |
| 9–11 | +6 | 3 |
...
| Extra Limbs (arms) | Gain an additional set of arms |
| Extra Limbs (legs) | Gain an additional set of legs |
...
| Store infusion (or potion) | Homunculus can store one infusion of up to 3rd level |
...
**Store Infusion (or Potion):** At the beginning of each day, the master can store one infusion (or potion) of up to 3rd level in the homunculus. This infusion (or potion) must be one that the master could normally create himself. This infusion (or potion) does not take effect when it is first stored. Instead, the homunculus can use a standard action to imbue itself with the infusion (or potion). No homunculus can store more than one infusion (or potion) at a time.

**Weapon Ability:** When this ability is granted, choose a weapon special ability with a base price modifier of “+1 bonus,” such as *[[Ghost Touch (Arm_ShldSpcAb)|ghost touch]]**,* *[[Keen (MagWpnSpcAb)|keen]]**,* or *[[Shock (MagWpnSpcAb)|shock]]*. The homunculus’s natural weapons are treated as if they had this special ability.

**Source:** Magic of Eberron (WotC), pg. 49
...
Unlike normal *scrying* or *greater scrying*, there is no chance of failure for viewing creatures though the sensor; the creator simply sees what the construct sees for the duration of the spell. Spells cast through the sensor still have the normal chance of operating through the construct’s eyes.
...
**Source:** Ultimate Magic, pgs. 113-116

## Monster Feat Advancement
**Monster Feat Advancement**

Creatures gain one feat at 1 Hit Die and one additional feat for every 2 Hit Dice above 1. Most additional feats should be focused on increasing the creature’s combat abilities, but metamagic feats and skill feats are also possible choices depending on the creature’s role.
...
---
## Tags
#Rule/NonOGL #Rule/House-Rule #Rule-System/Pathfinder #Rule/Feat--General- #Publisher/WotC #Rule/3PP #Rule/fm3 #Sources/Magic-of-Eberron
