...
- Automatic Language: Common. Bonus Languages: Any (other than secret languages such as Druidic). See other racial lists for common languages or Languages in the Core Rulebook for a more comprehensive list. See also the rules for Dark Speech in Chapter 2 of the *Book of Vile Darkness*.
...
**Source:** Book of Vile Darkness, pgs. 12-13


---
## Tags
#Sources/Book-of-Vile-Darkness #Rule/Race #Rule/3PP #Publisher/WotC #Rule-System/Pathfinder
