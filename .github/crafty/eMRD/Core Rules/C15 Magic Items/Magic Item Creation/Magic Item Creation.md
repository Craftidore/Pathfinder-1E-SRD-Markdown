...
RWtopicId: "Topic_19273"
---
# Magic Item Creation
## Overview
To create magic items, spellcasters use special feats which allow them to invest time and money in an item’s creation. At the end of this process, the spellcaster must make a single skill check (usually [[Spellcraft (Skill)|Spellcraft]], but sometimes another skill) to finish the item. If an item type has multiple possible skills, you choose which skill to make the check with. The DC to create a magic item is 5 + the caster level for the item. Failing this check means that the item does not function and the materials and time are wasted. Failing this check by 5 or more results in a cursed item (see [[Cursed Items]] for more information).
...
|---|---|---|
| Ability bonus (enhancement) | Bonus squared x 1,000 gp | *[[Belt of Incredible Dexterity +2\|Belt of incredible dexterity +2]]* |
...
| AC bonus (other) <sup>1</sup> | Bonus squared x 2,500 gp | *Ioun stone (dusty rose prism)* |
| Natural armor bonus (enhancement) | Bonus squared x 2,000 gp | *[[Amulet of Natural Armor +1\|Amulet of natural armor +1]]* |
| Save bonus (resistance) | Bonus squared x 1,000 gp | *[[Cloak of Resistance +5\|Cloak of resistance +5]]* |
| Save bonus (other) <sup>1</sup> | Bonus squared x 2,000 gp | *Stone of good luck* |
| Skill bonus (competence) | Bonus squared x 100 gp | *[[Cloak of Elvenkind\|Cloak of elvenkind]]* |
| Spell resistance | 10,000 gp per point over SR 12; SR 13 minimum | *[[Mantle of Spell Resistance\|Mantle of spell resistance]]* |
| Weapon bonus (enhancement) | Bonus squared x 2,000 gp | *+1 longsword* |
| **Spell Effect** | **Base Price** | **Example** |
| Single use, spell completion | Spell level x caster level x 25 gp | *Scroll of* *[[Haste (Spell)\|haste]]* |
| Single use, use-activated | Spell level x caster level x 50 gp | *Potion of* *[[Cure Light Wounds (Spell)\|cure light wounds]]* |
| 50 charges, spell trigger | Spell level x caster level x 750 gp | *Wand of fireball* |
| Command word | Spell level x caster level x 1,800 gp | *[[Cape of the Mountebank\|Cape of the mountebank]]* |
| Use-activated or continuous | Spell level x caster level x 2,000 gp <sup>2</sup> | *[[Lantern of Revealing\|Lantern of revealing]]* |
| **Special** | **Base Price Adjustment** | **Example** |
| Charges per day | Divide by (5 divided by charges per day) | *[[Boots of Teleportation\|Boots of teleportation]]* |
| No space limitation <sup>3</sup> | Multiply entire cost by 2 | *Ioun stone* |
| Multiple different abilities | Multiply lower item cost by 1.5 | *[[Helm of Brilliance\|Helm of brilliance]]* |
| Charged (50 charges) | 1/2 unlimited use base price | *[[Ram, the\|Ring of the ram]]* |
| **Component** | **Extra Cost** | **Example** |
| Armor, shield, or weapon | Add cost of masterwork item | *+1 composite longbow* |
| Spell has material component cost | Add directly into price of item per charge <sup>4</sup> | *Wand of stoneskin* |
...
| <sup>2</sup> If a continuous item has an effect based on a spell with a duration measured in rounds, multiply the cost by 4. If the duration of the spell is 1 minute/level, <br>  multiply the cost by 2, and if the duration is 10 minutes/level, multiply the cost by 1.5. If the spell has a 24-hour duration or greater, divide the cost in half. |||
| <sup>3</sup> An item that does not take up one of the spaces on a body costs double. |||
| <sup>4</sup> If item is continuous or unlimited, not charged, determine cost as if it had 100 charges. If it has some daily limit, determine as if it had 50 charges. |||
...
*House Rule:* All magical crafting of physical items (by arcane casters) with the exception of potions, scrolls, etc. requires the casting of the caster's unique *[[Arcane Mark (Spell)|arcane mark]]* as a part of the completion of the item.
...
**Item Creation Feat Required**: [[Craft Magic Arms and Armor (Feat)|Craft Magic Arms and Armor]].

**Skill Used in Creation**: [[Spellcraft (Skill)|Spellcraft]] or [[Craft (Skill)|Craft]] (armor).
...
**Skill Used in Creation**: [[Spellcraft (Skill)|Spellcraft]], [[Craft (Skill)|Craft]] (bows) (for magic bows and arrows), or [[Craft (Skill)|Craft]] (weapons) (for all other weapons).
...
**Item Creation Feat Required**: [[Brew Potion (Feat)|Brew Potion]].

**Skill Used in Creation**: [[Spellcraft (Skill)|Spellcraft]] or [[Craft (Skill)|Craft]] (alchemy)

**Potion Base Costs (By Brewer’s Class)**


-tx-
| **Spell** | **Cleric, Druid,** |  |  | **Paladin,** |
|---|---|---|---|---|
| **Level** | **Wizard** | **Sorcerer** | **Bard** | **Ranger\*** |
| 0 | 25 gp | 25 gp | 25 gp | — |
...
**Item Creation Feat Required**: [[Forge Ring (Feat)|Forge Ring]].

**Skill Used in Creation**: [[Spellcraft (Skill)|Spellcraft]] or [[Craft (Skill)|Craft]] ( jewelry).
...
**Item Creation Feat Required**: [[Craft Rod (Feat)|Craft Rod]].

**Skill Used in Creation**: [[Spellcraft (Skill)|Spellcraft]], [[Craft (Skill)|Craft]] ( jewelry), [[Craft (Skill)|Craft]] (sculptures), or [[Craft (Skill)|Craft]] (weapons).
...
**Item Creation Feat Required**: [[Scribe Scroll (Feat)|Scribe Scroll]].

**Skill Used in Creation**: [[Spellcraft (Skill)|Spellcraft]], [[Craft (Skill)|Craft]] (calligraphy), or [[Profession (Skill)|Profession]] (scribe).
...
**Item Creation Feat Required**: [[Craft Staff (Feat)|Craft Staff]].

**Skill Used in Creation**: [[Spellcraft (Skill)|Spellcraft]], [[Craft (Skill)|Craft]] ( jewelry), [[Craft (Skill)|Craft]] (sculptures), or [[Profession (Skill)|Profession]] (woodcutter).
...
**Item Creation Feat Required**: [[Craft Wand (Feat)|Craft Wand]].
...
**Item Creation Feat Required**: [[Craft Wondrous Item (Feat)|Craft Wondrous Item]].

**Skill Used In Creation**: [[Spellcraft (Skill)|Spellcraft]] or an applicable [[Craft (Skill)|Craft]] or [[Profession (Skill)|Profession]] skill check.

**GM Note**

*House Rule:* The spell(s) needed for creating a wondrous item can also be cast from a scroll with that spell(s). The creator must successfully activate the scroll(s) needed. To activate a scroll, a spellcaster must read the spell written on it. This involves several steps and conditions.

*Decipher the Writing:* The writing on a scroll must be deciphered before a character can use it or know exactly what spell it contains. This requires a *[[Read Magic (Spell)|read magic]]* spell or a successful [[Spellcraft (Skill)|Spellcraft]] check (DC 20 + spell level). Deciphering a scroll is a full-round action.
...
Any mishap causes the item creation in progress to fail.
...
## **Crafting and Bypassing Requirements: What crafting requirements can you bypass by adding +5 to the DC of your [[Spellcraft (Skill)|Spellcraft]] check?**
...
The cost to add additional abilities to an item is the same as if the item was not magical, less the value of the original item. Thus, a *+1 longsword* can be made into a *+2* *[[Vorpal (MagWpnSpcAb)|vorpal]]* *longsword,* with the cost to create it being equal to that of a *+2* *[[Vorpal (MagWpnSpcAb)|vorpal]]** sword* minus the cost of a *+1 longsword*.

If the item is one that occupies a specific place on a character’s body, the cost of adding any additional ability to that item increases by 50%. For example, if a character adds the power to confer invisibility to her *[[Protection +2|ring of protection +2]]**,* the cost of adding this ability is the same as for creating a *[[Invisibility (Ring)|ring of invisibility]]* multiplied by 1.5.

## Ways to Reduce Crafting Costs
...
—*Item Requires Skill to Use:* Some items require a specific skill (such as [[Perform (Skill)|Perform]] for a musical instrument) to get them to function. This factor should reduce the cost about 10%.

—*Item Requires Specific Class, Race, or Alignment to Use:* Even more restrictive than requiring a skill, this limitation cuts the cost by 30%. (Some GMs may limit this limitation to a single use per item (ie., specific class or rare or alignment) others will not.

Prices presented in the magic item descriptions in this book (the gold piece value following the item’s caster level) are the market value, which is generally twice what it costs the creator to make the item.

Since different classes get access to certain spells at different levels, the prices for two characters to make the same item might actually be different. Take *[[Hold Person (Spell)|hold person]]**,* for example. A cleric casts it as a 2nd-level spell, so a cleric-created *wand of hold person* costs 2 (2nd-level spell) × 3 (3rd-level caster) × 750 gp, divided in half, or 2,250 gp. However, a wizard casts *[[Hold Person (Spell)|hold person]]* as a 3rd-level spell, so her wand costs 3 (3rd-level spell) × 5 (5th-level caster) × 750 gp, divided in half, or 5,625 gp. A sorcerer also casts *[[Hold Person (Spell)|hold person]]* as a 3rd-level spell, but he doesn’t get the spell until 6th level, so his wand costs 3 (3rd-level spell) × 6 (6th-level caster) × 750 gp, divided in half, or 6,750 gp. The wand is only worth two times what the caster of lowest possible level (in this case, the cleric) can make it for, however, so the market price of a *wand of hold person* is 4,500 gp, no matter who makes it.
...
**Source:** Dungeon Master's Guide (3.5), pg. 282 (Sidebar)

### Artisan Feats
**Artisan Feats**

Artisan feats are usually, but not always, [[Item Creation Feats|item creation feats]] which modify the magic item crafting rules. Typically they do this in one of three ways: cost reduction, time reduction, or alter the basic rules for crafting.

For convenience they are grouped as follows:

**Cost Reduction Feats**


| **Feat** | **Reduction** | **Source** |
|---|---|---|
| [[Arcane Craftsman (Feat)\|Arcane Craftsman]] | -25% | The Living Sky Campaign Setting |
| [[Arcane Master Craftsman (Feat)\|Arcane Master Craftsman]] | -50% | The Living Sky Campaign Setting |
| [[Extraordinary Artisan (Feat)\|Extraordinary Artisan]] | -25% | Eberron Campaign Setting (WotC) 53 |
| [[Ioun Shaping (Feat)\|Ioun Shaping]] | -10% | The Mage's Tower |
| [[Improved Ioun Shaping (Feat)\|Improved Ioun Shaping]] | -25% | The Mage's Tower |
| [[Magical Artisan (Feat)\|Magical Artisan]] | -25% | Player's Guide to Faerun (WotC) 41 |

**Time Reduction Feats**


| **Feat** | **Reduction** | **Source** |
|---|---|---|
| [[Arcane Builder]] | -25% | The Mage's Tower |
| [[Arcane Craftsman (Feat)\|Arcane Craftsman]] | -25% | The Living Sky Campaign Setting |
| [[Arcane Master Craftsman (Feat)\|Arcane Master Craftsman]] | -50% | The Living Sky Campaign Setting |
| [[Exceptional Artisan (Feat)\|Exceptional Artisan]] | -25% | Eberron Campaign Setting (WotC) 52 |
| [[Improved Ioun Shaping (Feat)\|Improved Ioun Shaping]] | -25% | The Mage's Tower |
| [[Master Artificer (Feat)\|Master Artificer]] | -50%/day | Adventurer's Handbook (Super Genius Games), pg. 65 |
| [[Master Builder (Feat)\|Master Builder]] | -50% | The Artisan (Drop Dead Studios) 23 |

**Feats That Alter Crafting Rules** 


| **Feat** | **Benefit** | **Source** |
|---|---|---|
| [[Arcane Rod Artisan (Feat)\|Arcane Rod Artisan]] | [[Craft Rod (Feat)\|Craft Rod]], [[Exceptional Artisan (Feat)\|Exceptional Artisan]], [[Extraordinary Artisan (Feat)\|Extraordinary Artisan]], [[Legendary Artisan (Feat)\|Legendary Artisan]], caster level 12th | You excel in the creation of magical rods, divide the final cost by half; this includes the time it takes to create it |
| [[Arcane Wand Artisan (Feat)\|Arcane Wand Artisan]] | [[Craft Wand (Feat)\|Craft Wand]], [[Exceptional Artisan (Feat)\|Exceptional Artisan]], [[Extraordinary Artisan (Feat)\|Extraordinary Artisan]], [[Legendary Artisan (Feat)\|Legendary Artisan]], caster level 12th | You excel in the creation of magical wands, divide the final cost by half; this includes the time it takes to create it |
| [[Craft Anywhere (Feat)\|Craft Anywhere]] | Craft while adventuring; receive 8 hours towards project | Advanced Feats: Secrets of the Alchemist (Open Design) 4 |
| [[Fast Item Creation (Feat)\|Fast Item Creation]] | +1,000 gp to daily crafting level | Advanced Feats: Secrets of the Alchemist (Open Design) 5 |
| [[Frugal Crafting (Feat)\|Frugal Crafting]] | Reduce final cost of crafting project by 33% | Advanced Feats: Secrets of the Alchemist (Open Design) 5 |
| [[Long Days (Feat)\|Long Days]] | Take two 8 hour crafting sessions when not adventuring | The Living Sky Campaign Setting |
| [[Master Artificer (Feat)\|Master Artificer]] | Reduce daily crafting time to 4 hours; may use up to 2 four hour sessions in a day | Adventurer's Handbook (Super Genius Games), pg. 65 |
| [[Swift Crafting (Feat)\|Swift Crafting]] | Treat magic items as being 20% cheaper for the purpose of determining how long it will take to create | Path of Iron (Ascension Games) 71 |

As a house rule, GMs are encouraged to consider the fact that just in the 'real' world the ability to craft something faster (so long as the same level of quality is maintained) should allow the maker to charge a premium in addition to the usual price. 5% per each Time Reduction feat used is probably a good recommendation though the use of the [[Diplomacy (Skill)|Diplomacy]] skill could affect this (up or down).

**Spells that affect crafting:**

*Arcane reinforcement*

*[[Canny Effort (Spell)|Canny effort]]* (+2 insight bonus)

*[[Craftsmanship, Lesser (Spell)|Lesser craftsmanship]]* (bonus to [[Spellcraft (Skill)|Spellcraft]] roll equal to caster level + Int modifier)

*[[Instant Knowledge (Spell)|Instant knowledge]]* (+1 temporary skill rank/level [[Spellcraft (Skill)|Spellcraft]])

*[[Investigative Mind (Spell)|Investigative mind]]* (roll twice for [[Spellcraft (Skill)|Spellcraft]] when crafting)

*[[Magecraft (Spell)|Magecraft]]* (+5 competence bonus to [[Spellcraft (Skill)|Spellcraft]])

*[[Maestro's Favor (Spell)|Maestro's favor]]* (+5 luck bonus to [[Spellcraft (Skill)|Spellcraft]])

*[[Magician's Workshop (Spell)|Magician's workshop]]* (+4 hours crafting time/casting) 

*[[Phantom Worker (Spell)|Phantom worker]]* 

*[[Tireless (Spell)|Tireless]]*

*[[True Skill (Spell)|True skill]]* (insight bonus equal to 1/2 caster level)

Marble block generating clickie

*[[Fabricate (Spell)|Fabricate]]* spell (continuous use) = 90,000 gp + cost of 100 marble blocks of size desired
...
---
## Tags
#Rule/OGL #Sources/PF-Core-Rulebook #Rule-System/Pathfinder #Publisher/Paizo #Sources/Dungeon-Master-s-Guide #Rule/House-Rule
