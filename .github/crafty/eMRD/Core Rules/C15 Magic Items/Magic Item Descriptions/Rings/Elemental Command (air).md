...
- *[[Feather Fall (Spell)|Feather fall]]* (unlimited use, wearer only)
- *[[Resist Energy (Spell)|Resist energy]] (electricity)* (unlimited use, wearer only)
- *[[Gust of Wind (Spell)|Gust of wind]]* (twice per day)
- *[[Wind Wall (Spell)|Wind wall]]* (unlimited use)
- *[[Air Walk (Spell)|Air walk]]* (once per day, wearer only)
- *[[Chain Lightning (Spell)|Chain lightning]]* (once per week)
