...
*[[Resist Energy (Spell)|Resist energy]] (fire)* (as a *major ring of energy resistance \[fire]*)

*[[Burning Hands (Spell)|Burning hands]]* (unlimited use)

*[[Flaming Sphere (Spell)|Flaming sphere]]* (twice per day)

*[[Pyrotechnics (Spell)|Pyrotechnics]]* (twice per day)

*[[Wall of Fire (Spell)|Wall of fire]]* (once per day)

*[[Flame Strike (Spell)|Flame strike]]* (twice per week)
