...
*[[Water Walk (Spell)|Water walk]]* (unlimited use)

*[[Create Water (Spell)|Create water]]* (unlimited use)

*[[Water Breathing (Spell)|Water breathing]]* (unlimited use)

*[[Wall of Ice (Spell)|Wall of ice]]* (once per day)

*[[Ice Storm (Spell)|Ice storm]]* (twice per week)

*[[Control Water (Spell)|Control water]]* (twice per week)
