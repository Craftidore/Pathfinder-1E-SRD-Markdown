...
RWtopicId: "Topic_19337"
---
# Strand of Prayer Beads, Greater
## Overview
**Aura** moderate or strong (many schools); **CL** CL 5th (healing), 7th (smiting), 9th (karma), 11th (wind walking), 17th (summons)
...
|---|---|
| *Bead of healing* | Wearer can cast his choice of *[[Cure Serious Wounds (Spell)\|cure serious wounds]]**,* *[[Remove Blindness_Deafness (Spell)\|remove blindness/deafness]]**,* or *[[Remove Disease (Spell)\|remove disease]]**.* |
| *Bead of karma* | Wearer casts his spells at +4 caster level. Effect lasts 10 minutes. |
| *Bead of smiting* | Wearer can cast *[[Chaos Hammer (Spell)\|chaos hammer]]**,* *[[Holy Smite (Spell)\|holy smite]]**,* *[[Order's Wrath (Spell)\|order’s wrath]]**,* or *[[Unholy Blight (Spell)\|unholy blight]]* (Will DC 17 partial). |
...
| *Bead of wind walking* | Wearer can cast *[[Wind Walk (Spell)\|wind walk]]**.* |
...
The power of a special bead is lost if it is removed from the strand. Reduce the price of a *strand of prayer bead*s that is missing one or more beads by the following amounts: *bead of blessing* –600 gp, *bead of healing* –9,000 gp, *bead of karma* –20,000 gp, *bead of smiting* –16,800 gp, *bead of summons* –20,000 gp, *bead of wind walking* –46,800 gp.

**Construction**

**Requirements** [[Craft Wondrous Item (Feat)|Craft Wondrous Item]], one of the following spells per bead, as appropriate: *[[Cure Serious Wounds (Spell)|cure serious wounds]]**,* *[[Remove Blindness_Deafness (Spell)|remove blindness/ deafness]]**,* or *[[Remove Disease (Spell)|remove disease]]* (healing); *[[Righteous Might (Spell)|righteous might]]* (karma); *[[Gate (Spell)|gate]]* (summons); *[[Chaos Hammer (Spell)|chaos hammer]]**,* *[[Holy Smite (Spell)|holy smite]]**,* *[[Order's Wrath (Spell)|order’s wrath]]**,* or *[[Unholy Blight (Spell)|unholy blight]]* (smiting), *[[Wind Walk (Spell)|wind walk]]* (wind walking)

**Cost** 47,900 gp

**Source:** PF Core Rulebook, pg. 530


---
## Tags
#Rule-System/Pathfinder #Sources/PF-Core-Rulebook #Special-Item-Type/Magic-Item #Magic-Item-Type/Wondrous-Item #Rule/Wondrous-Item #Publisher/Paizo #Rule/Core #Magic-Item-Slot/None #Price-Band/16-001--gp
