...
**Requirements** [[Craft Wondrous Item (Feat)|Craft Wondrous Item]], *[[Mage's Magnificent Mansion (Spell)|mage's magnificent mansion]]**,* *[[Overland Flight (Spell)|overland flight]]**,* creator must have 6 ranks in the [[Craft (Skill)|Craft]] (carpentry) or [[Profession (Skill)|Profession]] (wainwright) skill
...
*House Rule:* Several modifications have been tried (some without success) to the *night monarch vardo*; each successful modification adds +1 to the *vardo's* caster level (remember this is not a construction requirement but rather provides the *vardo's* caster level for *[[Dispel Magic (Spell)|dispel magic]]* checks*.* The cost here for such modifications is the same whether they are incorporated into the *vardo's* construction or added later on. This is an exception to the normal crafting rule with regards to adding a later enchanment. Here are some of the successes:
...
Adding the *[[Augment Object (Spell)|augment object]]* spell to the *vardo's* construction requirements increases its price by 6,000 gp but doubles its hardness and hit points and adds +20 to the break DC of the *vardo*.
...
Adding the *[[Ironwood (Spell)|ironwood]]* spell to the *vardo's* construction requirements increases its price by 12,000 gp but increases its hardness by 10 to a total of 20 and gives it fire resistance 10.

Adding the *[[Ironwood, Greater (Spell)|greater ironwood]]* spell to the *vardo's* construction requirements increases its price by 16,000 gp but gives it DR 5/[[Adamantine|adamantine]] and immunity to fire.
...
Adding a second casting of the *[[Overland Flight (Spell)|overland flight]]* spell to the *vardo's* construction requirements increases its price by 10,000 gp but causes it to fly at a speed of 30 feet as that spell.
...
Adding the *[[Phantom Wagon (Spell)|phantom wagon]]* spell to the *vardo's* construction requirements increases its price by 12,000 gp but give it the additional powers and capabilities of that spell (any improvement in an ability, capability, or power, use the better of the two).
...
Substituting [[Darkwood|darkwood]] for more common woods results in the following: 
...
**Aura** strong conjuration and transmutation; **CL** 21th 
...
---
## Tags
#Rule/fm3 #Rule/House-Rule #Rule-System/Pathfinder #Sources/PF-Core-Rulebook #Magic-Item-Type/Wondrous-Item #Rule/Wondrous-Item #Publisher/Paizo #Magic-Item-Slot/None #Price-Band/16-001--gp #Rule/3PP
