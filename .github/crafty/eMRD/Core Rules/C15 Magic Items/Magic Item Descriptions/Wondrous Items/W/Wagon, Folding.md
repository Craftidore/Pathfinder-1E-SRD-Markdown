...
A *folding wagon* looks like a small wooden box about 8 inches long, 4 inches wide, and 2 inches deep when it is inactive. In this mode, it can be used to store items just like any other box. Yet when the proper command word is given, the box unfolds itself rapidly in the space of a single round to form a vardo (heavy wagon) 20 feet long, 10 feet wide, and 8 feet in depth. The *folding wagon* cannot unfold if there isn’t enough open space for it to occupy once unfolded. Any objects formerly stored in the box now rest inside it.
...
**Requirements** [[Craft Wondrous Item (Feat)|Craft Wondrous Item]], *[[Fabricate (Spell)|fabricate]]*, creator must have 2 ranks in the [[Craft (Skill)|Craft]] (wainwright) skill
...
*House Rule:* The command words for such vehicles is often some variant of their name and can be frequently found carved onto the box somewhere.  A favorite of some GMs is to use *[[Illusory Script (Spell)|illusory script]]* for the command words; doing so adds that spell to the requirements for construction and increases the price to 7,500 gp. Another often used is to make the command words invisible and/or to place them on the underside of a sliding lid. 

*House Rule:* There are rumored to be other, larger variants of the *folding wagon*; some of which use the *[[Secret Chest (Spell)|secret chest]]* spell as a part of their construction. Such a *folding wagon* would have increased storage capacity, even when folded.


---
## Tags
#Rule-System/Pathfinder #Price-Band/4-001---8-000-gp #Special-Item-Type/Magic-Item #Magic-Item-Slot/None #Magic-Item-Type/Wondrous-Item #Publisher/Paizo #Rule/House-Rule #Rule/fm3 #Rule/OGL #Rule/Wondrous-Item #Rule/3PP
