...
This more advanced form of crystal ball has an additional power that allows the user to use *[[True Seeing (Spell)|true seeing]]* (as the spell) on the target viewed.
