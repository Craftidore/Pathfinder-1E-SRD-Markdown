...
Aliases:
  - "Shadowsworn 1"
Category: "Shadowsworn Spell Lists"
Tags:
  - "Category/Shadowsworn-Spell-Lists"
parent:
...
**Keen Senses:** Subject gains +2 [[Perception (Skill)|Perception]], low-light vision.

## L
**L**

**Light Blindness:** Blind creatures that see in daylight.

**Light Warding <sup>M</sup>:** Barrier of light wards against creature type.
...
**Orb of Light, Lesser:** Ranged touch attack deals 1d8 points of positive energy/2 caster levels.
...
**Shadow Hands:** Hands deal 1d6 points of cold damage/level (max 5d6).

**Shadow Shape:** Alter the shape of shadows, and cause pain to shadow creatures.

**Shadow Weapon:** Create a quasi-real masterwork weapon.

**Silent Sound:** Inflict 1d6 points of sonic damage/level (5d6 max).
