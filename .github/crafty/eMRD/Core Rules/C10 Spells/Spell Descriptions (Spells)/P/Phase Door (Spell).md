...
**Source:** PF Core Rulebook, pg. 320

This spell creates an ethereal passage through wooden, plaster, or stone walls, but not other materials. The *phase door* is invisible and inaccessible to all creatures except you, and only you can use the passage. You disappear when you enter the *phase door* and appear when you exit. If you desire, you can take one other creature (Medium or smaller) through the door. This counts as two uses of the door. The door does not allow light, sound, or spell effects through it, nor can you see through it without using it. Thus, the spell can provide an escape route, though certain creatures, such as phase spiders, can follow with ease. A *[[Gem of Seeing|gem of true seeing]]* or similar magic reveals the presence of a *phase door* but does not allow its use.

A *phase door* is subject to *[[Dispel Magic (Spell)|dispel magic]]**.* If anyone is within the passage when it is dispelled, he is harmlessly ejected just as if he were inside a *[[Passwall (Spell)|passwall]]* effect.
...
*Phase door* can be made permanent with a *[[Permanency (Spell)|permanency]]* spell.


---
## Tags
#Spell-Resistance/No #Spell-School/Conjuration #Spell-Subschool/Creation #Saving-Throws/None #Spell-Level/Sorcerer-Wizard-7 #Spell-Range/Touch #Rule/OGL #Sources/PF-Core-Rulebook #Rule/Spell #Rule/Core #Publisher/Paizo #Rule/fm3 #Spell-Rarity/Common
