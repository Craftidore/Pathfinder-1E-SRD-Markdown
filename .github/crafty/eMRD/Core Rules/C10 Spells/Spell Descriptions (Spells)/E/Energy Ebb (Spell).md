...
This spell functions like *[[Enervation (Spell)|enervation]]*, except the creature struck gains negative levels over an extended period.

You must succeed on a ranged touch attack with the ray to strike a target. If the attack succeeds, the subject initially gains one negative level, then continues to gain another negative level each round thereafter as its life force slowly bleeds away. The drain can be stopped only by a successful DC 23 [[Heal (Skill)|Heal]] check or the application of a *[[Heal (Spell)|heal]], [[Restoration (Spell)|restoration]],* or *[[Restoration, Greater (Spell)|greater restoration]]* spell.
...
---
## Tags
#Spell-Resistance/Yes #Sources/Spell-Compendium #Rule-System/Pathfinder #Rule/NonOGL #Rule/Spell #Rule/3PP #Publisher/WotC #Spell-Rarity/Rare #Saving-Throws/See-text #Spell-Level/Cleric-7 #Spell-Range/Close--25-ft----5-ft--2-levels- #Spell-Descriptor/Evil #Saving-Throws/Fortitude-Partial #Spell-School/Necromancy #Spell-Level/Sorcerer-Wizard-7 #Rule/fm3 #Spell-Effect/Ray
