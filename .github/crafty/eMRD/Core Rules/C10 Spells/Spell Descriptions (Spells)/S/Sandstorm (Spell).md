...
You create a duststorm or sandstorm. *Sandstorm* uses the parameters of *[[Control Winds (Spell)|control winds]]*, differing from that spell as shown above and as follows. A spellcaster who knows *sandstorm* need not be in an area of exposed, sandy soil to create the effects described below—this spell conjures both sand and wind.
...
---
## Tags
#Sources/Sandstorm #Rule-System/Pathfinder #Rule/NonOGL #Rule/Spell #Rule/3PP #Publisher/WotC #Spell-Rarity/Rare #Spell-Resistance/No #Spell-Descriptor/Air #Spell-School/Conjuration #Spell-Subschool/Creation #Spell-Level/Druid-6 #Spell-Descriptor/Earth #Saving-Throws/Fortitude-Negates #Spell-Range/Other
