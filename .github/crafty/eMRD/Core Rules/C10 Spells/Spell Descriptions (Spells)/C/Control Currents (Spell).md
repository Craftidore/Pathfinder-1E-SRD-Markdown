...
*Current Strength:* For every three caster levels, you can increase or decrease the current’s speed by 10 feet. For example, a 9th level druid could increase the speed of a vigorous current (20 feet per round) to a dangerous current (50 feet per round) or reduce it to calm, placid water. See Currents and Streams, (*Stormwrack* 10), for more information about current strength and [[Swim (Skill)|Swim]] checks.


---
## Tags
#Sources/Stormwrack #Rule-System/Pathfinder #Saving-Throws/None #Rule/NonOGL #Rule/Spell #Rule/3PP #Publisher/WotC #Spell-Rarity/Rare #Spell-Resistance/No #Spell-Level/Druid-4 #Spell-Range/Other #Spell-School/Transmutation #Spell-Descriptor/Water
