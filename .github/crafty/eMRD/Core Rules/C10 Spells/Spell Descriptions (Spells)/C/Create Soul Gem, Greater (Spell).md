...
Aliases:
  - "Create Soul Gem, Greater"
  - "greater create soul gem"
Category: "Spells"
Suffix: "Spell"
Tags:
  - "Category/Spells"
...
RWtopicId: "Topic_13636"
---
# Create Soul Gem, Greater (Spell)
## Overview
[[Necromancy Spells|Necromancy]] \[[[Death Spells|death]], [[Evil Spells|evil]]]

**Level:** [[5th Level Cleric Spells|Cleric 5]], [[5th Level Shaman Spells|Shaman 5]], [[5th Level Sorcerer Spells|Sorcerer 5]], [[5th Level Witch Spells|Witch 5]], [[5th Level Wizard Spells|Wizard 5]]
...
You draw forth the ebbing life force of a dying creature or one that has died in the recent past (1 round/3 caster levels), focusing it through a crystal lens focus to transform into a soul gem. If the creature is alive and fails its saving throw, it dies and you capture its soul in the gem. If the creature is dead, it can still resist the spell effect by attempting a Will save as if it were still alive. The value of the soul gem created depends on the nature of the creature it is made from (see below). Soul gems created by this spell crumble to dust once the spell’s duration expires, releasing the trapped soul to travel on to judgment in the Great Beyond.

Only one soul gem can be created from a dying creature. Any attempt to resurrect a body whose soul is trapped in a soul gem requires a caster check against *greater create soul gem*’s save DC. Failure results in the *[[Resurrection (Spell)|resurrection]]* spell having no effect, while success shatters the target’s soul gem and returns the creature to life as normal. If the soul gem resides in an unholy location, such as that created by the *[[Unhallow (Spell)|unhallow]]* spell, the DC of this check increases by 2.

If you are a souldrinker (*Book of the Damned* 212), you can cast this spell and expend 5 soul points to fill the gem with the equivalent of one basic soul.
...
---
## Tags
#Spell-Resistance/Yes #Rule/House-Rule #Sources/Book-of-the-Damned #Rule-System/Pathfinder #Spell-Descriptor/Death #Spell-Descriptor/Evil #Spell-School/Necromancy #Spell-Range/Other #Saving-Throws/Will-Negates #Rule/OGL #Rule/Spell #Publisher/Paizo #Rule/Core #Spell-Rarity/Uncommon #Rule/fm3 #Spell-Level/Cleric-5 #Spell-Level/Shaman-5 #Spell-Level/Sorcerer-Wizard-5 #Spell-Level/Witch-5
