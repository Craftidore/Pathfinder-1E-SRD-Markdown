...
**Components:** V, S, M (a used handkerchief)
...
This spell functions like *[[Fog Cloud (Spell)|fog cloud]]*, except as noted here. Each round that a creature is within the fog, it must make a Fortitude save or contract a disease equivalent to the [[Shakes|shakes]], which strikes immediately (no incubation period). A creature afflicted with this disease takes 1d8 points of Dexterity damage immediately, and each day that the disease persists, it must make a DC 13 Fortitude save or take another 1d8 points of Dexterity damage.
...
---
## Tags
#Sources/Spell-Compendium #Rule-System/Pathfinder #Rule/NonOGL #Rule/Spell #Rule/3PP #Publisher/WotC #Spell-Rarity/Rare #Saving-Throws/See-text #Spell-Resistance/No #Spell-School/Conjuration #Spell-Subschool/Creation #Spell-Range/Medium--100-ft----10-ft--level- #Spell-Level/Sorcerer-Wizard-3
