...
**Level:** [[8th Level Cleric Spells|Cleric 8]], [[8th Level Sorcerer Spells|Sorcerer 8]], [[6th Level Summoner Spells|Summoner 6]], [[8th Level Witch Spells|Witch 8]], [[8th Level Wizard Spells|Wizard 8]]

**BoXM:** [[BoXM 15th-Level Cleric Spells List|Cleric 15]], [[BoXM 15th-Level Wizard Spells List|Wizard 15]]
...
*Structure*: Your demiplane has a specific, linked physical structure, such as a giant tree, floating castle (up to 1,000 sq. ft./level), labyrinth, mountain, and so on. (This option exists so you can pick a theme for your plane without having to worry about the small details of determining what spells you need for every hill, hole, wall, floor, and corner).
...
You can make this spell permanent with the *[[Permanency (Spell)|permanency]]* spell, at a cost of 20,000 gp. If you have cast *create demiplane* multiple times to enlarge the demiplane, each casting’s area requires its own *[[Permanency (Spell)|permanency]]* spell.

**GM Note**

*House Rule:* Added the *spell-barred* feature. Like most of the features, it may be added more than once, effectively warding out several specific spells.

*House Rule:* Added the *warded* feature. Like most of the features, it may be added more than once, effectively warding out several types of creatures.


---
## Tags
#Rule/OGL #Spell-Resistance/No #Sources/Ultimate-Magic #Rule-System/Pathfinder #Spell-School/Conjuration #Spell-Subschool/Creation #Saving-Throws/None #Spell-Range/Other #Rule/Spell #Publisher/Paizo #Rule/Core #Spell-Rarity/Uncommon #Rule/fm3 #Spell-Level/Cleric-8 #Spell-Level/Sorcerer-Wizard-8 #Spell-Level/Summoner-6 #Spell-Level/Witch-8 #Rule/House-Rule
