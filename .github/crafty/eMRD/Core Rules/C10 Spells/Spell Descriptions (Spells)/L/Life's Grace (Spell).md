...
In addition, the subject’s armor or clothing is considered *[[Ghost Touch (Arm_ShldSpcAb)|ghost touch]]* armor, and its armor bonus counts against incorporeal attacks. (A suit of clothing is considered armor that gives +0 AC for this purpose, though it can be enhanced with spells such as *[[Magic Vestment (Spell)|magic vestment]]*.)
...
---
## Tags
#Spell-Resistance/Yes #Sources/Spell-Compendium #Rule-System/Pathfinder #Rule/NonOGL #Rule/Spell #Rule/3PP #Publisher/WotC #Spell-Rarity/Rare #Spell-School/Abjuration #Spell-Level/Cleric-5 #Spell-Range/Touch #Saving-Throws/Will-Negates
