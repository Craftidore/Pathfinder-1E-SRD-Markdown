...
The *ice assassin* spell is in many ways an improved version of *[[Simulacrum (Spell)|simulacrum]]*. Developed by powerful frost mages who have more than their fair share of enemies to fight, an *ice assassin* is an effective way to destroy an enemy without putting yourself at risk.

An *ice assassin* spell creates a living, breathing creature that is a near-perfect duplicate of an existing creature. The duplicate is formed entirely out of ice, but once the spell is in effect, it appears as an exact duplicate to all but its source, who always sees the *ice assassin* as an animated ice statue of himself. The *ice assassin* possesses all the skills, abilities, and memories possessed by the original, but its personality is warped and twisted by an all-consuming need to slay the original. It also constantly uses *[[Locate Creature (Spell)|locate creature]]* on its duplicate at a caster level equal to your own. If its quarry is outside the range of this effect, the *ice assassin* must rely on its own cleverness or advice from you to track the original.

The *ice assassin* has the cold subtype. Creatures familiar with the original might detect the ruse with a successful [[Perception (Skill)|Perception]] check. You must make a [[Disguise (Skill)|Disguise]] check (gaining a +10 circumstance bonus from the power of the spell) when you cast the spell to determine how good the likeness is.
...
---
## Tags
#Rule/Spell #Publisher/WotC #Rule/3PP #Rule/fm3 #Sources/Frostburn #Rule/OGL #Spell-Rarity/Rare #Saving-Throws/See-text #Spell-Resistance/No #Rule-System/Pathfinder #Spell-School/Illusion #Saving-Throws/None #Spell-Subschool/Shadow #Spell-Level/Sorcerer-Wizard-9 #Spell-Range/Touch
