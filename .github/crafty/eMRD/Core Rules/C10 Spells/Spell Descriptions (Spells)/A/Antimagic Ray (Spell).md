...
**Components:** V, S, M (a pinch of iron filings mixed with ruby dust worth 100 gp.)
...
**Source:** Spell Compendium (WotC), pg. 14
...
You must succeed on a ranged touch attack with the ray to strike a target. The target, if struck, functions as if it were inside an *[[Antimagic Field (Spell)|antimagic field]]* if it fails its Will save.
...
---
## Tags
#Spell-Resistance/Yes #Spell-School/Abjuration #Spell-Range/Close--25-ft----5-ft--2-levels- #Spell-Level/Sorcerer-Wizard-7 #Saving-Throws/Will-Negates #Rule-System/Pathfinder #Rule/NonOGL #Rule/Spell #Publisher/WotC #Rule/3PP #Sources/Spell-Compendium #Spell-Rarity/Rare
