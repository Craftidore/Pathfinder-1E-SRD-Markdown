...
The mud remains until a successful *[[Dispel Magic (Spell)|dispel magic]]* or *[[Transmute Mud to Rock (Spell)|transmute mud to rock]]* spell restores its substance—but not necessarily its form. Evaporation turns the mud to normal dirt over a period of days. The exact time depends on exposure to the sun, wind, and normal drainage.

*Transmute rock to mud* counters and dispels *[[Transmute Mud to Rock (Spell)|transmute mud to rock]]*.


---
## Tags
#Saving-Throws/See-text #Spell-Resistance/No #Rule-System/Pathfinder #Spell-Level/Druid-5 #Spell-Descriptor/Earth #Spell-Range/Medium--100-ft----10-ft--level- #Spell-Level/Sorcerer-Wizard-5 #Spell-School/Transmutation #Rule/OGL #Sources/PF-Core-Rulebook #Rule/Spell #Rule/Core #Publisher/Paizo #Spell-Rarity/Common
