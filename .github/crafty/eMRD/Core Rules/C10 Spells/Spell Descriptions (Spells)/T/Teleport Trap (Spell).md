...
*Teleport trap* can be made permanent at the cost of 7,000 gp. A single *[[Permanency (Spell)|permanency]]* spell can be used on all *teleport traps* that share a linked destination, but the gold piece cost must be paid for each individual spell.
...
*House Rule:* The password restriction only applies to teleporting out; the (keystone) item applies to both ways.


---
## Tags
#Rule/OGL #Spell-Resistance/Yes #Rule-System/Pathfinder #Spell-School/Abjuration #Spell-Range/Medium--100-ft----10-ft--level- #Spell-Level/Sorcerer-Wizard-7 #Saving-Throws/Will-Negates #Rule/Spell #Publisher/Paizo #Rule/Core #Spell-Rarity/Uncommon #Rule/fm3 #Sources/Inner-Sea-World-Guide #Rule/House-Rule
