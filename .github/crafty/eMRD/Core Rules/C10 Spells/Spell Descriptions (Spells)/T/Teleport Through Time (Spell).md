...
next:
  - "Time Conduit (Spell)"
RWtopicId: "Topic_16447"
---
# Teleport Through Time (Spell)
## Overview
[[Chronomancy Spells|Chronomancy]] ([[Teleportation Spells|teleportation]])
...
**Components:** V, S, M (see text), XP (1,000 XP)
...
**Source:** Wizards of the Coast website, Portals in Time, Pt 2:The Portal Through Time (Robert Wiese)

A far more powerful version of the *[[Teleport (Spell)|teleport]]* spell, this spell instantly transports the character to the same location, but to a different time. Interplanar travel is not possible, and the spell fails on any plane where time is meaningless. The character can bring along objects and willing creatures totaling up to 50 pounds per caster level. Unwilling creatures cannot be affected by this spell. Only objects held or in use (attended) by another person receive saving throws and spell resistance.
...
| **Temporal**<br>**Distance Traveled** | **Temporal**<br>**Drift\*** | **Chance of**<br>**Mishap** |
|---|---|---|
...
*House Rule:* Originally this spell's school was *transmutation (teleportation)*, however, that has been changed to *chronomancy (teleportation)* to reflect fundamental changes in how magic works within my campaigns.


---
## Tags
#Rule/NonOGL #Spell-Rarity/Rare #Rule/Spell #Publisher/WotC #Rule/3PP #Sources/Wizard-s-of-the-Coast-website #Rule/fm3 #Rule/House-Rule #Spell-Resistance/Yes #Spell-Resistance/No #Rule-System/Pathfinder #Saving-Throws/None #Spell-Range/Personal #Spell-Level/Sorcerer-Wizard-9 #Spell-Subschool/Teleportation #Spell-Range/Touch #Saving-Throws/Will-Negates
