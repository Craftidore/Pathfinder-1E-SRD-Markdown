...
**Source:** Spell Compendium (WotC), pg. 73
...
This spell functions like *[[Dream (Spell)|dream]]*, except as noted above and that you can alter the sleeping person’s dreams to produce a specific desired effect. The dreamer gets a Will saving throw to resist the additional effects of this spell; if the save succeeds, the *dream casting* spell can send only a message, in the manner of the *[[Dream (Spell)|dream]]* spell. If the saving throw fails, you decide what additional effect the message carries.

*Fear:* Your image in the dream is surrounded by intimidating imagery and an aura of power. For the duration of the spell, any time the dreamer can see you or knows you are present, he is [[Shaken|shaken]]. This is a compulsion and fear effect.

*Charm:* Your image in the dream appears particularly helpful and kind. For the duration of the spell, the dreamer is under the effect of a *[[Charm Monster (Spell)|charm monster]]* spell. This is a charm effect.
...
*Harrow:* Your image in the dream behaves in a bizarre and irrational manner. For the duration of the spell, the dreamer behaves in an unusual manner, gaining two random traits from Table 4–24: One Hundred Traits (*DMG 3.5* 128), rerolling any results not pertinent to behavior. If the dreamer can see you or knows you are present, he is *[[Confused|confused]]* for 1 round/level.


---
## Tags
#Spell-Resistance/Yes #Sources/Spell-Compendium #Rule-System/Pathfinder #Rule/NonOGL #Rule/Spell #Rule/3PP #Publisher/WotC #Spell-Rarity/Rare #Saving-Throws/See-text #Spell-School/Illusion #Spell-Descriptor/Mind-Affecting #Spell-Subschool/Phantasm #Spell-Level/Sorcerer-Wizard-6 #Spell-Range/Unlimited #Saving-Throws/Will-Negates
