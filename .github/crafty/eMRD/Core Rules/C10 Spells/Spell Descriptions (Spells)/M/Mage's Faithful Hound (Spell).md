...
If an intruder approaches to within 5 feet of the hound, the dog stops barking and delivers a vicious bite (+10 attack bonus, 2d6+3 points of piercing damage) once per round. The dog also gets the bonuses appropriate to an invisible creature (see *[[Invisibility (Spell)|invisibility]]*).
...
*House Rule:* In the World of Greyhawk campaign setting this spell is known as *Mordenkainen's faithful hound.*


---
## Tags
#Spell-Level/Summoner-4 #Rule/OGL #Spell-Resistance/No #Rule-System/Pathfinder #Spell-Range/Close--25-ft----5-ft--2-levels- #Spell-School/Conjuration #Spell-Subschool/Creation #Saving-Throws/None #Spell-Level/Sorcerer-Wizard-5 #Sources/PF-Core-Rulebook #Rule/Spell #Publisher/Paizo #Rule/Core #Spell-Rarity/Common #Rule/House-Rule
