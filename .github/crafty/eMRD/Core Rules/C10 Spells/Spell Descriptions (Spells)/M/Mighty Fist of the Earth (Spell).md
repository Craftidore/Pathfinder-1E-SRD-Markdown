...
At 4th level, a qinggong monk (*Ultimate Magic* 51) may select this spell as a *ki* power costing 1 *ki* point to activate (if the monk has 0 *ki* points after activating this *ki* power, the rock does not count as a *ki* strike).


---
## Tags
#Spell-Level/Cleric-1 #Spell-Range/Close--25-ft----5-ft--2-levels- #Spell-School/Conjuration #Spell-Subschool/Creation #Spell-Level/Druid-1 #Spell-Descriptor/Earth #Spell-Resistance/Yes #Sources/Advanced-Race-Guide #Rule-System/Pathfinder #Saving-Throws/None #Rule/OGL #Rule/Spell #Rule/Core #Publisher/Paizo #Spell-Rarity/Uncommon
