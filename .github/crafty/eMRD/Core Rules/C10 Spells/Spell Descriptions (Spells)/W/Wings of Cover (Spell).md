...
Your foe could choose to attack the area in which you have taken cover with an area attack (such as a *[[Fireball (Spell)|fireball]]* spell). In this case, you gain a +8 bonus to AC (if applicable) and a +4 bonus on Reflex saves.
...
*House Rule:* Added Wizard 2 to Level.


---
## Tags
#Rule/NonOGL #Spell-Resistance/No #Rule/House-Rule #Rule-System/Pathfinder #Spell-School/Evocation #Spell-Descriptor/Force #Saving-Throws/None #Spell-Range/Personal #Spell-Level/Sorcerer-Wizard-2 #Rule/Spell #Publisher/WotC #Rule/3PP #Spell-Rarity/Rare #Rule/fm3 #Sources/Races-of-the-Dragon
