...
**Components:** V, S, Coldfire (Three ounces of coldfire)
...
The opaqueness of the coldfire grants concealment (20% miss chance) against attacks made from the opposite side of the wall. If any 5-foot length of wall takes 20 points of fi re damage or more in 1 round, that length goes out. (Do not divide fi re damage by 4, as for normal objects.)

*Wall of coldfire* can be made permanent with a *[[Permanency (Spell)|permanency]]* spell.
...
---
## Tags
#Rule/NonOGL #Sources/Frostburn #Rule-System/Pathfinder #Rule/Spell #Rule/3PP #Publisher/WotC #Spell-Rarity/Rare #Spell-Resistance/Yes #Spell-Descriptor/Cold #Spell-Level/Druid-5 #Spell-School/Evocation #Spell-Range/Medium--100-ft----10-ft--level- #Saving-Throws/None #Spell-Level/Sorcerer-Wizard-4
