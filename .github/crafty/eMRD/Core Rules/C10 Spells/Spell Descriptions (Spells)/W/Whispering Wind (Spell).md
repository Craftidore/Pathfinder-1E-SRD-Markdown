...
When the spell reaches its objective, it swirls and remains in place until the message is delivered. As with *[[Magic Mouth (Spell)|magic mouth]], whispering wind* cannot speak verbal components, use command words, or activate magical effects.


---
## Tags
#Spell-Resistance/No #Rule-System/Pathfinder #Spell-Descriptor/Air #Spell-Level/Bard-2 #Saving-Throws/None #Spell-Range/Other #Spell-Level/Sorcerer-Wizard-2 #Spell-School/Transmutation #Rule/OGL #Sources/PF-Core-Rulebook #Rule/Spell #Publisher/Paizo #Rule/Core #Spell-Rarity/Common
