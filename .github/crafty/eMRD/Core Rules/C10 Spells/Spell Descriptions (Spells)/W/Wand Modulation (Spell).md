...
**Source:** Complete Scoundrel (WotC), pg. 105
...
For example, a 5th-level wizard facing an angry fire elemental wishes to cast *magic missile* (a 1st-level spell) from his *wand of scorching ray* (a 2nd-level spell), which happens to have a caster level of 5th. He casts *wand modulation* and in the following round casts *[[Magic Missile (Spell)|magic missile]]*. The wand can now cast *magic missile* as a 1st-level caster (the minimum caster level), but each use expends 2 charges. The wizard can now use the wand to cast *[[Magic Missile (Spell)|magic missile]]* for 5 minutes, after which it reverts back to a normal *wand of scorching ray*.


---
## Tags
#Spell-Resistance/Yes #Rule-System/Pathfinder #Saving-Throws/None #Spell-Level/Sorcerer-Wizard-3 #Spell-Range/Touch #Spell-School/Transmutation #Rule/NonOGL #Sources/Complete-Scoundrel #Rule/Spell #Rule/3PP #Publisher/WotC #Spell-Rarity/Rare #Rule/fm3
