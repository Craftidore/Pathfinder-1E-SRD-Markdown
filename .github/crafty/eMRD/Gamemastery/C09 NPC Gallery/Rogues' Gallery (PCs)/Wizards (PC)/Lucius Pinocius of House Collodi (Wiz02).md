...
**hp:** *30* (2d6+20 War titan alternate racial trait: 6, 4)
...
*1st—[[Alarm (Spell)|alarm]], [[Animate Tattoo (Spell)|animate tattoo]], [[Burning Hands (Spell)|burning hands]], [[Charm Person (Spell)|charm person]], [[Color Spray (Spell)|color spray]], [[Comprehend Languages (Spell)|comprehend languages]], [[Crafter's Fortune (Spell)|crafter's fortune]], [[Erase (Spell)|erase]], [[Expeditious Retreat (Spell)|expeditious retreat]], [[Feather Fall (Spell)|feather fall]], [[Floating Disk (Spell)|floating disk]], [[Identify (Spell)|identify]], [[Infernal Healing (Spell)|infernal healing]], [[Mage Armor (Spell)|mage armor]], [[Magic Missile (Spell)|magic missile]], [[Obscuring Mist (Spell)|obscuring mist]], [[Phantom Worker (Spell)|phantom worker]], [[Ray of Enfeeblement (Spell)|ray of enfeeblement]], [[Secluded Grimoire (Spell)|secluded grimoire]], [[Shield (Spell)|shield]], [[Sleep (Spell)|sleep]], [[Tireless (Spell)|tireless]], [[Unseen Servant (Spell)|unseen servant]], [[Vanish (Spell)|vanish]], [[Weaponwand (Spell)|weaponwand]],* 

*0—[[Acid Splash (Spell)|acid splash]], [[Amanuensis (Spell)|amanuensis]], [[Arcane Mark (Spell)|arcane mark]], [[Canny Effort (Spell)|canny effort]], [[Daze (Spell)|daze]], [[Detect Magic (Spell)|detect magic]], [[Detect Poison (Spell)|detect poison]], [[Disrupt Undead (Spell)|disrupt undead]], [[Electric Jolt (Spell)|electric jolt]], [[Ghost Sound (Spell)|ghost sound]], [[Launch Bolt (Spell)|launch bolt]], [[Launch Item (Spell)|launch item]], [[Light Spells|light]], [[Mending (Spell)|mending]], [[Message (Spell)|message]], [[Open_Close (Spell)|open/close]], [[Prestidigitation (Spell)|prestidigitation]], [[Ray of Frost (Spell)|ray of frost]], [[Read Magic (Spell)|read magic]], [[Repair Minor Damage (Spell)|repair minor damage]], [[Resistance (Spell)|resistance]]*
...
*7th—arcane cannon, [[Banishment (Spell)|banishment]], [[Finger of Death (Spell)|finger of death]], greater arcane sight, greater teleport, lesser create demiplane, limited wish, plane shift, prismatic spray, project image, reverse gravity, simulacrum, spell turning, teleport trap, vision,*
...
*1st—abundant ammunition, ancient knowledge, anticipated attack, appraising touch, arcane sensitivity, buzzing bee, combat precognition, crafter's gift, critical strike, darklight, delay image, detect undead, discern next of kin, disguise self, endure elements, enlarge person, gravity bow, grease, guide craft, handy grapnel, helpful hand, hidden ward, hold portal, instant knowledge, instant locksmith, instant search, ironpage, lesser deflect, lesser recharge innate magic, line in the sand, lock gaze, long arm, mage clock, magecraft, magic aura, memorize page, metamorphose liquids, minor image, mistsight, nerveskitter, nightshield, persistent blade, protection from chaos, protection from evil, protection from good, protection from law, ray of clumsiness, repair light damage, restful sleep, scales of the lizard, scholar's touch, shocking grasp, silent image, spell flower, spirit shape, stunning barrier, transmute coinage to gem, true casting, true skill, true strike, unseen crafter, ventriloquism, waterproof, windy escape, wings of swift flying,*
