...
down:
  ...
  - "Duck and Cover (Feat)"
RWtopicId: "Topic_16104"
---
# D
## Overview
| **Feats** | **Prerequisites** | **Benefits** |
|---|---|---|
| Darkness Trick | [[Use Magic Device (Skill)\|Use Magic Device]] 5 ranks, ability to cast *[[Darkness (Spell)\|darkness]]* | Deactivate a magic weapon’s light |
...
| Deceptive Exchange | [[Improved Feint (Feat)\|Improved Feint]] | Upon successful [[Feint\|feint]], you may force opponent to accept an object |
...
| [[Deep Lunge (Feat)\|Deep Lunge]] | Base attack bonus +1 | Attack as though using a reach weapon |
| Deepsight | Darkvision 60 feet | Your darkvision has a range of 120 feet |
| Defender's Reflexes \* | Str 20+, Combat Reflexes | Use Str modifier instead of Dex modifier for number of attacks of opportunity |
...
| Dueling Mastery \* | Exotic Weapon Proficiency (dueling sword), Quick Draw, Weapon Finesse, Weapon Focus (dueling sword) | Gain combat benefits when using dueling sword |
