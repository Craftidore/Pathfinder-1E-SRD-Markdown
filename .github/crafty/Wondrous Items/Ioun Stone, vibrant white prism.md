...
Aliases:
  - "vibrant white prism ioun stone"
...
This ioun stone stores a 3rd level spell, as a *[[Spell Storing, Minor (Ring)|ring of spell storing (minor)]]*, except the stone can only contain a single 3rd level spell*,* while orbiting.
...
**Source:** True Arcane Story: Ioun Stones (Louis Porter Jr. Design), pg. 9

**GM Note**

*House Rule:*  Changed from vibrant purple prism to vibrant white prism to avoid duplication.


---
## Tags
#Publisher/Louis-Porter-Jr--Design #Sources/True-Arcane-Story--Ioun-Stones #Rule/OGL #Rule/3PP #Rule-System/Pathfinder #Special-Item-Type/Magic-Item #Magic-Item-Type/Wondrous-Item #Rule/Wondrous-Item #Magic-Item-Slot/None #Price-Band/16-001--gp
