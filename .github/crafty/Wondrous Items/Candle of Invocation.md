...
In addition, burning a candle also allows the owner to cast a *[[Gate (Spell)|gate]]* spell, the respondent being of the same alignment as the candle, but the taper is immediately consumed in the process.

**Construction**

**Requirements** [[Craft Wondrous Item (Feat)|Craft Wondrous Item]], *[[Gate (Spell)|gate]],* creator must be same alignment as candle created
...
---
## Tags
#Sources/PF-Core-Rulebook #Rule-System/Pathfinder #Price-Band/8-001---16-000-gp #Special-Item-Type/Magic-Item #Magic-Item-Slot/None #Magic-Item-Type/Wondrous-Item #Publisher/Paizo #Rule/Core
