...
Divine wisdom infuses this stone, which is finely inlaid in gold. The user of this stone has access to a daily reservoir of divine energy, which she can use to empower her existing class abilities. Once per day, the energy in this stone can be used to make an extra smite attempt (such as smite evil) or an extra use of channel energy. Alternatively, it may be used to prepare an extra divine spell of 2nd level or lower. 
