...
This more advanced form of crystal ball has an additional power that allows the user to *[[Detect Thoughts (Spell)|detect thoughts]]* (as the spell; Will DC 13 negates) on the target viewed. 
