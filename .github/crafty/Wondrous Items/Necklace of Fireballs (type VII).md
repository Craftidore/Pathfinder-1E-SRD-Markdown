...
RWtopicId: "Topic_19148"
---
# Necklace of Fireballs (type VII)
## Overview
**Aura** moderate evocation; **CL** 10th

**Slot** neck (does not take up slot)
...
| **Necklace** | **10d6** | **9d6** | **8d6** | **7d6** | **6d6** | **5d6** | **4d6** | **3d6** | **2d6** |
|---|---|---|---|---|---|---|---|---|---|
| Type VII | 1 | 2 | — | 2 | — | 2 | — | 2 | — |
...
**Requirements** [[Craft Wondrous Item (Feat)|Craft Wondrous Item]], *[[Fireball (Spell)|fireball]]*
