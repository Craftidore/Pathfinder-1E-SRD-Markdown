...
This ordinary-looking, windowless tent appears to cover only a 10-foot-by-10-foot area, but, inside, it measures a full 30 feet by 30 feet, with a large central area and three small “bedrooms” (separated by curtains) along the back wall. The interior can be lit on command, and can be adjusted from normal darkness as per the spell *[[Light (Spell)|light]]*. Occupants inside the tent cannot be seen, heard, or smelled by creatures outside.
...
**Requirements** [[Craft Wondrous Item (Feat)|Craft Wondrous Item]], *[[Hide From Animals (Spell)|hide from animals]]**,* *[[Tiny Hut (Spell)|tiny hut]]*

**Cost** 3,200 gp

**Source:** Sargava, The Lost Colony, pg. 29


---
## Tags
#Rule/fm3 #Sources/Sargava--the-Lost-Colony #Rule-System/Pathfinder #Price-Band/4-001---8-000-gp #Special-Item-Type/Magic-Item #Magic-Item-Slot/None #Magic-Item-Type/Wondrous-Item #Rule/OGL #Rule/Core #Publisher/Paizo
