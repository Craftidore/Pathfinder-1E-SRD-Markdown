...
This ioun stone*,* while orbiting, prevents a party from becoming lost. Orbiting its owner, it flashes with a faint light whenever it points north relative to the owner. This flash of light imposes a -1 penalty to the owner’s [[Stealth (Skill)|Stealth]] checks unless the stone is stowed.
...
---
## Tags
#Publisher/Kobold-Press #Sources/Deep-Magic #Rule/OGL #Rule/3PP #Rule-System/Pathfinder #Special-Item-Type/Magic-Item #Magic-Item-Type/Wondrous-Item #Rule/Wondrous-Item #Magic-Item-Slot/None #Price-Band/1-001---2-000-gp
