...
*An extremely tall, pale-skinned elf with flowing white hair and piercing red eyes.*

***Kraelyn*    CR: *01                                                                                                                                                                                     *** Type symbol, terrain symbol, climate symbol

**XP: *0***

*Male Elf (Rockseer) [[Poleiheira Adherent (Archetype)|Poleiheira Adherent]] Level 01*
...
| [[Linguistics (PF Freeport Comp)\|Linguistics]] | +xx |  |  |  |  | Int |  |  |
...
Combat Maneuver Defense: + 13 = 10 + 0 \[base] + 1 \[strength] + 2 \[dexterity]
...
Languages:              Common, Draconic, Drow, Drow Sign, Dwarven, Elven, Ignan
...
Non-specializing wizards can now use melee weapons to 30 feet, the return to the hand, int mod to hit, strength mod for damage. At level 8, apply one metamagic to a spell you are casting.
...
L01: Wizard 01, BAB +0, Collegiate Wizard (starting feat)
