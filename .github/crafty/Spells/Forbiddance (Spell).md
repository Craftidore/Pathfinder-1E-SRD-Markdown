...
*Forbiddance* seals an area against all planar travel into or within it. This includes all teleportation spells (such as *[[Dimension Door (Spell)|dimension door]]* and *[[Teleport (Spell)|teleport]]**),* plane shifting*,* astral travel, ethereal travel, and all summoning spells. Such effects simply fail automatically.
...
*[[Dispel Magic (Spell)|Dispel magic]]* does not dispel a *forbiddance* effect unless the dispeller’s level is at least as high as your caster level.
...
---
## Tags
#Sources/PF-Core-Rulebook #Rule/Spell #Publisher/Paizo #Rule/Core #Spell-Rarity/Common #Saving-Throws/See-text #Spell-Resistance/Yes #Rule-System/Pathfinder #Spell-School/Abjuration #Spell-Level/Cleric-6 #Spell-Range/Medium--100-ft----10-ft--level-
