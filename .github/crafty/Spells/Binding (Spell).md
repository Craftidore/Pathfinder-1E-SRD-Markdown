...
**Level:** [[8th Level Sorcerer Spells|Sorcerer 8]], [[6th Level Summoner Spells|Summoner 6]], [[8th Level Wizard Spells|Wizard 8]]
...
**Source:** PF Core Rulebook, pg. 248
...
*Chaining*: The subject is confined by restraints that generate an *[[Antipathy (Spell)|antipathy]]* spell affecting all creatures who approach the subject, except you. The duration is 1 year per caster level. The subject of this form of *binding* is confined to the spot it occupied when it received the spell. Casting this version requires a chain that is long enough to wrap around the creature three times.
...
You can’t dispel a *binding* spell with *[[Dispel Magic (Spell)|dispel magic]]* or a similar effect, though an *[[Antimagic Field (Spell)|antimagic field]]* or *[[Mage's Disjunction (Spell)|mage’s disjunction]]* affects it normally. A bound extraplanar creature cannot be sent back to its home plane by *[[Dismissal (Spell)|dismissal]]**,* *[[Banishment (Spell)|banishment]]**,* or a similar effect.


---
## Tags
#Spell-Level/Summoner-6 #Rule/OGL #Sources/PF-Core-Rulebook #Rule/Spell #Publisher/Paizo #Rule/Core #Rule/fm3 #Spell-Rarity/Common #Saving-Throws/See-text #Spell-Resistance/Yes #Rule-System/Pathfinder #Spell-Range/Close--25-ft----5-ft--2-levels- #Spell-Subschool/Compulsion #Spell-School/Enchantment #Spell-Descriptor/Mind-Affecting #Spell-Level/Sorcerer-Wizard-8 #Saving-Throws/Will-Negates
