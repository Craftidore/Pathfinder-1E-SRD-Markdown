...
**Components:** V, S, F (a fang from any reptile)
...
**Source:** Spell Compendium (WotC), pg. 108
...
In each round when the *gutsnake* is constricting a target, you cannot move more than 5 feet away from that target, unless the *gutsnake* makes a successful grapple check to carry the opponent with you when you move. This is the only way in which the tentacle restricts movement. While the snake is present, you can use its [[Acrobatics (Skill)|Acrobatics]] (3.5 Balance) and [[Climb (Skill)|Climb]] skill modifiers instead of your own, and you gain a climb speed of 20 feet.
