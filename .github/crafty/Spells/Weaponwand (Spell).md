...
**Level:** [[1st Level Bard Spells|Bard 1]], [[1st Level Cleric Spells|Cleric 1]], [[1st Level Inquisitor Spells|Inquisitor 1]], [[1st Level Magus Spells|Magus 1]], [[1st Level Sorcerer Spells|Sorcerer 1]], [[1st Level Wizard Spells|Wizard 1]]
...
At the end of the spell’s duration, the encased wand is ejected from the weapon. If you have a free hand, you may catch the weapon as a free action; otherwise, the wand drops to the ground. If the weapon housing the wand is [[Broken|broken]] or destroyed during the duration of *weaponwand*, the encased wand is similarly [[Broken|broken]] or destroyed.

**GM Note**

*House Rule:* Added Sorcerer 1, Wizard 1 to Level.

*House Rule:* *Weaponwand* can be used as part of a weapon's creation increasing the cost as usual. As a standard action a wand can be either placed inside the *weaponwanded* weapon or removed from it.


---
## Tags
#Spell-Resistance/Yes #Sources/Inner-Sea-Magic #Rule-System/Pathfinder #Rule/OGL #Rule/Spell #Rule/Core #Publisher/Paizo #Spell-Rarity/Uncommon #Spell-Level/Investigator-1 #Rule/House-Rule #Spell-Level/Bard-1 #Spell-Level/Cleric-1 #Spell-Level/Magus-1 #Spell-Level/Sorcerer-Wizard-1 #Spell-Range/Touch #Spell-School/Transmutation #Saving-Throws/Will-Negates #Rule/fm3
