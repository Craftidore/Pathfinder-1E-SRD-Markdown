...
*A shimmering aura takes the shape of a multilegged creature from nightmare, instantly leaping into battle against your foes.*
...
*Dream spirits* are material in nature, and so are not affected by *[[Dismissal (Spell)|dismissal]]* and similar effects. They are not subject to effects that affect outsiders.


---
## Tags
#Sources/Secrets-of-Sarlona #Rule-System/Pathfinder #Saving-Throws/None #Rule/NonOGL #Rule/Spell #Rule/3PP #Publisher/WotC #Spell-Rarity/Rare #Spell-Resistance/No #Spell-School/Conjuration #Spell-Range/Medium--100-ft----10-ft--level- #Spell-Level/Sorcerer-Wizard-3
