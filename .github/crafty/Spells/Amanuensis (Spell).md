...
**Level:** [[0 Level Cleric Spells|Cleric 0]], [[0 Level Sorcerer Spells|Sorcerer 0]], [[0 Level Wizard Spells|Wizard 0]]
...
**Source:** Spell Compendium (WotC), pg. 9
...
You cause writing from one source (such as a book) to be copied into a book, paper, or parchment. This spell copies 250 words per minute and creates a perfect duplicate of the original. The spell copies only nonmagical text, not illustrations or magical writings (such as the text of a spellbook, a spell scroll, or a *[[Sepia Snake Sigil (Spell)|sepia snake sigil]]*). If the target contains normal and magical writing (such as a letter with *[[Explosive Runes (Spell)|explosive runes]]*), only the normal text is copied, leaving blank space in the copied text where the magical writing would be expected. Likewise, if the target contains text and illustration, only the text is copied.
...
---
## Tags
#Spell-Resistance/Yes #Sources/Spell-Compendium #Rule-System/Pathfinder #Spell-Range/Close--25-ft----5-ft--2-levels- #Spell-Level/Sorcerer-Wizard-0 #Spell-School/Transmutation #Saving-Throws/Will-Negates #Rule/Spell #Publisher/WotC #Rule/3PP #Spell-Rarity/Rare #Rule/NonOGL #Spell-Level/Cleric-0
