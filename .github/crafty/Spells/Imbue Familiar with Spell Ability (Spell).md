...
The spell can be dispelled; if this happens, the spells transferred are lost as if the familiar had cast them. In an *[[Antimagic Field (Spell)|antimagic field]],* the familiar loses the ability to cast the imbued spells, but regains it again if it leaves the field (as long as the spell’s duration hasn’t expired).
...
---
## Tags
#Spell-Resistance/Yes #Sources/Spell-Compendium #Rule-System/Pathfinder #Rule/NonOGL #Rule/Spell #Rule/3PP #Publisher/WotC #Spell-Rarity/Rare #Spell-Level/Sorcerer-Wizard-6 #Spell-Range/Touch #Saving-Throws/Will-Negates #Spell-School/Universal
