...
RWtopicId: "Topic_14564"
---
# Symbol of Death (Spell)
## Overview
[[Necromancy Spells|Necromancy]] \[[[Death Spells|death]], [[Ectomancy Spells|ectomancy]]]
...
A *symbol of death* can be removed by a successful *[[Dispel Magic (Spell)|dispel magic]]* targeted solely on the rune. An *[[Erase (Spell)|erase]]* spell has no effect on a *symbol of death.* Destruction of the surface where a *symbol of death* is inscribed destroys the *symbol* but also triggers it.

*Symbol of death* can be made permanent with a *[[Permanency (Spell)|permanency]]* spell. A permanent *symbol of death* that is disabled or has affected its maximum number of hit points becomes inactive for 10 minutes, but then can be triggered again as normal.

*Note*: Magic traps such as *symbol of death* are hard to detect and disable. A rogue (only) can use the [[Perception (Skill)|Perception]] skill to find a *symbol of death* and [[Disable Device (Skill)|Disable Device]] to thwart it. The DC in each case is 25 + spell level, or 33 for *symbol of death*.


---
## Tags
#Spell-Resistance/Yes #Rule-System/Pathfinder #Spell-Level/Cleric-8 #Spell-Descriptor/Death #Saving-Throws/Fortitude-Negates #Spell-School/Necromancy #Spell-Range/Other #Spell-Level/Sorcerer-Wizard-8 #Rule/OGL #Spell-Descriptor/Ectomancy #Sources/PF-Core-Rulebook #Rule/Spell #Rule/Core #Publisher/Paizo #Spell-Rarity/Common
