...
The subject’s armor (including natural armor) becomes worthless, though its modifiers for size, Dexterity, and deflection still apply to Armor Class, as do armor bonuses from force effects (for example, from the *[[Mage Armor (Spell)|mage armor]]* [[Eschew Materials (Feat)|Eschew Materials]], [[Silent Spell (Feat)|Silent Spell]], and [[Still Spell (Feat)|Still Spell]].) The subject loses all supernatural abilities while in amorphous form, and its magic items, aside from those bonuses noted above, cease functioning as long as it remains amorphous.
...
---
## Tags
#Rule-System/Pathfinder #Rule/NonOGL #Rule/Spell #Publisher/WotC #Rule/3PP #Sources/Spell-Compendium #Spell-Rarity/Rare #Spell-Resistance/Yes #Spell-Level/Assassin-3 #Spell-Level/Sorcerer-Wizard-3 #Spell-Range/Touch #Spell-School/Transmutation #Saving-Throws/Will-Negates
