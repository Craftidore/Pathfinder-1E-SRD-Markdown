...
**Level:** [[6th Level Alchemist Spells|Alchemist 6]]
...
The body you do not inhabit crumbles into dust when the extract’s duration expires or is dismissed. If the body you inhabit is destroyed, you immediately shift to your surviving self and the extract immediately ends. The body you left behind crumbles into dust, and you are [[Stunned|stunned]] until the start of your next turn. If the body you do not inhabit is destroyed, the extract also ends immediately, but you suffer no ill effects.

You have no special ability to sense what your second body is experiencing, though you immediately know if it has been destroyed. You may switch between bodies at any distance on the same plane. If your bodies cross into separate planes (including through the use of *[[Teleport (Spell)|teleport]]* or *[[Blink (Spell)|blink]]*), the body you inhabit survives, while your other body is destroyed.


---
## Tags
#Spell-Resistance/Yes #Sources/Advanced-Player-s-Guide #Rule-System/Pathfinder #Rule/OGL #Rule/Spell #Rule/Core #Publisher/Paizo #Spell-Rarity/Uncommon #Spell-Level/Alchemist-6 #Spell-Range/Personal #Spell-School/Transmutation
