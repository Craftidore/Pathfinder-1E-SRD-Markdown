...
**Source:** Wizard's of the Coast website (The Hidden Depth's Below: Spells of the Deep Underdark)

All that occurs in the depths of the Underdark is witnessed by the stone. Over the ages, an infinite legion of events has come to pass, and in their passing they have left their mark upon the stones of the Underdark. The *[[Stone Tell (Spell)|stone tell]]* spell allows you to "tap into" this resonance of events to a limited extent, but this bonding is only a scratching of the surface of the strange phenomenon known to a few as the *deepsong*.
...
---
## Tags
#Rule/NonOGL #Rule/Spell #Publisher/WotC #Rule/3PP #Sources/Wizard-s-of-the-Coast-website #Spell-Rarity/Rare #Spell-Resistance/No #Rule-System/Pathfinder #Spell-School/Divination #Spell-Level/Druid-7 #Saving-Throws/None #Spell-Range/Personal
