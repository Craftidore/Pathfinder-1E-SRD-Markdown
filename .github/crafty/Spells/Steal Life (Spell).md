...
**BoXM:** [[Book of Experimental Might Wizard Spell Lists|Wizard 15]]

**Casting Time:** 1 standard action

**Components:** V, S, Location (an area under the effect of a *[[Desecrate (Spell)|desecrate]]* or *[[Unhallow (Spell)|unhallow]]* spell)
...
**Source:** Book of Vile Darkness (WotC)­, pg. 106
...
*House Rule:* The target of this spell is not automatically aware of this; unless the caster makes the target aware of that they are, in fact the target, it requires a [[Spellcraft (Skill)|Spellcraft]] check (DC 18 plus the casting modifier of the caster (Int for wizards, Cha for sorcerers) to realize they are the target.

Using this spell in conjunction with a *[[Finding the Center (Spell)|finding the center]]* spell makes it very powerful.


---
## Tags
#Spell-Resistance/Yes #Rule-System/Pathfinder #Spell-Range/Close--25-ft----5-ft--2-levels- #Spell-Descriptor/Evil #Saving-Throws/Fortitude-Negates #Spell-School/Necromancy #Spell-Level/Sorcerer-Wizard-8 #Rule/NonOGL #Sources/Book-of-Vile-Darkness #Rule/Spell #Publisher/WotC #Rule/3PP #Rule/fm3 #Rule/House-Rule #Spell-Rarity/Rare
