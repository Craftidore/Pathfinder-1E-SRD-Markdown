...
\*Bebilith attempts to start a grapple with its target. On a successful grapple check, bebilith and its victim are both affected by the bebilith’s *[[Plane Shift (Spell)|plane shift]]* ability (this ability allows the bebilith to take a creature with it, which it can’t otherwise do).

---
## Tags
#Spell-Resistance/No #Rule-System/Pathfinder #Spell-Subschool/Calling #Spell-Range/Close--25-ft----5-ft--2-levels- #Spell-School/Conjuration #Spell-Descriptor/Evil #Saving-Throws/None #Spell-Level/Sorcerer-Wizard-6 #Rule/NonOGL #Sources/Book-of-Vile-Darkness #Rule/Spell #Publisher/WotC #Rule/3PP #Spell-Rarity/Rare
