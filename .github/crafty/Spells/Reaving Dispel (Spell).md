...
**Source:** Spell Compendium (WotC), pg. 169
...
This spell functions like *[[Dispel Magic (Spell)|dispel magic]]*, except that your caster level for your dispel check is a maximum of +20 instead of +10, and (as with *[[Dispel Magic, Greater (Spell)|greater dispel magic]]*) you have a chance to dispel any effect that *[[Remove Curse (Spell)|remove curse]]* can remove, even if *[[Dispel Magic (Spell)|dispel magic]]* can’t dispel that effect. When casting a targeted dispel or counterspell, you can choose to reave each spell you successfully dispel, stealing its power and effect for yourself. When making a targeted dispel, make a [[Spellcraft (Skill)|Spellcraft]] check (DC 25 + spell level) to identify the target spell or each ongoing spell currently in effect on the target creature or object.
...
---
## Tags
#Saving-Throws/See-text #Spell-Resistance/No #Spell-School/Abjuration #Spell-Range/Medium--100-ft----10-ft--level- #Spell-Level/Sorcerer-Wizard-9 #Sources/Spell-Compendium #Rule-System/Pathfinder #Rule/NonOGL #Rule/Spell #Rule/3PP #Publisher/WotC #Spell-Rarity/Rare
