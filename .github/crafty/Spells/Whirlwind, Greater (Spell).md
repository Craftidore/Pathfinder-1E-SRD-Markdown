...
**Level:** [[9th Level Druid Spells|Druid 9]], [[Windstorm (Domain)|Windstorm]] 9
...
**Source:** Spell Compendium (WotC), pg. 239
...
This spell is a more potent version of *[[Whirlwind (Spell)|whirlwind]]*. A *greater whirlwind* affects creatures differently, depending on their size and where they are in relation to the twister.
...
*Terrain and Structures:* The tornado uproots trees and other vegetation automatically, and it leaves a trail of dense rubble wherever it goes. Structures within a *greater whirlwind* take 2d6×10 points of damage per round. In a round or two, that amount of damage is sufficient to destroy any building made of materials less sturdy than reinforced masonry.

No ranged attacks can pass through the twister. A *greater whirlwind* extinguishes all flames it touches. [[Perception (Skill)|Perception]] (v3.5 Listen) checks are impossible within a *greater whirlwind.*
...
---
## Tags
#Spell-Resistance/Yes #Sources/Spell-Compendium #Rule-System/Pathfinder #Rule/NonOGL #Rule/Spell #Rule/3PP #Publisher/WotC #Spell-Rarity/Rare #Spell-Descriptor/Air #Spell-Level/Druid-9 #Spell-School/Evocation #Saving-Throws/Fortitude-Partial #Spell-Range/Medium--100-ft----10-ft--level- #Domain/Windstorm
