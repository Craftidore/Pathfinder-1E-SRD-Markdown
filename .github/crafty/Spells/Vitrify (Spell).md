...
RWtopicId: "Topic_13623"
---
# Vitrify (Spell)
## Overview
[[Transmutation Spells|Transmutation]] \[[[Earth Spells|earth]]]

**Level: [[Sand (Domain)|Sand 7]]**, [[7th Level Sorcerer Spells|Sorcerer 7]], [[7th Level Wizard Spells|Wizard 7]]
...
**Source:** Sandstorm (WotC), pg. 125

This spell transforms normal sand of any depth into crude glass. The sand is instantly heated to the melting point and then slowly hardens in its new form. Objects on or in the sand sink into the hot glass. A creature is allowed a Refl ex save to escape before the area is changed. A creature that fails its save and that is unable to levitate, fly, or otherwise free itself sinks partway into the molten glass, reducing its speed to 5 feet and giving it a –2 penalty on attack rolls and to AC. Creatures of the earth subtype can move only 10 feet per round slower in molten glass. If a creature is only partially in the area (such as a Large or larger creature on the edge of the effect), it still takes full damage, but its speed is reduced only by half (instead of to 5 feet).
...
---
## Tags
#Sources/Sandstorm #Rule-System/Pathfinder #Rule/NonOGL #Rule/Spell #Rule/3PP #Publisher/WotC #Spell-Rarity/Rare #Saving-Throws/See-text #Spell-Resistance/No #Spell-Descriptor/Earth #Spell-Range/Medium--100-ft----10-ft--level- #Spell-Level/Sorcerer-Wizard-7 #Spell-School/Transmutation #Domain/Sand
