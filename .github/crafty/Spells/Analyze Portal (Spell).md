...
RWtopicId: "Topic_13808"
---
# Analyze Portal (Spell)
## Overview
[[Divination Spells|Divination]]

**Level:** [[3rd Level Bard Spells|Bard 3]], [[Portal (Domain)|Portal 2]], [[3rd Level Sorcerer Spells|Sorcerer 3]], [[3rd Level Wizard Spells|Wizard 3]]
...
**Source:** Spell Compendium (WotC), pg. 10
...
You can tell whether an area contains a magical portal or the effect of a *[[Gate (Spell)|gate]]* spell. If you study an area for 1 round, you know the sizes and locations of any such portals in the area. Once you find a portal, you can study it. (If you find more than one portal, you can study only one at a time.)
...
*- A glimpse of the area where the portal leads. You can look at the area where the portal leads for 1 round; the range of your vision is the spell’s range. Analyze portal does not allow other divination spells or spell-like abilities to extend through the portal. For example, you cannot also use [[Detect Magic (Spell)|detect magic]] or [[Detect Evil (Spell)|detect evil]] to study the area where the portal leads while viewing the area with analyze portal.
*
...
---
## Tags
#Spell-Resistance/No #Rule-System/Pathfinder #Rule/NonOGL #Rule/Spell #Publisher/WotC #Rule/3PP #Sources/Spell-Compendium #Spell-Rarity/Rare #Saving-Throws/See-text #Spell-Level/Bard-3 #Spell-School/Divination #Spell-Range/Other #Spell-Level/Sorcerer-Wizard-3 #Domain/Portal
