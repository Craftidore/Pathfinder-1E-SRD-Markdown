...
**Source:** War of the Crown AP 2 Songbird, Scion, Saboteur, pg. 79

SUBTLE MASK

SLOT head CL 11th WEIGHT 1 lb.
...
**Fourth Triumph:** The mask’s enhancement bonus to Charisma is +6. When the wearer mentally activates the mask, she also detects whether the target is lying throughout the concentration, as per *discern lies* (DC 22). Once per day, the wearer can speak a command word to use *true seeing*.
