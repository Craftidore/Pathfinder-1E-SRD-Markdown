...
next:
  - "Profession (Skill)"
RWtopicId: "Topic_6936"
---
# Perform (Skill)
## Overview
**Perform (Cha)**

You are skilled at one form of entertainment, from singing to acting to playing an instrument. Like [[Craft (Skill)|Craft]], [[Knowledge (Domain)|Knowledge]], and [[Profession (Skill)|Profession]], Perform is actually a number of separate skills. You could have several Perform skills, each with
...
- Wind instruments (f lute, pan pipes, recorder, trumpet)
...
**Special**: A bard must have ranks in specific Perform categories to use some of his Bardic Performance abilities. Consult the Bardic Performance section of the bard class description in Chapter 3 of the *Pathfinder Core Rulebook* for more details.
