...
**Run**: A character can run for a number of rounds equal to his Constitution score on the local scale without needing to rest. See Chapter 8 of the *PF Core Rulebook* for rules covering extended periods of running.
...
## Flight and Damage
*House Rule:* In previous editions, mundane flight and damage was simple: once a creature received half damage or more, it was forced to land and if unable to do so, it fell to the ground. Since there are no rules as written (RAW) covering this in first edition Pathfinder the following rule will be used. 

If a flying creature receives damage that reduces its hit points to 50% of its total, it MUST land at the end of its movement. If it is too high above the ground to land, it falls straight down, descending 150 feet in the first round of falling. If this distance brings it to the ground, it takes falling damage. If the fall doesn’t bring the creature to the ground, it falls another 300 feet in the next round and it takes falling damage.

If the flying creatures receives damage that reduces its hit points to 25% of its total, it begins to immediately fall straight down, descending 150 feet in the first round of falling. If this distance brings it to the ground, it takes falling damage. If the fall doesn’t bring the creature to the ground, it continues to fall another 300 feet in the next round and it takes more falling damage.


---
## Tags
#Rule/House-Rule #Sources/PF-Core-Rulebook #Rule-System/Pathfinder #Publisher/Paizo #Rule/Core
