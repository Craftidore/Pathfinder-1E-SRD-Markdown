...
| [[Aberrant Dragonmark (Feat)\|Aberrant Dragonmark]] | Dragonmarked race | Manifest an aberrant dragonmark spell-like ability |
| Lesser Aberrant Dragonmark | [[Aberrant Dragonmark (Feat)\|Aberrant Dragonmark]], 9 ranks in any two skills | Gain new spell-like ability and use other aberrant dragonmark powers 1 additional time/day |
...
| [[Aberrant Tumor (Feat)\|Aberrant Tumor]] | [[Aberrant (Bloodline)\|Aberrant]] bloodline | Gain a tumor familiar |
| [[Abjurant Caster (Feat)\|Abjurant Caster]] | Swift Abjuration class ability | Increase the power of your Swift Abjuration class ability |
| [[Able Sniper (Feat)\|Able Sniper]] | Dex 13, [[Stealth (Skill)\|Stealth]] (Hide) 5 ranks | +2 bonus on ranged attacks against distant [[Flat-Footed\|flat-footed]] targets, +4 bonus on [[Stealth (Skill)\|Stealth]] (Hide) checks after sniping attack |
| Absorb Spirit | Con 13, died or possessed by an undead | Temporarily absorb a spirit to prevent rejuvenation |
| Spirit Speaker | Cha 13, Absorb Spirit, [[Diplomacy (Skill)\|Diplomacy]] 5 ranks | Talk to spirits you’ve absorbed |
| [[Academic Priest (Feat)\|Academic Priest]] | Int 13+ | For the purpose of determining bonus divine spells per day and maximum divine spell level, your primary spellcasting ability is Intelligence. |
| [[Academy Graduate (Feat)\|Academy Graduate]] | 1st level only | Pick any 3 Cha- or Int-based skills. These 3 skills are always considered class skills; in addition, you gain a +2 bonus on [[Knowledge (Skill)\|Knowledge]] (history) and [[Knowledge (Skill)\|Knowledge]] (nobility and royalty) checks, and may use these skills untrained |
| [[Acidic Splatter (Feat)\|Acidic Splatter]] | Ability to cast 2nd-level spells | Create orb of acid 1d6 damage/spell level, +1 CL on acid spells |
...
| [[Barroom Brawler (Feat)\|Barroom Brawler]]\* | Base attack bonus +4 | Once per day, gain the use of a combat feat you don’t possess for 1 minute |
...
| [[Battle Dancer (Feat)\|Battle Dancer]] | Base attack bonus +2, bardic music | +2 on attacks while moving and using bardic music |
| [[Battlecaster Defense (Feat)\|Battlecaster Defense]] | [[Combat Casting (Feat)\|Combat Casting]], base attack bonus +1, CL 1st | Gain benefits when casting spells defensively |
| [[Battlecaster Offense (Feat)\|Battlecaster Offense]] | [[Combat Casting (Feat)\|Combat Casting]] or warmage edge, base attack bonus +1, [[Spellcraft (Skill)\|Spellcraft]] 4 ranks | Gain benefits when mixing melee combat and spellcasting |
...
| [[Believer's Boon (Feat)\|Believer’s Boon]] | Wis 13, alignment must be within one step of your deity’s | Gain that use of a 1st-level cleric domain ability |
| [[Believer's Hands (Feat)\|Believer’s Hands]] | [[Believer's Boon (Feat)\|Believer’s Boon]], must be lawful good | Use lay on hands once per day |
| Betrayal Sense\* | Wis 13, rogue level 3rd, trap sense class feature | Apply trap sense on checks to see through disguises and avoid surprise attacks |
| [[Blade of Force (Feat)\|Blade of Force]] | Ability to cast 3rd-level spells | Surround a weapon in force, +1 CL on force spells |
| [[Blasting Charge (Feat)\|Blasting Charge]] | Base attack bonus +7, ability to cast 2nd-level bloodrager spells, bloodrage class feature | Expend a bloodrager spell slot while bloodraging to add force damage to your charge attack |
| [[Blessed Striker (Feat)\|Blessed Striker]] | Base attack bonus +11, ability to cast divine spells, alignment must be within one step of your deity’s | Your attacks are considered to have the alignments you share with your deity |
| [[Blind-Fight (Feat)\|Blind-Fight]]\* | — | Reroll miss chances for concealment |
| Improved Blind-Fight\* | [[Perception (Skill)\|Perception]] 10 ranks, [[Blind-Fight (Feat)\|Blind-Fight]] | Ignore miss chance for less than total concealment |
| Greater Blind-Fight\* | [[Perception (Skill)\|Perception]] 15 ranks, Improved Blind-Fight | Total concealment is considered normal concealment |
| Moonlight Stalker\* | Darkvision or low-light vision racial trait, [[Bluff (Skill)\|Bluff]] 3 ranks, [[Blind-Fight (Feat)\|Blind-Fight]], [[Combat Expertise (Feat)\|Combat Expertise]] | Gain +2 on damage and attack rolls when you have concealment vs. foe |
| Moonlight Stalker Feint\* | [[Bluff (Skill)\|Bluff]] 6 ranks, Moonlight Stalker | Make a [[Bluff (Skill)\|Bluff]] check to [[Feint\|feint]] with concealment vs. foe |
| Moonlight Stalker Master\* | [[Bluff (Skill)\|Bluff]] 9 ranks, [[Improved Feint (Feat)\|Improved Feint]], Moonlight Stalker Feint | While concealed, miss chance increases by 10% |
| Blood Spurt\* | Base attack bonus +2, susceptibility to bleed | Adjacent foes risk being [[Blinded\|blinded]] when dealing you bleed damage |
| Bludgeoner\* | — | Inflict nonlethal damage with bludgeoning weapons |
| Blustering Bluff | Cha 13, [[Bluff (Skill)\|Bluff]] 1 rank, [[Intimidate (Skill)\|Intimidate]] 1 rank | Bully people into believing your [[Bluff (Skill)\|Bluff]] |
| Bolstered Resilience | Damage reduction | Increase DR against a single attack |
| [[Bonded Familiar (Feat)\|Bonded Familiar]] | Familiar | You and familiar shift damage after deadly attack |
| Bookish Rogue | Minor magic rogue talent | Change your rogue talent spell-like abilities with study |
| [[Borne Aloft (Feat)\|Borne Aloft]] | Ability to cast 5th-level spells | Fly 30 feet once per round, +1 CL on air spells |
| Branded for Retribution | Bane class feature | Grant ally’s weapon the *[[Bane (MagWpnSpcAb)\|bane]]* quality against a branded opponent |
| [[Breadth of Experience (Feat)\|Breadth of Experience]] | Dwarf, elf, or gnome; 100+ years old | +2 bonus on all [[Knowledge (Skill)\|Knowledge]] and [[Profession (Skill)\|Profession]] checks |
| Breath of Siberys | Breath weapon class feature, any true dragonmark | Your breath weapon deals extra damage |
| Brilliant Planner | Int 13, character level 5th | Use gold to fund unspecified plans |
| Brilliant Spell Preparation | Int 13, ability to prepare 3rd-level spells | Prepare spells faster in a reserved slot |
| Bully Breed | [[Handle Animal (Skill)\|Handle Animal]] 4 ranks, [[Intimidate (Skill)\|Intimidate]] 4 ranks, animal companion or mount class feature | Animal companion or mount gains [[Intimidate (Skill)\|Intimidate]] as a class skill and can demoralize foes |
| But a Scratch\* | Cha 13, [[Bluff (Skill)\|Bluff]] 4 ranks | Demoralize foes by playing down a mighty blow |
...
| **Feats** | **Prerequisites** | **Benefits** |
|---|---|---|
| Cannith Forgecraft | [[Craft (Skill)\|Craft]] (armorsmithing, blacksmithing, or sculpting) 4 ranks, any Mark of Making | Reroll a [[Craft (Skill)\|Craft]] check 1/week; reduce time and cost to repair constructs; repair more damage to warforged |
...
| Careful Sneak | Dex 13, [[Stealth (Skill)\|Stealth]] 3 ranks | Use [[Stealth (Skill)\|Stealth]] slowly without penalty from most armor |
| Exquisite Sneak | Dex 15, Careful Sneak, [[Stealth (Skill)\|Stealth]] 6 ranks | Use [[Stealth (Skill)\|Stealth]] without penalty from most armor |
| Cartogramancer | [[Knowledge (Skill)\|Knowledge]] (geography) 10 ranks, ability to cast *greater teleport* | Use [[Knowledge (Skill)\|Knowledge]] to find a destination for *greater teleport* |
| Planar Wanderer | Cartogramancer, [[Knowledge (Skill)\|Knowledge]] (planes) 10 ranks, ability to cast *[[Plane Shift (Spell)\|plane shift]]* | Arrive more accurately with *[[Plane Shift (Spell)\|plane shift]]* |
| Cartwheel Dodge | Improved evasion class feature, [[Acrobatics (Skill)\|Acrobatics]] 12 ranks | With a successful evasion you may move half your speed |
| Cat and Mouse\* | [[Bluff (Skill)\|Bluff]] 5 ranks, [[Sense Motive (Skill)\|Sense Motive]] 5 ranks, [[Opportune Parry and Riposte (Deed)\|opportune parry and riposte]] deed | Hold your riposte to gain an advantage |
...
| Disrupting Fist\* | [[Channel Smite (Feat)\|Channel Smite]], [[Improved Unarmed Strike (Feat)\|Improved Unarmed Strike]], base attack bonus +9, channel positive energy 4d6 | Destroy an undead on a critical unarmed strike |
| Greater Channel Smite | [[Channel Smite (Feat)\|Channel Smite]], base attack bonus +8 | Can exchange channel positive energy to create pool of damage dice |
| Guided Hand | [[Channel Smite (Feat)\|Channel Smite]], proficiency with deity’s chosen weapon | May use Wisdom modifier for attack rolls with favored weapon |
| [[Channeled Blessing (Feat)\|Channeled Blessing]] | Blessings class feature, channel energy class feature | Bestow a blessing on an ally when you channel energy |
| Channeled Revival | Channel positive energy 6d6 | May expend channel energy to cast [[Breath of Life (Spell)\|breath of life]] |
...
| [[Child of the Shadow (Feat)\|Child of the Shadow]] | — | +2 bonus on [[Diplomacy (Skill)\|Diplomacy]] to learn about a city's black markets; +2 bonus on Initiative checks in urban environments |
...
| Vermin Companion | Druid 3rd, nongood, Child of Winter, ability to acquire new animal companion, minimum level (see text) | Gain vermin as “animal” companion |
| Vermin Shape | Druid 5th, nongood, Child of Winter | Wild shape into vermin form |
| [[Childlike (Feat)\|Childlike]] | Cha 13, halfling | +2 on [[Disguise (Skill)\|Disguise]] checks to look like human child, take 10 on [[Bluff (Skill)\|Bluff]] checks |
| [[Clap of Thunder (Feat)\|Clap of Thunder]] | Ability to cast 3rd-level spells | Touch attack does 1d6 damage/spell level and bestows deafness, +1 CL on sonic spells |
| Cloudy Conjuration | [[Spell Focus (Feat)\|Spell Focus]] (conjuration) or conjurer level 1st | Conjurations accompanied by a cloud of sickening smoke |
| Clutch of Earth | Ability to cast 2nd-level spells | Impede creature's movement, +1 CL on earth spells |
| [[Collegiate Wizard (Feat)\|Collegiate Wizard]] | Int 13, wizard level 1st | Begin play with knowledge of six 1st-level spells plus 1 per point of Intelligence modifier. Each time you gain a wizard level, you may add four spells to your spellbook without additional research |
...
| Felling Smash\* | [[Improved Trip (Feat)\|Improved Trip]], [[Power Attack (Feat)\|Power Attack]], base attack bonus +6 | Trip a foe when you make a power attack |
...
| Pursue | [[Combat Reflexes (Feat)\|Combat Reflexes]] | Spend action point to occupy square opponent has left |
...
| [[Cut Your Losses (Feat)\|Cut Your Losses]] | Str 13, [[Acrobatics (Skill)\|Acrobatics]] 1 rank | Withdraw as a full-round action and pick up one unattended object or unconscious ally of your size or smaller without provoking attacks of opportunity |
...
| **Feats** | **Prerequisites** | **Benefits** |
|---|---|---|
| Darkness Trick | [[Use Magic Device (Skill)\|Use Magic Device]] 5 ranks, ability to cast darkness | Deactivate a magic weapon’s light |
| [[Darkstalker (Feat)\|Darkstalker]] | — | Hide from creatures with extraordinary senses |
...
| [[Dazing Spell (Feat)\|Dazing Spell]] | — | Daze creature with spell damage |
| Dazzling Illusion | [[Spell Focus (Feat)\|Spell Focus]] (illusion) or illusionist level 1st | Enemies within 30 feet [[Dazzled\|dazzled]] when casting illusion spells |
...
| [[Deceitful (Feat)\|Deceitful]] | — | +2 bonus on [[Bluff (Skill)\|Bluff]] and [[Disguise (Skill)\|Disguise]] checks |
| Conceal Spell | [[Deceitful (Feat)\|Deceitful]], [[Bluff (Skill)\|Bluff]] 1 rank, [[Disguise (Skill)\|Disguise]] 1 rank, [[Sleight of Hand (Skill)\|Sleight of Hand]] 1 rank | Conceal evidence of spellcasting |
| Improved Conceal Spell | Conceal Spell, [[Bluff (Skill)\|Bluff]] 5 ranks, [[Disguise (Skill)\|Disguise]] 5 ranks, [[Sleight of Hand (Skill)\|Sleight of Hand]] 10 ranks, ability to cast 3rd level spells or use a 3rd-level spell-like ability | Hide powerful spells more easily |
| Feign Curse | [[Deceitful (Feat)\|Deceitful]], [[Bluff (Skill)\|Bluff]] 5 ranks, [[Spellcraft (Skill)\|Spellcraft]] 1 rank | Trick an enemy into thinking she’s cursed |
| Fool Magic | [[Deceitful (Feat)\|Deceitful]], [[Disguise (Skill)\|Disguise]] 1 rank, [[Use Magic Device (Skill)\|Use Magic Device]] 1 rank | Use [[Disguise (Skill)\|Disguise]] to fool magic items |
| Intoxicating Flattery | [[Deceitful (Feat)\|Deceitful]], [[Bluff (Skill)\|Bluff]] 5 ranks | Flatter someone to weaken Wisdom-based checks |
| Misdirection Tactics\* | Int 13, [[Combat Expertise (Feat)\|Combat Expertise]], [[Deceitful (Feat)\|Deceitful]], [[Bluff (Skill)\|Bluff]] 4 ranks | While using total defense, use [[Bluff (Skill)\|Bluff]] to negate a hit |
| Misdirection Redirection\* | Misdirection Tactics, [[Bluff (Skill)\|Bluff]] 10 ranks | When using Misdirection Tactics, redirect attack to another creature |
...
| Subtle Enchantments | [[Deceitful (Feat)\|Deceitful]], [[Spell Focus (Feat)\|Spell Focus]] (enchantment) | Victims and observers might not notice your enchantments |
| [[Deadzone Casting (Feat)\|Deadzone Casting]] | Cast *[[Antimagic Field (Spell)\|antimagic field]]* | Character can cast spells in any magical deadzone, such as that created by *[[Antimagic Field (Spell)\|antimagic field]]*, with only a 50% chance of spell failure. |
| [[Improved Deadzone Casting (Feat)\|Improved Deadzone Casting]] | Cast *[[Antimagic Field (Spell)\|antimagic field]]*, Concentration 20 ranks [[Deadzone Casting (Feat)\|Deadzone Casting]]. | Character can cast spells in any magical deadzone, such as that created by *[[Antimagic Field (Spell)\|antimagic field]]*, with only a 10% chance of spell failure. |
| [[Deep Bond_ Object\|Deep Bond: Object]] | Arcane bond (object) | Increase the number of times per day you can cast a spell using your arcane bond, from once to twice per day |
| [[Deep Drinker (Feat)\|Deep Drinker]] | Con 13, monk level 11, drunken ki class feature | Gain 2 temporary ki from drunken ki |
| Deep Lunge | Base attack bonus +1 | Attack as though using a reach weapon |
...
| Disorienting Maneuver | [[Dodge (Feat)\|Dodge]], [[Acrobatics (Skill)\|Acrobatics]] 5 ranks | After successful tumble through opponent’s square, gain +2 on attack rolls vs. that opponent |
...
| **Feats** | **Prerequisites** | **Benefits** |
|---|---|---|
| Ecclesiarch | [[Knowledge (Skill)\|Knowledge]] (religion) 6 ranks | Gather Information and [[Knowledge (Skill)\|Knowledge]] (local) are class skills, +2 bonus on [[Leadership (Feat)\|Leadership]] score |
| Education | — | All [[Knowledge (Skill)\|Knowledge]] skills are class skills, +1 on checks with any two [[Knowledge (Skill)\|Knowledge]] skills |
| Elemental Adept | Elemental mastery class feature | Cast a spell from your chosen element spontaneously |
| Eagle Eyes | Wis 13, keen senses racial trait | Ignore up to –5 due to distance on visual [[Perception (Skill)\|Perception]] checks |
...
| [[Eidetic Spellcaster (Feat)\|Eidetic Spellcaster]] | Int 17+, wizard level 1st | Record spells in your perfect memory instead of spellbooks |
| Eldritch Claws | Str 15, natural weapons, base attack bonus +6 | Natural weapons treated as magic and silver |
| Eldritch Dragonbane | Ability to invoke an eldritch blast, any true or aberrant dragonmark | Your eldritch blast deals extra damage to dragons and creatures with the dragonblood subtype |
| Eldritch Mark | Ability to invoke an eldritch blast, any true or aberrant dragonmark | Spend 1 action point to render a target [[Flat-Footed\|flat-footed]] with your eldritch blast |
| [[Elemental Channel (Feat)\|Elemental Channel]] | Channel energy class feature | Channel energy can harm or heal elementals |
...
| Elfmarked | Elfmarked | You count as both human and elf for any effects related to race |
...
| Elven Spell Lore | Int 17 or elf, [[Knowledge (Skill)\|Knowledge]] (arcana) 12 ranks | Bonus on dispel attempts, alter energy type of spell |
| [[Emergency Attunement (Feat)\|Emergency Attunement]] | [[Spellcraft (Skill)\|Spellcraft]] 7 ranks | Alter one of your ongoing abjuration or transmutation spells |
| Emotional Conduit | Shared consciousness class feature | Gain new spells tied to phantom’s emotional focus |
| Empath | Psychic Sensitivity or ability to cast psychic spells, [[Perception (Skill)\|Perception]] 1 rank or [[Sense Motive (Skill)\|Sense Motive]] 1 rank | Read emotions quickly and often, but open your mind to risk |
| [[Endurance (Domain)\|Endurance]] | — | +4 bonus on checks to avoid nonlethal damage |
| [[Diehard (Feat)\|Diehard]] | [[Endurance (Domain)\|Endurance]] | Automatically stabilize and remain conscious below 0 hp |
| Deathless Initiate\* | Str 13, Con 13, orc or half-orc, [[Diehard (Feat)\|Diehard]], base attack bonus +6 | Not [[Staggered\|staggered]] while using [[Diehard (Feat)\|Diehard]]; gain +2 on melee damage rolls |
| Deathless Master\* | Con 15, Deathless Initiate, Ironhide, base attack bonus +9 | Do not lose hit points while using [[Diehard (Feat)\|Diehard]] |
| Deathless Zealot\* | Con 17, Deathless Master, base attack bonus +12 | Foes must reroll critical confirmation attacks |
| [[Fast Healer (Feat)\|Fast Healer]] | Con 13, [[Diehard (Feat)\|Diehard]], [[Endurance (Domain)\|Endurance]] | Regain additional hit points when healing |
| Heroic Defiance | [[Diehard (Feat)\|Diehard]], base Fortitude save +8 | Once per day, delay onset of harmful condition for 1 round |
| Heroic Recovery | [[Diehard (Feat)\|Diehard]], base Fortitude save +4 | Once per day, gain new saving throw against harmful condition requiring Fort save |
| Stalwart | [[Diehard (Feat)\|Diehard]], base attack bonus +4 | Forgo dodge AC bonus for equivalent DR |
| Improved Stalwart | Stalwart, base attack bonus +11 | Double DR gained from Stalwart |
| Indomitable Soul | [[Endurance (Feat)\|Endurance]], [[Iron Will (Feat)\|Iron Will]] | Roll twice against fear and mind-affecting attacks |
| Energy Abjuration | [[Spell Focus (Feat)\|Spell Focus]] (abjuration) or abjurer level 1st | Gain energy resistance when casting abjuration spell |
| [[Energy Channel (Feat)\|Energy Channel]] | Channel energy class feature; Air, [[Earth (Domain)\|Earth]], [[Fire (Domain)\|Fire]], or Water domain or blessing | Spend channel energy to deal extra energy damage with weapon attacks |
...
| [[Extra Rage (Feat)\|Extra Rage]] | Rage class feature | Use rage for 6 additional rounds per day |
...
| Field Repair | [[Craft (Skill)\|Craft]] 4 ranks | Take no penalty for repairs made with improvised materials |
...
| Purging Emesis | [[Great Fortitude (Feat)\|Great Fortitude]] | Vomit an ingested poison |
...
| [[Improved Arcane Bond (Feat)\|Improved Arcane Bond]] | Arcane caster level 5th, must have an arcane bond object | Your arcane bond object gains additional powers as you gain levels in your arcane class |
| Improved Bravery\* | Cha 13, bravery class feature | Bravery applies against all mind-affecting effects |
| [[Improved Channel (Feat)\|Improved Channel]] | Channel energy class feature | +2 bonus on channel energy DC |
| [[Improved Counterspell (Feat)\|Improved Counterspell]] | — | Counterspell with spell of the same school |
| Dampen Spell | [[Improved Counterspell (Feat)\|Improved Counterspell]] | Reduce your save DC against foe’s spell by expending spell or slot as immediate action |
| Parry Spell | [[Spellcraft (Skill)\|Spellcraft]] 15 ranks, [[Improved Counterspell (Feat)\|Improved Counterspell]] | Reflect a counterspelled spell back on its caster |
...
| [[Improved Day Job (Feat)\|Improved Day Job]] | — | +3 bonus on Day Job checks using one skill you choose when you take this feat |
| [[Improved Dirge of Doom (Feat)\|Improved Dirge of Doom]] | Ability to perform dirge of doom | Dirge of doom expands to 60 feet and can cause fear up to [[Frightened\|frightened]] |
| [[Greater Dirge of Doom (Feat)\|Greater Dirge of Doom]] | Improved Dirge of Doom, ability to perform dirge of doom | Your dirge effects linger and can cause fear up to [[Panicked\|panicked]] |
| Improved Draconic Aura | Draconic aura, any true dragonmark | Spend 1 action point to increase bonus of draconic aura |
| [[Improved Familiar (Feat)\|Improved Familiar]] | Ability to acquire a familiar, see feat | Gain a more powerful familiar |
| [[Improved Homunculus (Feat)\|Improved Homunculus]] | [[Craft Construct (Feat)\|Craft Construct]] or craft homunculus class feature, [[Craft (Skill)\|Craft]] (any) 6 ranks | Your homunculus gains special abilities and feats based on its HD |
| [[Improved Initiative (Feat)\|Improved Initiative]]\* | — | +4 bonus on initiative checks |
| [[Improved Natural Attack (Feat)\|Improved Natural Attack]] | Natural weapon, base attack bonus +4 | Increase the damage of a natural weapon |
| Improved Share Spells | [[Spellcraft (Skill)\|Spellcraft]] 10 ranks, see feat | Spells affect both you and your bonded creature |
| [[Improved Spell Sharing (Feat)\|Improved Spell Sharing]] | Ability to acquire an animal companion, eidolon, familiar, or special mount | Divide spell duration with the companion creature |
| Improved Stonecunning | Wis 13, dwarf, stonecunning racial trait | +4 bonus on [[Perception (Skill)\|Perception]] checks to notice unusual stonework |
| Stone Sense | [[Perception (Skill)\|Perception]] 10 ranks, Improved Stonecunning | Gain tremorsense 10 ft. |
| [[Improved Unarmed Strike (Feat)\|Improved Unarmed Strike]]\* | — | Always considered armed |
| Adder Strike\* | Poison use class feature, [[Improved Unarmed Strike (Feat)\|Improved Unarmed Strike]], [[Craft (Skill)\|Craft]] (alchemy) 1 rank | May apply contact poison to unarmed strikes |
| Pinpoint Poisoner\* | Adder Strike, [[Two-Weapon Fighting (Feat)\|Two-Weapon Fighting]] or flurry of blows class feature, [[Craft (Skill)\|Craft]] (alchemy) 6 ranks | When using Adder Strike, you may poison two blowgun darts that can be used in melee |
| Ascetic Hunter | [[Improved Unarmed Strike (Feat)\|Improved Unarmed Strike]], favored enemy | Monk and ranger levels stack for unarmed strike damage, favored enemy bonus improves stunning DC |
| Ascetic Knight | [[Improved Unarmed Strike (Feat)\|Improved Unarmed Strike]], smite evil | Monk and paladin levels stack for unarmed strike and smite evil damage |
| Ascetic Mage | [[Improved Unarmed Strike (Feat)\|Improved Unarmed Strike]], spontaneous 2nd-level arcane spells | Monk and sorcerer levels stack for AC bonus (Cha-based), sacrifice spell to gain bonus on unarmed strike |
| Ascetic Rogue | [[Improved Unarmed Strike (Feat)\|Improved Unarmed Strike]], sneak attack | Monk and rogue levels stack for sneak attack damage, unarmed strike sneak attack gains improved stunning DC |
...
| [[Dazing Fist (Feat)\|Dazing Fist]]\* | Dex 13, Wis 13, [[Improved Unarmed Strike (Feat)\|Improved Unarmed Strike]], base attack bonus +4 | [[Daze (Spell)\|Daze]] with unarmed strikes |
...
| Dispelling Fist | [[Improved Unarmed Strike (Feat)\|Improved Unarmed Strike]], ability to cast *[[Dispel Magic (Spell)\|dispel magic]]*, base attack bonus +11, caster level 7th | May cast *[[Dispel Magic (Spell)\|dispel magic]]* as a swift action after an attack |
| Domain Strike\* | Domain class feature, [[Improved Unarmed Strike (Feat)\|Improved Unarmed Strike]] | Use a domain power through unarmed strike |
...
| [[Inspired Alchemy (Feat)\|Inspired Alchemy]] | Ability to create 2nd-level extracts, alchemy class feature, inspiration class feature | Spend time and inspiration to recreate a consumed extract |
...
| [[Inspired Strike (Feat)\|Inspired Strike]] | Studied combat class feature | Expend inspiration to increase the damage dealt with the studied combat |
| Inspiring Bravery\* | Cha 13, bravery class feature | Grant your bravery to allies within 30 feet |
| Inspiring Mentor | Cha 13, inspire competence bardic performance | Inspire competence affects allies within 30 feet |
| Omnipresent Mentor | Cha 17, Inspiring Mentor | Inspire competence affects one ally for 24 hours |
...
| [[Intimidating Performance (Feat)\|Intimidating Performance]] | Ability to start performances or raging song as move action, bardic performance or raging song class feature | Demoralize foes with a successful [[Perform (Skill)\|Perform]] check |
...
| Intimidating Strike | [[Intimidate (Skill)\|Intimidate]] 4 ranks | Use [[Intimidate (Skill)\|Intimidate]] check with attack to shake opponent |
| Investigate | — | Use Search skill to analyze scene of a crime |
| [[Invisible Needle (Feat)\|Invisible Needle]] | Ability to cast 3rd-level spells | Create force dart 1d4 damage/spell level, +1 CL on force spells |
| [[Ioun Bond]] | Possess an arcane bond | Use an ioun stone as your arcane bond |
| [[Ioun Shaping (Feat)\|Ioun Shaping]] | [[Craft Wondrous Item (Feat)\|Craft Wondrous Item]], caster level 12+ | Craft ioun stones at a reduced price or faster than usual |
| [[Improved Ioun Shaping (Feat)\|Improved Ioun Shaping]] | [[Craft Wondrous Item (Feat)\|Craft Wondrous Item]], [[Ioun Shaping (Feat)\|Ioun Shaping]], caster level 12+ | Craft ioun stones at a greater reduced price or even quicker |
| [[Iron Will (Feat)\|Iron Will]] | — | +2 bonus on Will saves |
| Fear Eater | Cha 13, [[Iron Will (Feat)\|Iron Will]], no immunity to fear effects | Transfer others’ fear effects to yourself |
| [[Hardened Criminal (Feat)\|Hardened Criminal]] | [[Iron Will (Feat)\|Iron Will]] | You cannot be intimidated |
| [[Improved Iron Will (Feat)\|Improved Iron Will]] | [[Iron Will (Feat)\|Iron Will]] | Once per day, you may reroll a Will save |
| Clarity of Pain | Con 13, [[Improved Iron Will (Feat)\|Improved Iron Will]], [[Iron Will (Feat)\|Iron Will]] | Damage yourself to fight off a charm or compulsion |
| Exorcising Mutilation | Con 15, Clarity of Pain | Grievously damage yourself to fight off a dominate effect or possession |
| Lifeless Gaze | [[Iron Will (Feat)\|Iron Will]], [[Bluff (Skill)\|Bluff]] 5 ranks | Gain bonuses against emotions, and those who read your mind or fail to impress you gain the [[Shaken\|shaken]] condition |
| Unimpeachable Honor | [[Iron Will (Feat)\|Iron Will]] | +4 bonus to avoid violating beliefs, –4 penalty on attack rolls and damage rolls versus allies |
| Zealous Mind | [[Iron Will (Feat)\|Iron Will]], Unimpeachable Honor, lawful alignment | Gain additional bonuses against enchantments |
| Ironclad Logic | Int 19, [[Diplomacy (Skill)\|Diplomacy]] 3 ranks | Gain a +4 bonus on [[Diplomacy (Skill)\|Diplomacy]] checks and use Intelligence in verbal duels |
| Play to the Crowd | Ironclad Logic, [[Diplomacy (Skill)\|Diplomacy]] 5 ranks, [[Sense Motive (Skill)\|Sense Motive]] 5 ranks | Learn biases to assist your [[Diplomacy (Skill)\|Diplomacy]] |
...
| Smell Fear | Keen Scent, half-orc or orc | +4 on [[Perception (Skill)\|Perception]] checks to detect [[Frightened\|frightened]] creatures |
| Keen-Eared Scout | Listen 6 ranks, Alertness or Skill Focus (Listen) | Listen check reveals extra information about sound |
| Kinetic Counter | Cold simple blast, fire simple blast, or water simple blast; kinetic blast class feature | Use kinetic blast to counter an opposing element |
| Kinetic Leap | [[Acrobatics (Skill)\|Acrobatics]] 3 ranks, kinetic blast class feature | Use blast to add +10 on [[Acrobatics (Skill)\|Acrobatics]] checks to jump (+20 at 10 ranks) |
| [[Knack for Magic (Feat)\|Knack for Magic]] | — | +2 bonus on [[Spellcraft (Skill)\|Spellcraft]] skill checks; also gain the following spell-like abilities as a 1st-level caster: 1/day—*[[Detect Magic (Spell)\|detect magic]]**,* *[[Light (Spell)\|light]]**,* and *[[Prestidigitation (Spell)\|prestidigitation]]* |
...
| Entourage | Cha 17+, Leadership | Take Leadership feat multiple times |
| [[Improved Cohort (Feat)\|Improved Cohort]] | Cha 15, [[Leadership (Feat)\|Leadership]] | Your cohort’s maximum level increases by 1 |
| [[Merry Men (Feat)\|Merry Men]] | [[Leadership (Feat)\|Leadership]], character level 7th | You gain followers of a better calibre and level than usual |
...
| Legendary | No ability score below 12 | Add one point to any ability score every three levels |
| Legendary Influence | Lesser spirit power class feature | Gain a different feat from each legend |
| Improved Legendary Influence | Legendary Influence, propitiation class feature | Gain two different feats from each legend |
| Legendary Trait | One of your abilities must be 17+ | At 6th level and every 6 levels thereafter (6th, 12th, and 18th level) you gain a +1 to that ability |
...
| Nurian Mage | Ley Line Magic, Spellcraft 5 ranks, Language (Enochian), Wis 11+, Int 13+ | You can tap the power of ley lines to strengthen your magic |
| Nurian Shield | Ley Line Magic, Nurian Mage, Spellcraft 5 ranks, Language (Enochian), Wis 13+, Int 13+ | You can tap the power of ley lines to protect yourself |
| Nurian Vitality | Ley Line Magic, Nurian Mage, Spellcraft 5 ranks, Language (Enochian), Wis 13+, Int 13+ | You can tap the power of ley lines to heal yourself |
| [[Lightning Reflexes (Feat)\|Lightning Reflexes]] | — | +2 bonus on Reflex saves |
| [[Improved Lightning Reflexes (Feat)\|Improved Lightning Reflexes]] | [[Lightning Reflexes (Feat)\|Lightning Reflexes]] | Once per day, you may reroll a Reflex save |
...
| Lucid Dreamer | Cha 13, [[Knowledge (Skill)\|Knowledge]] (planes) 3 ranks | Gain greater control during dreams |
...
| Skewering Spear \* | Lunge, Weapon Focus (longspear or spear), Weapon Specialization (longspear or spear) | Increase the critical multiplier of your spear by one step whenever you use the Lunge feat |
| Lunging Spell Touch | [[Spellcraft (Skill)\|Spellcraft]] 6 ranks | Increase reach of spell’s touch attack by 5 feet |
...
| Magic Device Attunement | [[Use Magic Device (Skill)\|Use Magic Device]] 1 rank | Attune to item to avoid making [[Use Magic Device (Skill)\|Use Magic Device]] checks |
| Magic Disruption | Ability to cast 3rd-level spells | Reduce effect of enemy spellcasting, +1 CL on abjuration spells |
| Magic Sensitive | Ability to cast 3rd-level spells | [[Detect Magic (Spell)\|Detect magic]] instinctively, +1 CL on divination spells |
| [[Magical Aptitude (Feat)\|Magical Aptitude]] | — | +2 bonus on [[Spellcraft (Skill)\|Spellcraft]] and [[Use Magic Device (Skill)\|Use Magic Device]] checks |
| Sabotage Magic Item | [[Magical Aptitude (Feat)\|Magical Aptitude]], [[Disable Device (Skill)\|Disable Device]] 5 ranks, [[Use Magic Device (Skill)\|Use Magic Device]] 5 ranks | Sabotage an item to cause a mishap |
| [[Magical Artisan (Feat)\|Magical Artisan]] | Any item creation feat | Make item for 75% item creation costs |
...
| Manipulative Agility | [[Bluff (Skill)\|Bluff]] 1 rank, [[Sleight of Hand (Skill)\|Sleight of Hand]] 1 rank | Use [[Sleight of Hand (Skill)\|Sleight of Hand]] for body-language Bluffs |
| Mark of the Dauntless | Any true dragonmark | You cannot be [[Dazed\|dazed]] or [[Stunned\|stunned]]; remove similar conditions afflicting others by touch |
...
| Mark of Purity | Divine health or purity of body, any true dragonmark | You cannot be [[Sickened\|sickened]] or [[Nauseated\|nauseated]]; remove similar conditions afflicting others by touch |
| Mark of the Recovery | Any true dragonmark | When [[Disabled\|disabled]] or [[Dying\|dying]], expend a dragonmark power as an immediate action to heal yourself |
| Mark of Resilience | Any true or aberrant dragonmark | Spend one use of a dragonmark power to gain a bonus on a saving throw |
| Mark of Stars | Any Siberys dragonmark | You are never surprised or [[Flat-Footed\|flat-footed]]; +2 to AC, Ref saves |
| Mark of Truth | Any true dragonmark | Deal +2d6 damage against creatures with aberrant dragonmarks |
| Mark of Twelve Moons . | Any true lesser, greater, or Siberys dragonmark | Gain +1 inherent bonus to ability score, +10 bonus on [[Control Shape (Skill)\|Control Shape]] checks |
...
| Martial Dominance\* | Base attack bonus +5, [[Intimidate (Skill)\|Intimidate]] 1 rank | [[Intimidate (Skill)\|Intimidate]] with martial training and on critical hits |
| [[Martial Weapon Proficiency (Feat)\|Martial Weapon Proficiency]]\* | — | No penalty on attacks made with one martial weapon |
| Master Alchemist | [[Craft (Skill)\|Craft]] (alchemy) 5 ranks | +2 on [[Craft (Skill)\|Craft]] (alchemy) checks, and you can create alchemical items and poisons faster |
| [[Master Builder (Feat)\|Master Builder]] | [[Craft (Skill)\|Craft]] 5 ranks or [[Profession (Skill)\|Profession]] 5 ranks | +2 bonus to whatever skill used to create vehicles, ships, siege engines, statues of large size or bigger, buildings, or fortifications; you cut the required time to complete the job in half |
| [[Master Craftsman (Feat)\|Master Craftsman]] | 5 ranks in any [[Craft (Skill)\|Craft]] or [[Profession (Skill)\|Profession]] skill | You can craft magic items without being a spellcaster |
...
| [[Master Pickpocket (Feat)\|Master Pickpocket]] | Dex 15, [[Sleight of Hand (Skill)\|Sleight of Hand]] 8 ranks | Steal an object from an adjacent opponent in combat as a standard action without provoking attacks of opportunity |
| Master of Undeath | [[Knowledge (Skill)\|Knowledge]] (religion) 5 ranks | Control one additional undead that you create |
| Master of Wards | Any Mark of Warding | Reroll a Search check 1/day; grant one or more creatures energy resistance 10 |
| Maximized Spellstrike | Maximized magic magus arcana, weapon expertise class feature or [[Quick Draw (Feat)\|Quick Draw]] | Maximize spellstrike by spending 3 arcana pool points |
| Melodic Casting | [[Perform (Skill)\|Perform]] 4 ranks, [[Spellcraft (Skill)\|Spellcraft]] 4 ranks, bardic music class feature | Use [[Perform (Skill)\|Perform]] in place of Concentration, cast spells while using bardic music |
| Menacing Bane | Bane class feature | May imbue weapon with *menacing* special quality |
| [[Mercantile Background (Feat)\|Mercantile Background]] | — | Sell items at 75% list price; 1/month buy one item at 75% offered price. |
| [[Merchant's Tongue (Feat)\|Merchant's Tongue]] | — | Start with an additional 300 gp; make an opposed [[Diplomacy (Skill)\|Diplomacy]] check to automatically sell an object for 5% over its asking price. |
...
| Greater Mesmerizing Feint\* | Mesmerizing Feint, [[Bluff (Skill)\|Bluff]] 10 ranks, psychic inception bold stare | Feint against mindless creatures |
| Metamagic School Focus | [[Spell Focus (Feat)\|Spell Focus]] (chosen school) or specialist wizard | Reduce the cost of adding metamagic feats to spells of a chosen school of magic |
| Metamagic Spell Trigger | Any metamagic feat, [[Use Magic Device (Skill)\|Use Magic Device]] or [[Spellcraft (Skill)\|Spellcraft]] 15 ranks | Use metamagic feats with spell trigger items |
...
| [[Mind Over Body (Feat)\|Mind Over Body]] | Cha 15, Int 15, 1st level character | Use Int or Cha modifier to determine hp at 1st level; gain +1 hp when you learn a metamagic feat; +1 insight bonus to AC. |
| [[Mental Fortitude (Feat)\|Mental Fortitude]] | [[Mind Over Body (Feat)\|Mind Over Body]] | Use your Cha, Int, or Wis modifier (your choice) instead of your Fort modifier |
...
| Monument Builder | Knowledge (engineering) 1 rank, have built a structure/vehicle worth at least 5,000 gp | When doing a construction project, reduce raw materials by 10%. +2 bonus to Knowledge (engineering) checks |
...
| [[Improved Mounted Archery (Feat)\|Improved Mounted Archery]]\* | [[Ride (Skill)\|Ride]] 1 rank, [[Mounted Archery (Feat)\|Mounted Archery]], [[Mounted Combat (Feat)\|Mounted Combat]] | Reduce or eliminate attack penalties with ranged weapon while mounted |
...
| Mounted Skirmisher\* | [[Ride (Skill)\|Ride]] rank 14, Trick Riding | Make a full attack if mount moves its speed or less |
...
| Music of Growth | Bardic music, [[Perform (Skill)\|Perform]] 12 ranks | Bardic music enhances animals and plants |
| Music of Making | Bardic music, [[Perform (Skill)\|Perform]] 9 ranks | Bardic music doubles duration of conjuration (creation) spells and +4 bonus on [[Craft (Skill)\|Craft]] checks |
| Mutilating Ritualist | [[Knowledge (Skill)\|Knowledge]] (arcana) 4 ranks, [[Knowledge (Skill)\|Knowledge]] (religion) 4 ranks, [[Spellcraft (Skill)\|Spellcraft]] 4 ranks | Mutilate yourself to enhance a ritual |
| Sacrificial Ritualist | Mutilating Ritualist | Kill sentient creatures to enhance your ritual |
...
| **Feats** | **Prerequisites** | **Benefits** |
|---|---|---|
| [[Natural Spell (Feat)\|Natural Spell]] | Wis 13, wild shape class feature | Cast spells while using wild shape |
| Nature Magic | [[Knowledge (Skill)\|Knowledge]] (nature) 1 rank | Gain druid orison once per day |
...
| Net Adept\* | [[Exotic Weapon Proficiency (Feat)\|Exotic Weapon Proficiency]] (net), base attack bonus +1 | May treat a net as a one-handed weapon |
| Net and Trident\* | Dex 15, Net Adept, [[Two-Weapon Fighting (Feat)\|Two-Weapon Fighting]] | May wield a one-handed or light weapon with a net |
...
| Nightborn Dragonmark | Any true or aberrant dragonmark | +1 on attacks, saving throws, skill checks, ability checks, and level checks at night |
| [[Nimble Moves (Feat)\|Nimble Moves]] | Dex 13 | Ignore 5 feet of difficult terrain when you move |
| [[Acrobatic Steps (Feat)\|Acrobatic Steps]] | Dex 15, [[Nimble Moves (Feat)\|Nimble Moves]] | Ignore 20 feet of difficult terrain when you move |
| Light Step | [[Acrobatic Steps (Feat)\|Acrobatic Steps]], [[Nimble Moves (Feat)\|Nimble Moves]], elf | Move normal speed in difficult terrain |
...
| Orator | [[Skill Focus (Feat)\|Skill Focus]] ([[Linguistics (Skill)\|Linguistics]]) | Use [[Linguistics (Skill)\|Linguistics]] instead of [[Bluff (Skill)\|Bluff]], [[Diplomacy (Skill)\|Diplomacy]], and [[Intimidate (Skill)\|Intimidate]] in some instances |
...
| Ostentatious Rager\* | [[Intimidate (Skill)\|Intimidate]] 5 ranks, rage class feature | Rage as a performance for money or to distract enemies |
...
| Pass for Human | Half-elf, half-orc, or halfling | +10 on [[Disguise (Skill)\|Disguise]] checks to look like a human |
| [[Patient Strike (Feat)\|Patient Strike]] | Int 13 | You can choose to ready an attack as a full-round action instead of a standard action |
| Performance Weapon Mastery\* | — | All weapons you are proficient with act as if they had the performance quality |
| [[Persuasive (Feat)\|Persuasive]] | — | +2 bonus on [[Diplomacy (Skill)\|Diplomacy]] and [[Intimidate (Skill)\|Intimidate]] checks |
| Agent of Fear | [[Persuasive (Feat)\|Persuasive]], frightening appearance class feature | Target a creature more often with appearances |
| Betrayer | [[Persuasive (Feat)\|Persuasive]], [[Quick Draw (Feat)\|Quick Draw]], base attack bonus +3 | Gain free attack upon successful [[Diplomacy (Skill)\|Diplomacy]] skill check |
| Call Truce | Cha 15, [[Persuasive (Feat)\|Persuasive]], [[Diplomacy (Skill)\|Diplomacy]] 5 ranks | Call for a truce in combat |
| Entreating Critical\* | Call Truce, [[Critical Focus (Feat)\|Critical Focus]], base attack bonus +11 | Use a critical hit to convince foes to agree to a truce |
| Cutting Humiliation | [[Persuasive (Feat)\|Persuasive]], [[Intimidate (Skill)\|Intimidate]] 5 ranks | Humiliate someone to weaken Charisma-based checks |
| Nerve-Racking Negotiator | [[Persuasive (Feat)\|Persuasive]] | Target of [[Intimidate (Skill)\|Intimidate]] doesn’t turn against you later |
...
| Persuasive Bribery | [[Persuasive (Feat)\|Persuasive]] | Bribe effectively and without offending others |
| Quick Favor | [[Persuasive (Feat)\|Persuasive]] | Follow up quickly on gather information 1/day |
| Rhetorical Flourish | Cha 13, [[Persuasive (Feat)\|Persuasive]] | Use verbal misdirection while making [[Diplomacy (Skill)\|Diplomacy]] check |
...
| Piercing Evocation | [[Spell Focus (Feat)\|Spell Focus]] (evocation) or evoker level 1st | 10 points of energy damage from evocation spells becomes untyped damage |
| Planar Wild Shape | Wild shape class feature, [[Knowledge (Skill)\|Knowledge]] (planes) 5 ranks | May add the celestial or fiendish template to your animal form |
| [[Planned Spontaneity (Feat)\|Planned Spontaneity]] | [[Knowledge (Skill)\|Knowledge]] (arcana) 9 ranks, ability to prepare and cast 4th-level spells | Designate one spell slot from each of up to three different spell levels that are lower than the highest-level spell that you can cast. In each designated slot you can memorize two different spells of the respective level |
| Improved Planned Spontaneity | Knowledge (arcana) 15 ranks, Planned Spontaneity, ability to prepare and cast 8th-level spells | Increase the number and level of spells you can use with Planned Spontaneity |
| [[Point-Blank Shot (Feat)\|Point-Blank Shot]]\* | — | +1 attack and damage on targets within 30 feet |
| Arc Slinger\* | [[Point-Blank Shot (Feat)\|Point-Blank Shot]], proficient with sling or halfling sling staff | Reduce ranged attack penalties due to range by 2 |
| Charging Hurler\* | [[Point-Blank Shot (Feat)\|Point-Blank Shot]] | May use charge rules to make thrown weapon attack |
...
| [[Dead Eye (Feat)\|Dead Eye]] | Dex 17, [[Point-Blank Shot (Feat)\|Point Blank Shot]], [[Weapon Focus (Feat)\|Weapon Focus]] (any ranged weapon), base attack bonus +14 | Add Dexterity bonus on damage rolls made with ranged weapons, so long as the target is within 30 feet |
| [[Deadly at Short Distances (Feat)\|Deadly at Short Distances]] | [[Point-Blank Shot (Feat)\|Point Blank Shot]], [[Rapid Shot (Feat)\|Rapid Shot]] | Threaten an area up 20 ft. away as if you have reach |
| [[Defensive Archery (Feat)\|Defensive Archery]] | [[Point-Blank Shot (Feat)\|Point Blank Shot]] | +4 dodge bonus against attacks of opportunity |
| Disrupting Shot\* | Dex 13, [[Point-Blank Shot (Feat)\|Point-Blank Shot]], 6th-level fighter | Ranged attacks increase enemy’s DC to cast spells |
| [[Efficient Pull (Feat)\|Efficient Pull]]<u>\*</u> | [[Point-Blank Shot (Feat)\|Point Blank Shot]] | Treat your Str as +2 for determining damage with a composite bow |
...
| Impact Critical Shot\* | Dex 13, [[Point-Blank Shot (Feat)\|Point-Blank Shot]], base attack bonus +9 | You can bull rush on a critical hit |
| [[Penetrating Shot (Feat)\|Penetrating Shot]]<u>\*</u> | Str 15, [[Point-Blank Shot (Feat)\|Point Blank Shot]], base attack bonus +10 | Your ranged attack targets every foe in 60-ft. line |
| [[Plunging Shot (Feat)\|Plunging Shot]] | Dex 13, [[Point-Blank Shot (Feat)\|Point Blank Shot]] | Deal an additional 1d6 points of damage against targets at least 30 feet below you |
| [[Power Shot (Feat)\|Power Shot]] | [[Point-Blank Shot (Feat)\|Point Blank Shot]], Str 13, Dex 13, base attack bonus +2 | -3 penalty to hit, gain +1d6 bonus to damage |
| [[Precise Shot (Feat)\|Precise Shot]]\* | [[Point-Blank Shot (Feat)\|Point-Blank Shot]] | No penalty for shooting into melee |
| [[Clustered Shots (Feat)\|Clustered Shots]]\* | [[Point-Blank Shot (Feat)\|Point-Blank Shot]], [[Precise Shot (Feat)\|Precise Shot]], base attack bonus +6 | Total damage from full-round ranged attacks before applying DR |
| [[Deadeye Shot (Feat)\|Deadeye Shot]]\* | [[Point-Blank Shot (Feat)\|Point Blank Shot]], [[Precise Shot (Feat)\|Precise Shot]], base attack bonus +4, skirmish or sneak attack ability | Ready action to fire, denying foe Dex bonus to AC on your attack after ally hits foe |
| [[Expert Aim (Feat)\|Expert Aim]] | [[Precise Shot (Feat)\|Precise Shot]], base attack bonus +4 | Take a single attack at a target within 30 ft, add Dex modifier to damage |
| Focused Shot\* | Int 13, [[Precise Shot (Feat)\|Precise Shot]] | Add Int modifier on damage rolls with bows or crossbows |
...
| Circuitous Shot\* | Dex 19, [[Blind-Fight (Feat)\|Blind-Fight]], [[Improved Precise Shot (Feat)\|Improved Precise Shot]], [[Precise Shot (Feat)\|Precise Shot]], [[Point-Blank Shot (Feat)\|Point-Blank Shot]], base attack bonus +11 | Bounce ranged attacks to avoid total cover |
| [[Pinpoint Targeting (Feat)\|Pinpoint Targeting]]\* | [[Improved Precise Shot (Feat)\|Improved Precise Shot]], base attack bonus +16 | No armor or shield bonus on one ranged attack |
...
| Ranged Pin\* | Dex 15, [[Point-Blank Shot (Feat)\|Point Blank Shot]], [[Precise Shot (Feat)\|Precise Shot]], base attack bonus +5 | Use ranged weapon to grapple foe within 30 feet |
| Ranged Sunder\* | Str 13, [[Point-Blank Shot (Feat)\|Point Blank Shot]], [[Precise Shot (Feat)\|Precise Shot]], Ranged Pin, base attack bonus +5 | Use ranged weapon to sunder foe’s weapon at reduced damage penalty |
...
| Ranged Threat\* | [[Combat Reflexes (Feat)\|Combat Reflexes]], [[Point-Blank Shot (Feat)\|Point Blank Shot]], [[Precise Shot (Feat)\|Precise Shot]], base attack bonus +6 | You threaten all targets within 15 ft. with your ranged weapon |
| [[Improved Ranged Threat (Feat)\|Improved Ranged Threat]]\* | [[Combat Reflexes (Feat)\|Combat Reflexes]], [[Point-Blank Shot (Feat)\|Point Blank Shot]], [[Precise Shot (Feat)\|Precise Shot]], [[Ranged Threat (Feat)\|Ranged Threat]], base attack bonus +11 | You threaten all targets within 30 ft. with your ranged weapon |
| [[Sharp-Shooting (Feat)\|Sharp-Shooting]]\* | [[Point-Blank Shot (Feat)\|Point Blank Shot]], [[Precise Shot (Feat)\|Precise Shot]], base attack bonus +3 | Halve opponent’s cover bonus |
| [[Synchronized Shot (Feat)\|Synchronized Shot]]\* | [[Point-Blank Shot (Feat)\|Point Blank Shot]], [[Precise Shot (Feat)\|Precise Shot]] | Your ranged attacks ignore cover from allies |
| [[Rapid Shot (Feat)\|Rapid Shot]] | Dex 13, [[Point-Blank Shot (Feat)\|Point-Blank Shot]] | Make one extra ranged attack |
| [[Crossbow Mastery (Feat)\|Crossbow Mastery]] | Dex 15, [[Rapid Reload (Feat)\|Rapid Reload]], [[Rapid Shot (Feat)\|Rapid Shot]] | Reload crossbow as free action and make full attacks |
| [[Double Nock (Feat)\|Double Nock]] | Dex 15+, [[Point-Blank Shot (Feat)\|Point Blank Shot]], [[Rapid Shot (Feat)\|Rapid Shot]] | Attack with two arrows at -5 |
| [[Manyshot (Feat)\|Manyshot]]\* | Dex 17, [[Rapid Shot (Feat)\|Rapid Shot]], base attack bonus +6 | Shoot two arrows simultaneously |
| [[Improved Rapid Shot (Feat)\|Improved Rapid Shot]]\* | [[Manyshot (Feat)\|Manyshot]], [[Point-Blank Shot (Feat)\|Point Blank Shot]], [[Rapid Shot (Feat)\|Rapid Shot]] | Ignore –2 penalty when using [[Rapid Shot (Feat)\|Rapid Shot]] |
| [[Snap Shot (Feat)\|Snap Shot]]\* | [[Rapid Shot (Feat)\|Rapid Shot]], [[Weapon Focus (Feat)\|Weapon Focus]], base attack bonus +6 | Threaten squares within 5 feet of you when wielding a ranged weapon |
| Improved Snap Shot\* | Dex 15, [[Snap Shot (Feat)\|Snap Shot]], base attack bonus +9 | You threaten an additional 10 feet with [[Snap Shot (Feat)\|Snap Shot]] |
...
| Sword And Pistol\* | [[Snap Shot (Feat)\|Snap Shot]], [[Two-Weapon Fighting (Feat)\|Two-Weapon Fighting]], base attack bonus +6 | Ranged attacks do not provoke attacks of opportunity |
| [[Stabbing Shot (Feat)\|Stabbing Shot]]\* | [[Rapid Shot (Feat)\|Rapid Shot]], elf | Use arrow as a melee attack to push enemies back |
...
| [[Parting Shot (Feat)\|Parting Shot]]\* | [[Shot on the Run (Feat)\|Shot on the Run]], base attack bonus +6 | Make a ranged attack when withdrawing |
...
| [[Potent Hex (Feat)\|Potent Hex]] | Hex class feature | You have developed more powerful hexes |
...
| [[Improved Awesome Blow (Feat)\|Improved Awesome Blow]] \* | Str 13, Awesome Blow or awesome blow class feature; [[Power Attack (Feat)\|Power Attack]] | +2 on awesome blow combat maneuver checks and to CMD against such attacks, and movement due to awesome blow provokes from allies |
| Bloody Assault\* | [[Power Attack (Feat)\|Power Attack]], base attack bonus +6 | Trade melee attack bonus for bleed damage |
...
| Cleaving Finish\* | [[Cleave (Feat)\|Cleave]] | Make additional attack if opponent is knocked out |
| Improved Cleaving Finish | Cleaving Finish, [[Great Cleave (Feat)\|Great Cleave]], base attack bonus +6 | May use Cleaving Finish any number of times/round |
| [[Great Cleave (Feat)\|Great Cleave]]\* | [[Cleave (Feat)\|Cleave]], base attack bonus +4 | Make an additional attack after each attack hits |
| Dazing Assault\* | [[Power Attack (Feat)\|Power Attack]], base attack bonus +11 | Trade melee attack bonus to daze opponents |
| Death or Glory\* | [[Power Attack (Feat)\|Power Attack]], base attack bonus +6 | Gain +4 on attack, damage, and critical rolls vs. Large or larger opponents |
...
| Dreadful Carnage\* | Str 15, Furious Focus, base attack bonus +11 | Make a free [[Intimidate (Skill)\|Intimidate]] check when you knock down a foe |
...
| Bull Rush Strike\* | [[Improved Bull Rush (Feat)\|Improved Bull Rush]], base attack bonus +9 | Attempt a bull rush on a successful critical hit |
...
| Quick Bull Rush\* | [[Improved Bull Rush (Feat)\|Improved Bull Rush]], base attack bonus +6 | May bull rush in place of one of your melee attacks |
...
| Rebuffing Reduction\* | Damage reduction, [[Improved Bull Rush (Feat)\|Improved Bull Rush]] | Bull Rush opponent who fails to pierce your DR |
| Spinning Throw\* | [[Improved Bull Rush (Feat)\|Improved Bull Rush]], [[Improved Trip (Feat)\|Improved Trip]], [[Improved Unarmed Strike (Feat)\|Improved Unarmed Strike]], Ki Throw | Spend a swift action to bull rush opponent, move it, then knock it prone |
| Improved Drag\* | [[Power Attack (Feat)\|Power Attack]] | +2 bonus on drag attempts, no attack of opportunity |
...
| Charge Through\* | [[Improved Overrun (Feat)\|Improved Overrun]], base attack bonus +1 | Make overrun as free action while charging |
...
| Sabotaging Sunder\* | Str 13, [[Improved Sunder (Feat)\|Improved Sunder]], [[Power Attack (Feat)\|Power Attack]], [[Disable Device (Skill)\|Disable Device]] 7 ranks | Break objects through sabotage rather than force |
| Improved Sabotaging | Sabotaging Sunder, [[Disable Device (Skill)\|Disable Device]] 9 ranks, Sunder\* | Use Sabotaging Sunder on more objects and without provoking attacks of opportunity |
| Sundering Strike\* | [[Improved Sunder (Feat)\|Improved Sunder]], base attack bonus +9 | Attempt a sunder attack on a successful critical hit |
| Pushing Assault\* | Str 15, [[Power Attack (Feat)\|Power Attack]], base attack bonus +1 | Push a foe back with a two-handed weapon |
...
| Reckless Rage | [[Power Attack (Feat)\|Power Attack]]; rage or raging song class feature | Take a penalty on attack rolls to deal more damage while raging |
| Resounding Blow\* | Str 13, [[Power Attack (Feat)\|Power Attack]], [[Intimidate (Skill)\|Intimidate]] 7 ranks | Potential [[Cowering\|cowering]] effect on critical hit |
| Shield of Swings\* | Str 13, [[Power Attack (Feat)\|Power Attack]], base attack bonus +1 | Reduce damage with a two handed weapon to gain a +4 shield bonus |
| Smash\* | [[Power Attack (Feat)\|Power Attack]], half-orc | Ignore 5 points of hardness when breaking an object |
| Stunning Assault\* | [[Power Attack (Feat)\|Power Attack]], base attack bonus +16 | Trade melee attack bonus to stun opponents |
| Powerful Charge\* | Medium or larger, base attack bonus +1 | Extra damage when charging |
...
| [[Practiced Spellcaster (Feat)\|Practiced Spellcaster]] | [[Spellcraft (Skill)\|Spellcraft]] 4 ranks | Your caster level is +4 but not above your HD |
...
| Preferred Spell | [[Spellcraft (Skill)\|Spellcraft]] 5 ranks, [[Heighten Spell (Feat)\|Heighten Spell]] | Spontaneously cast a specific spell |
| Profane Studies | Int 13, [[Knowledge (Skill)\|Knowledge]] (planes) 4 ranks, ability  to cast a summon monster spell | Gain +5 on [[Knowledge (Skill)\|Knowledge]] checks and +2 CL on summoning durations involving evil outsiders |
...
| Psychic Combatant\* | Int 13, Psychic Sensitivity or ability to cast psychic spells or use psychic spell-like abilities, character level 3rd | Gain free manifestation points in psychic duels |
| Psychic Defender | Int 13, Psychic Sensitivity or ability to cast psychic spells or use psychic spell-like abilities, character level 3rd | Gain free temporary hit points when starting a psychic duel |
| Psychic Healing | Cha 11, Psychic Sensitivity or ability to cast psychic spells, [[Heal (Skill)\|Heal]] 3 ranks | Use faith healing to treat deadly wounds and grant temporary hit points |
...
| [[Quick Preparation (Feat)\|Quick Preparation]] | Ability to prepare spells | Halve the time necessary to prepare spells |
| Quick Study\* | Int 13, bravery +3, fighter level 10th | Study with an ally to learn a combat feat |
...
| Quiet Death\* | Dex 19, [[Stealth (Skill)\|Stealth]] 10 ranks, rogue level 10th | Drop your foes before they make a sound |
| Quill of Sivis | Any Mark of Scribing | Reroll a Decipher Script or Forgery check 1/day; +2 bonus on some [[Use Magic Device (Skill)\|Use Magic Device]] checks; you don’t trigger certain magic traps |
...
| Raging Vitality | Con 15, rage class feature | +2 bonus to Con when raging, and continue raging if [[Unconscious\|unconscious]] |
...
| Rapid Reload\* | Weapon Proficiency (crossbow) or [[Exotic Weapon Proficiency (Feat)\|Exotic Weapon Proficiency]] (firearms) | Reload your weapon quickly |
...
| Reactive Healing | Quick Channel or [[Quicken Spell (Feat)\|Quicken Spell]]; channel energy or lay on hands class feature | When reduced to 0 hp or fewer, use channel energy or lay on hands to heal yourself as immediate action |
...
| Rebounding Leap\* | [[Acrobatics (Skill)\|Acrobatics]] 5 ranks, [[Ride (Skill)\|Ride]] 11 ranks, leaping lance class feature | Remount your steed as a swift action with successful [[Acrobatics (Skill)\|Acrobatics]] check |
| Recognize Impostor | [[Sense Motive (Skill)\|Sense Motive]] 3 ranks, Spot 3 ranks | +4 on Spot checks to oppose [[Disguise (Skill)\|Disguise]] checks, +4 on [[Sense Motive (Skill)\|Sense Motive]] checks to oppose [[Bluff (Skill)\|Bluff]] checks |
...
| Improved Recycle Goods | Recycle Goods, Craft (any) 5 ranks | Break down items more efficiently to make something new |
...
| [[Renown (Feat)\|Renown]] | — | Treat your Fame score as 2 higher in certain settlements |
| Research | — | Use [[Knowledge (Skill)\|Knowledge]] to get information from books and scrolls |
| [[Research Anywhere (Feat)\|Research Anywhere]] | [[Spellcraft (Skill)\|Spellcraft]] 3 ranks, [[Knowledge (Skill)\|Knowledge]] (arcana) 3 ranks | Research 4 hours/day while adventuring |
| Residual Magic | [[Spellcraft (Skill)\|Spellcraft]] 12 ranks, any metamagic feat | Apply magical effects in consecutive rounds |
...
| [[Run (Feat)\|Run]] | — | Run at 5 times your normal speed |
...
| **Feats** | **Prerequisites** | **Benefits** |
|---|---|---|
| Sacred Geometry | Int 13, Knowledge (engineering) 2 ranks | Add metamagic effects to your spells without using a higher-level spell slot |
| Sacrificial Adept | [[Knowledge (Skill)\|Knowledge]] (arcana) 4 ranks, [[Knowledge (Skill)\|Knowledge]] (planes) 4 ranks, [[Knowledge (Skill)\|Knowledge]] (religion) 4 ranks, [[Spellcraft (Skill)\|Spellcraft]] 4 ranks, ability to cast 3rd-level spells, evil alignment | Kill sentient creatures to enhance your spells |
...
| Sea Legs | [[Profession (Skill)\|Profession]] (sailor) 5 ranks | Gain +2 on [[Acrobatics (Skill)\|Acrobatics]], [[Climb (Skill)\|Climb]], and [[Swim (Skill)\|Swim]] checks |
| [[Second Bond (Feat)\|Second Bond]] | Bond class feature, character level 5 | Gain a second class bond |
| Secret of Magical Discipline | Secret class feature | Cast any spell as if it were one of your prepared spells or spells known. |
...
| Seize Advantage\* | Opportune parry and riposte deed | Add foe’s [[Power Attack (Feat)\|Power Attack]] damage to your riposte |
| [[Selective Channeling (Feat)\|Selective Channeling]] | Cha 13, channel energy class feature | Choose whom to affect with channel energy |
| Contingent Channeling | True healer class feature, [[Selective Channeling (Feat)\|Selective Channeling]] | May transfer positive energy to ally who can use it to heal |
| [[Self-Sufficient (Feat)\|Self-Sufficient]] | — | +2 bonus on [[Heal (Skill)\|Heal]] and [[Survival (Skill)\|Survival]] checks |
| Sense Assumptions | [[Sense Motive (Skill)\|Sense Motive]] 3 ranks | Discern which lies would be unbelievable |
| Sentinel Stance | Any Mark of Sentinel | Reroll a [[Sense Motive (Skill)\|Sense Motive]] check 1/day; allies adjacent to you gain bonus to AC and on Reflex saves |
| Serpent Strike | [[Simple Weapon Proficiency (Feat)\|Simple Weapon Proficiency]] (longspear), [[Weapon Focus (Feat)\|Weapon Focus]] (longspear), flurry of blows | Treat longspear as monk weapon |
...
| Shadows of Fear\* | Hidden strike +2d8 or sneak attack +2d6 | Flank a scared creature once per round |
| Shapeshifter Foil | [[Knowledge (Skill)\|Knowledge]] (arcana) 5 ranks or [[Knowledge (Skill)\|Knowledge]] (nature) 5 ranks, ability to use polymorph effects | When you deal damage, target’s ability to use any polymorph effects is hindered |
...
| Shared Insight | Wis 13, half-elf | Grant friendly creatures a +2 bonus on [[Perception (Skill)\|Perception]] checks |
...
| Sharp Senses | Keen senses racial trait | +4 racial bonus on [[Perception (Skill)\|Perception]] checks |
| Shatter Control | Channel positive energy 4d6 | Use channel to cut the control of undead creatures |
...
| Shield of Siberys | Any true dragonmark | Sense aberrant dragonmarked creatures within 60 ft.; gain spell resistance against aberrant mark powers |
...
| [[Bashing Finish (Feat)\|Bashing Finish]]\* | [[Shield Master (Feat)\|Shield Master]], [[Two-Weapon Fighting (Feat)\|Two-Weapon Fighting]], base attack bonus +11 | Make a free shield bash after a critical hit |
| Saving Shield\* | [[Shield Proficiency (Feat)\|Shield Proficiency]] | Grant shield bonus to an adjacent ally |
...
| Covering Defense\* | Shield Defense, base attack bonus +6 | Provide cover to an ally with total defense |
...
| Missile Shield\* | Dex 13, [[Shield Focus (Feat)\|Shield Focus]] | Deflect one ranged attack per round with shield |
| Ray Shield\* | Dex 15, Missile Shield, [[Spellbreaker (Feat)\|Spellbreaker]] | Deflect one ranged touch attack per round with shield |
| Mounted Shield\* | [[Mounted Combat (Feat)\|Mounted Combat]], [[Shield Focus (Feat)\|Shield Focus]] | Apply shield bonus to mount’s AC |
| Shield Specialization\* | [[Shield Focus (Feat)\|Shield Focus]], 4th-level fighter | +2 bonus to AC against criticals with one type of shield |
...
| Greater Shield Specialization\* | [[Greater Shield Focus (Feat)\|Greater Shield Focus]], Shield Specialization, 12th-level fighter | +2 bonus to AC against criticals, and negate critical hit once per day |
...
| Shipwright | Craft (ships) 3 ranks, Knowledge (engineering) 3 ranks | Gain +2 on Craft (ships) and reduce costs for building or repairing any sort of boat, ship, or watercraft |
| Sickening Grasp | Ability to cast 3rd-level spells | Sicken a target with a touch, +1 CL on necromancy spells |
| Siege Commander\* | [[Craft (Skill)\|Craft]] (siege weapon) 5 ranks, [[Knowledge (Skill)\|Knowledge]] (engineering) 5 ranks or [[Profession (Skill)\|Profession]] (Siege Engineer) 1 rank | Grant weapon crew +4 on assemble or move checks |
| Siege Weapon Engineer\* | [[Knowledge (Skill)\|Knowledge]] (engineering) 5 ranks or [[Profession (Skill)\|Profession]] (siege engineer) 5 ranks, proficiency with 1 siege weapon | You are considered proficient with all siege weapons |
| Master Siege Engineer\* | Siege Weapon Engineer, [[Knowledge (Skill)\|Knowledge]] (engineering) 10 ranks | Crew can load siege engine as a move action |
| Siege Gunner\* | Siege Weapon Engineer | Take no size penalties for aiming a direct fire siege weapon |
| Silent Kill\* | [[Stealth (Skill)\|Stealth]] 12 ranks, assassinate advanced slayer talent or ninja master trick | Kill during the surprise round and slip back into shadows |
...
| Greater Skald’s Vigor | Skald’s Vigor, [[Perform (Skill)\|Perform]] (song) 10 ranks | Allies share the fast healing of Skald’s Vigor |
| [[Skill Focus (Feat)\|Skill Focus]] | — | +3 bonus on one skill (+6 at 10 ranks) |
| Deft Catcher | [[Skill Focus (Feat)\|Skill Focus]] ([[Sleight of Hand (Skill)\|Sleight of Hand]]) | Use [[Sleight of Hand (Skill)\|Sleight of Hand]] to avoid dropping an item |
...
| Sliding Dash\* | Dex 15, [[Acrobatics (Skill)\|Acrobatics]] 10 ranks or acrobatic charge class feature, [[Bluff (Skill)\|Bluff]] 3 ranks | Charge through a foe for a flank attack |
| Sling Flail Weapon | Focus (sling), base attack bonus +1 | Make melee attacks with a sling |
| Slow Faller | [[Acrobatics (Skill)\|Acrobatics]] 5 ranks or slow fall class feature | Gain or improve the slow fall ability |
| Sociable | Cha 13, half-elf | Grant friendly creatures a +2 bonus on [[Diplomacy (Skill)\|Diplomacy]] checks |
| Social Bravery\* | Cha 13, bravery class feature | Apply bravery against various social attacks |
| Somatic Weaponry | Concentration 5 ranks, [[Spellcraft (Skill)\|Spellcraft]] 5 ranks | Cast spells with somatic components while hands are full |
| Song of the Heart | Bardic music, inspire competence, [[Perform (Skill)\|Perform]] 6 ranks | Increase bardic music effects |
| Soothe the Beast | Bardic music, [[Perform (Skill)\|Perform]] 6 ranks | Bardic music improves the attitudes of animals |
| Spell Bane | Bane class feature | Your spells’ DCs increase by 2 when bane is in effect |
| Spell Exchange | Wizard level 3rd+ | Swap a spell in place of one of equal or higher level |
| [[Spell Finesse (Feat)\|Spell Finesse]] | — | Choose one of the following ability scores: Intelligence, Wisdom or Charisma; all you spellcasting calculations are now based on this ability |
| [[Spell Focus (Feat)\|Spell Focus]] | — | +1 bonus on save DCs for one school |
| Diviner’s Delving | [[Spell Focus (Feat)\|Spell Focus]] (divination) | +2 bonus on caster level checks with divinations |
| Dragonmarked Summoner | [[Spell Focus (Feat)\|Spell Focus]] (conjuration), any true dragonmark | Creatures you summon gain a deflection bonus to AC |
| Evoker’s Mark | [[Spell Focus (Feat)\|Spell Focus]] (evocation), any true or aberrant dragonmark | Spend 1 action point to empower an evocation spell |
...
| [[Greater Spell Focus (Feat)\|Greater Spell Focus]] | [[Spell Focus (Feat)\|Spell Focus]] | +1 bonus on save DCs for one school |
| Putrid Summons | [[Spell Focus (Feat)\|Spell Focus]] (conjuration), ability to cast a *summon monster* or *summon nature’s ally* spell | Summon a single weaker creature that has a horrific stench |
| Superior Scryer | [[Spell Focus (Feat)\|Spell Focus]] (divination), the ability to cast at least one spell of the scrying subschool | Improve various effects of scrying spells |
| Tenacious Transmutation | [[Spell Focus (Feat)\|Spell Focus]] (transmutation) | +2 to DC to dispel your transmutations |
| [[Spell Focus (Feat)\|Spell Focus]] (Good) | Any good alignment | +2 bonus to save DCs of spells with good descriptor |
| [[Spell Mastery (Feat)\|Spell Mastery]] | 1st-level Wizard | Prepare some spells without a spellbook |
| [[Adept Mastery (Feat)\|Adept Mastery]] | Int 17+, [[Spell Mastery (Feat)\|Spell Mastery]] | Double the number of spells you master every time you choose the [[Spell Mastery (Feat)\|Spell Mastery]] feat |
| [[Flexible Wizardry (Feat)\|Flexible Wizardry]] | [[Spell Mastery (Feat)\|Spell Mastery]], wizard level 1st | Prepare some spells flexibly |
| [[Improved Flexible Wizardry (Feat)\|Improved Flexible Wizardry]] | [[Flexible Wizardry (Feat)\|Flexible Wizardry]], wizard level 8th | Flexibly prepare more spells |
| Initiate of the Threefold Path | Int 20+, Spell Mastery, Flexible Wizardry, Improved Flexible Wizardry, wizard level 12th | Choose to keep a number of spell slots equal to the number of spells you have mastered with Spell Mastery (and Adept Mastery if that feat is possessed) flexibly prepared |
...
| [[Signature Spell (Feat)\|Signature Spell]] | [[Spell Mastery (Feat)\|Spell Mastery]] or a domain | Sacrifice a prepared spell to cast your signature spell |
| [[Uncanny Forethought (Feat)\|Uncanny Forethought]] | Int 17, [[Spell Mastery (Feat)\|Spell Mastery]] | Reserve slots to cast [[Spell Mastery (Feat)\|Spell Mastery]] spells |
| [[Spell Penetration (Feat)\|Spell Penetration]] | — | +2 bonus on level checks to beat spell resistance |
| [[Greater Spell Penetration (Feat)\|Greater Spell Penetration]] | [[Spell Penetration (Feat)\|Spell Penetration]] | +2 bonus on level checks to beat spell resistance |
| Spell Perfection | [[Spellcraft (Skill)\|Spellcraft]] 15 ranks, 3 metamagic feats | Apply any metamagic feat to one spell without penalty, up to 9th level |
| Spider Step | [[Acrobatics (Skill)\|Acrobatics]] 6 ranks, [[Climb (Skill)\|Climb]] 6 ranks, 6th-level monk | Walk on walls or ceilings for half your slow fall distance |
| Cloud Step | Spider Step, 12th-level monk | *[[Air Walk (Spell)\|Air walk]]* for half your slow fall distance |
...
| Incorporeal Intuition | Psychic Sensitivity or the ability to cast psychic spells, Spirit Sense | Notice adjacent incorporeal creatures inside walls |
...
| Spirit’s Gift | Animal companion or familiar class feature | Commune with a spirit to grant your animal companion or familiar a shaman spirit augmentation |
...
| Spiritual Guardian | Ability to cast [[Spiritual Weapon (Spell)\|spiritual weapon]] or spiritual ally, spirit magic class feature | Increase the attack power of your spirit spells |
...
| [[Spontaneous Casting (Feat)\|Spontaneous Casting]] | Caster 5th | Swap one prepared spell for another spell on spell list |
| [[Spontaneous Healer (Feat)\|Spontaneous Healer]] | [[Knowledge (Skill)\|Knowledge]] (religion) 4 ranks, nonevil | Swap out your spells for *cure* spells on your list |
| Spontaneous Nature’s Ally | [[Knowledge (Skill)\|Knowledge]] (nature) 5 ranks, ability to spontaneously cast cure or inflict spells, Animal or [[Plant (Domain)\|Plant]] domain | Lose a spell slot to spontaneous cast a *summon nature’s ally* spell of the same level |
| Staff-Like Wand | Craft Staff, wizard 11+ | Use your Int modifier, caster level and relevant feats to set the DC for saves when using a wand |
| Stalker’s Focus | [[Knowledge (Skill)\|Knowledge]] (nature) 3 ranks, [[Survival (Skill)\|Survival]] 3 ranks, no ranks in a class that has the animal focus class feature | Gain an animal focus for you or your animal companion |
| Startling Getaway\* | Startling appearance class feature | Move away after a startling appearance |
| [[Steadfast Loyalty (Feat)\|Steadfast Loyalty]] | — | Gain +2 bonus on Will saving throws against charm, compulsion, and fear effects |
| Steadfast Mind | Cha 15, Int 15, or Wis 15 (see special) | Possibly retain a spell that would be lost when failing a Concentration check while casting defensively |
| Steadfast Personality | — | Gain an insight bonus on saves against mind-affecting effects equal to your Charisma modifier |
| [[Stealthy (Feat)\|Stealthy]] | — | +2 bonus on [[Escape Artist (Skill)\|Escape Artist]] and [[Stealth (Skill)\|Stealth]] checks |
...
| Following Step\* | Dex 13, [[Step Up (Feat)\|Step Up]] | Move up to 10 feet as an immediate action |
...
| Stone-Faced | Dwarf +4 bonus on | [[Bluff (Skill)\|Bluff]] checks to lie or conceal motives |
...
| Street Smarts | — | +2 bonus on [[Knowledge (Skill)\|Knowledge]] (local) and [[Sense Motive (Skill)\|Sense Motive]] checks |
...
| Sense Relationships | Street Smarts | Discern relationship between two people and use it against them |
...
| Stubborn Curse | Ability to cast a spell or spell-like ability with the curse descriptor or a special ability with a curse effect | Creatures roll twice to remove your curses |
| Student of Nature | — | +1 bonus on Handle Animal, Knowledge (nature), and Survival skill checks; also get a +2 bonus on Fortitude saving throws to resist special attacks from plant creatures. |
...
| Sure Grasp | [[Climb (Skill)\|Climb]] 1 rank | When climbing, roll twice and take the highest result |
| Surehand | Base attack bonus +1, Str or Dex 14+ | Use melee weapons one size category larger than you are with a –1 penalty on the attack roll |
| [[Suspicious Eye (Feat)\|Suspicious Eye]] | — | +2 bonus on [[Sense Motive (Skill)\|Sense Motive]] skill checks |
...
| Swipe and Stash\* | [[Sleight of Hand (Skill)\|Sleight of Hand]] 5 ranks | Plant objects on others |
...
| **Feats** | **Prerequisites** | **Benefits** |
|---|---|---|
| [[Tagging (Feat)\|Tagging]] | — | Forego damage to increase critical potential |
...
| [[Tapestry Traveler (Feat)\|Tapestry Traveler]] | Character level 5th | Cast spells of the teleportation subschool as though your caster level were 2 higher |
| Taunt | Cha 13, Small size or smaller | Demoralize opponents with [[Bluff (Skill)\|Bluff]] instead of [[Intimidate (Skill)\|Intimidate]] |
| Telepathy Tap | [[Sense Motive (Skill)\|Sense Motive]] 10 ranks, ability to cast *[[Detect Thoughts (Spell)\|detect thoughts]]* or *telepathy* as a spell or spell-like ability or telepathy supernatural ability | Eavesdrop on telepathic communication |
| Tertiary Domain | Wis 15+, Skill Focus (Knowledge: religion), cleric level 1st+ | Gain a third domain |
...
| Torch Handling | — | In your grasp, a simple torch has multiple uses |
...
| Trap Warden | Any Mark of Finding | Reroll Search or [[Disable Device (Skill)\|Disable Device]] check 1/day; gain a bonus on Reflex saves and to AC against traps |
...
| Truly Favored | Jinnborn, favored racial trait, character level 4th | You can use your favored ability as many times a day equal to your Int, Wis or Cha modifier (your choice; minimum 2 times per day) |
...
| Two Wand Technique | Dex 15, 5 ranks in Spellcraft | Activate one wand in each hand as a single action |
| [[Two-Weapon Fighting (Feat)\|Two-Weapon Fighting]]\* | Dex 15 | Reduce two-weapon fighting penalties |
| Double Bane | Bane class feature, [[Two-Weapon Fighting (Feat)\|Two-Weapon Fighting]] | Apply your bane to a second weapon |
...
| Dual Enhancement | [[Two-Weapon Fighting (Feat)\|Two-Weapon Fighting]]; divine bond (weapon) or sacred weapon class feature | Imbue two weapons with divine bond or sacred weapon instead of just one |
...
| Improved Two-Weapon Feint\* | [[Combat Expertise (Feat)\|Combat Expertise]], [[Improved Two-Weapon Fighting (Feat)\|Improved Two-Weapon Fighting]] | Make a [[Bluff (Skill)\|Bluff]] check instead of your first attack |
| Spear Dancing Style \* | Dex 13, Two-Weapon Fighting, Weapon Focus (with the chosen weapon) | Use polearms and spears as double weapons |
| Spear Dancing Spiral \* | Dex 15, Spear Dancing Style, Two-Weapon Fighting, Weapon Finesse, Weapon Focus (with the chosen weapon) | Wield spears with poise and grace |
| Spear Dancing Reach \* | Dex 17, Spear Dancing Spiral, Spear Dancing Style, Two-Weapon Fighting, Weapon Finesse, Weapon Focus (with the chosen weapon) | Strike from afar with double weapons |
...
| **Feats** | **Prerequisites** | **Benefits** |
|---|---|---|
| Umbral Mark | Any Mark of Shadow | Reroll [[Stealth (Skill)\|Stealth]] check 1/day; chance to negate extra damage from a critical hit or sneak attack |
| [[Unarmored Defense Proficiency (Beginner) (Feat)\|Unarmored Defense Proficiency (Beginner)]] \* | — | Increase your base AC by a bonus based on your level when you are not in armor |
| [[Unarmored Defense Proficiency (Intermediate) (Feat)\|Unarmored Defense Proficiency (Intermediate)]] \* | [[Unarmored Defense Proficiency (Beginner) (Feat)\|Unarmored Defense Proficiency (Beginner)]] | Increase your base AC by a bonus based on your level when you are not in armor |
| [[Unarmored Defense Proficiency (Master) (Feat)\|Unarmored Defense Proficiency (Master)]] \* | [[Unarmored Defense Proficiency (Beginner) (Feat)\|Unarmored Defense Proficiency (Beginner)]], [[Unarmored Defense Proficiency (Intermediate) (Feat)\|Unarmored Defense Proficiency (Intermediate)]] | Increase your base AC by a bonus based on your level when you are not in armor |
| [[Unarmored Specialist (Combat) (Feat)\|Unarmored Specialist]] \* | — | +2 dodge bonus to AC if unarmored |
| [[Improved Unarmored Specialist (Combat) (Feat)\|Improved Unarmored Specialist]] \* | Unarmored Specialist, evasion class feature | Double your Dex bonus to AC if unarmored |
| Unassailable Sanctum | Must have at least one sanctum with at<br>least 5 sanctum points invested in it | While in your sanctum, whenever you make a<br>saving throw, roll twice and take the better<br>result |
| [[Uncanny Activation (Feat)\|Uncanny Activation]] | [[Use Magic Device (Skill)\|Use Magic Device]] 12 ranks | If you exceed the [[Use Magic Device (Skill)\|Use Magic Device]] DC to activate a spell completion or spell trigger item you can increase the item’s caster level for determining the spell’s effect |
| Undead Empathy | Cha 13 Use | [[Diplomacy (Skill)\|Diplomacy]] to influence undead |
...
| Unsettling Enchantment | [[Spell Focus (Feat)\|Spell Focus]] (enchantment) or enchanter level 1st | Enchantment spells hinder foe's attacks and defense |
...
| [[Versatile Spontaneity (Feat)\|Versatile Spontaneity]] | Int 13 or Wis 13, ability to spontaneously cast 2nd-level spells | You may opt to prepare one spell you don’t know in place of a daily spell slot 1 level higher than the prepared spell’s level |
| Vigilant Phantom | Phantom class feature | +4 on [[Perception (Skill)\|Perception]] checks within arm’s reach of active phantom |
| [[Vital Strike (Feat)\|Vital Strike]]\* | Base attack bonus +6 | Deal twice the normal damage on a single attack |
| Devastating Strike\* | [[Vital Strike (Feat)\|Vital Strike]], base attack bonus +9 | Deal extra damage when using [[Vital Strike (Feat)\|Vital Strike]] bonus |
| Improved Devastating Strike | Devastating Strike, base attack bonus +13 | Gain bonus on rolls to confirm critical hits |
| Faerie’s Strike\* | Nature Magic or the ability to cast druid or ranger spells; [[Vital Strike (Feat)\|Vital Strike]], [[Knowledge (Skill)\|Knowledge]] (nature) 5 ranks | Illuminate foes with [[Vital Strike (Feat)\|Vital Strike]] |
| Furious Finish | Rage class feature, [[Vital Strike (Feat)\|Vital Strike]], base attack bonus +6 | Deal maximum damage and end your rage |
| Grasping Strike\* | Nature Magic or the ability to cast druid or ranger spells; [[Vital Strike (Feat)\|Vital Strike]] | Entangle those you hit with [[Vital Strike (Feat)\|Vital Strike]] |
| [[Improved Vital Strike (Feat)\|Improved Vital Strike]]\* | [[Vital Strike (Feat)\|Vital Strike]], base attack bonus +11 | Deal three times the normal damage on a single attack |
| [[Greater Vital Strike (Feat)\|Greater Vital Strike]]\* | [[Improved Vital Strike (Feat)\|Improved Vital Strike]], base attack bonus +16 | Deal four times the normal damage on a single attack |
| Winter’s Strike\* | Nature Magic or the ability to cast druid or ranger spells; [[Vital Strike (Feat)\|Vital Strike]], [[Knowledge (Skill)\|Knowledge]] (nature) 5 ranks | Target of your [[Vital Strike (Feat)\|Vital Strike]] must successfully save or become [[Fatigued\|fatigued]] |
...
| **Feats** | **Prerequisites** | **Benefits** |
|---|---|---|
| Wand Adept | Ability to cast 2nd‐level spells, or Use Magic Device 5 ranks | Your caster level is increased for the purposes of spells cast from wands |
| Wand Master | Wand Adept | The saving throw DCs of spells you cast from wands are increased |
| [[Wand Bonding (Feat)\|Wand Bonding]] | [[Warforged (Race)\|Warforged]], ability to spontaneously cast arcane spells or infusions | Sacrifice an arcane spell slot or infusion slot of the level of the spell to be cast from the wand (or a higher level) instead of using one of the charges in the wand |
...
| Opportunistic Wand | Wand Parry | You can make attacks of opportunity with wands to deliver spells |
...
| Warden Initiate | Ability to spontaneously cast *summon nature’s ally* | +2 deflection bonus to AC, add spells to spell list, add [[Climb (Skill)\|Climb]] and [[Jump (Spell)\|Jump]] as class skills |
| Mark of the Wilderness | Warden Initiate, any true dragonmark | Ignore movement penalties caused by difficult terrain |
| [[Water Rat (Feat)\|Water Rat]] | — | +2 bonus on [[Swim (Skill)\|Swim]] checks |
| Wave Strike\* | Weapon expertise class feature or [[Quick Draw (Feat)\|Quick Draw]], [[Bluff (Skill)\|Bluff]] 1 rank | Spend a swift action to make a [[Bluff (Skill)\|Bluff]] check to feint |
...
| Canny Strike | Int 13, Clever Fighting, Weapon Finesse, base attack bonus +6 | Intelligence modifier increases damage from Clever Fighting |
...
| Enable Critical | Weapon Finesse or Weapon Focus | Choose one type of creature that is normally immune to critical hits (construct, elemental, ooze, plant, undead); you can now score critical hits against that type of creature |
...
| Piranha Strike \* | Weapon Finesse, base attack bonus +1 | Trade melee attack bonus for damage |
| Slashing Grace\* | Dex 13, [[Weapon Finesse (Feat)\|Weapon Finesse]], [[Weapon Focus (Feat)\|Weapon Focus]] with selected weapon | Treat a one-handed slashing weapon as a piercing melee weapon |
| [[Weapon Focus (Feat)\|Weapon Focus]]\* | Proficiency with weapon, base attack bonus +1 | +1 bonus on attack rolls with one weapon |
| Crossbow Sniper | Proficiency with hand, heavy, or light crossbow, Weapon Focus with hand, heavy, or light crossbow, base attack bonus +1 | Half Dexterity bonus on crossbow damage, 60 ft. skirmish or sneak attack |
| Crusader’s Flurry | Channel energy and flurry of blows class feature, [[Weapon Focus (Feat)\|Weapon Focus]] with deity’s favored weapon | May use flurry of blows with deity’s favored melee weapon |
...
| Brutal Coup de Grace\* | [[Dazzling Display (Feat)\|Dazzling Display]], [[Weapon Focus (Feat)\|Weapon Focus]], base attack bonus +5, proficiency with the selected weapon | Successful coup de grace disheartens nearby enemies |
| Disheartening Display\* | [[Dazzling Display (Feat)\|Dazzling Display]], [[Weapon Focus (Feat)\|Weapon Focus]], base attack bonus +6, proficiency with selected weapon | Use [[Dazzling Display (Feat)\|Dazzling Display]] to increase a fear effect |
| Gory Finish\* | [[Dazzling Display (Feat)\|Dazzling Display]], [[Weapon Focus (Feat)\|Weapon Focus]] | Make an [[Intimidate (Skill)\|Intimidate]] check if you reduce an opponent to negative hit points |
| Intimidating Bane | Bane class feature, [[Dazzling Display (Feat)\|Dazzling Display]], character level 8th | Gain +2 bonus on [[Dazzling Display (Feat)\|Dazzling Display]] while bane is active |
| Notorious Vigilante\* | [[Dazzling Display (Feat)\|Dazzling Display]], [[Weapon Focus (Feat)\|Weapon Focus]], any nongood alignment, great renown social talent, proficiency with chosen weapon | Use [[Dazzling Display (Feat)\|Dazzling Display]] as a standard action based on your reputation alone |
...
| Fencing Grace\* | Dex 13, [[Weapon Finesse (Feat)\|Weapon Finesse]], [[Weapon Focus (Feat)\|Weapon Focus]] (rapier) | Use Dexterity on rapier damage rolls |
...
| Performing Combatant\* | [[Dazzling Display (Feat)\|Dazzling Display]], any one Performance feat | Can make combat performance checks in any combat |
...
| Prone Shooter\* | [[Weapon Focus (Feat)\|Weapon Focus]] (crossbow or firearm), base attack bonus +1 | May ignore penalties for shooting while prone |
| Ranged Study | [[Weapon Focus (Feat)\|Weapon Focus]] with chosen weapon, studied combat class feature | Choose a ranged weapon and use studied combat with that weapon |
| Spear Dancer \* | Weapon Focus (any two-handed reach weapon), Perform (dance) 4 ranks | When you hit a creature with a two-handed reach weapon they are dazzled for 1 round |
| Spear Wind \* | Elf, Dex 13, Weapon Focus (any spear), base attack bonus +4 | Make one extra attack per round; all attacks take a -3 penalty |
| Spear Wind Mastery \* | Elf, Dex 13, Spear Wind, Weapon Focus (any spear), base attack bonus +8 | +2 dodge bonus to AC when using Spear Wind feat with the full attack action |
| Stage Combatant\* | [[Weapon Focus (Feat)\|Weapon Focus]], base attack bonus +5 | Take no penalty to deal nonlethal damage |
| Starry Grace\* | Dex 13, [[Weapon Finesse (Feat)\|Weapon Finesse]], [[Weapon Focus (Feat)\|Weapon Focus]] (starknife) | Use Dexterity on starknife damage rolls |
| Weapon of the Chosen \* | [[Weapon Focus (Feat)\|Weapon Focus]] with deity’s favored weapon, worship and receive spells from a deity | As a swift action, your first attack with weapon counts as magical |
...
| Melee Weapon Mastery | Proficiency with selected weapon, Weapon Focus with selected weapon, Weapon Specialization with selected weapon, base attack bonus +8 | Gain Weapon Focus, Weapon Specialization benefits with multiple weapons |
...
| [[Point Blank Master (Feat)\|Point Blank Master]] | [[Weapon Specialization (Feat)\|Weapon Specialization]] with a ranged weapon | Do not provoke attacks of opportunity while firing one ranged weapon |
...
| Whip Mastery\* | [[Weapon Focus (Feat)\|Weapon Focus]] (whip), base attack bonus +2 | Using a whip does not provoke attacks of opportunity |
...
| Whirling Steel Strike | [[Martial Weapon Proficiency (Feat)\|Martial Weapon Proficiency]] (longsword), [[Weapon Focus (Feat)\|Weapon Focus]] (longsword), flurry of blows | Treat longsword as monk weapon |
| Willing Accomplice | Cha 13, [[Bluff (Skill)\|Bluff]] 3 ranks, [[Sense Motive (Skill)\|Sense Motive]] 1 rank | Use [[Bluff (Skill)\|Bluff]] to aid ally’s [[Disguise (Skill)\|Disguise]] |
...
| [[Wormbound (Feat)\|Wormbound]] | Living creature, host a living Kyuss worm | Take a vile green Kyuss worm into your own body and bind yourself to its power; add spells to your spell list if you are a spellcaster |
...
| **Feats** | **Prerequisites** | **Benefits** |
|---|---|---|
| Xenoglossy | Int 13, [[Linguistics (Skill)\|Linguistics]] 3 ranks | Use [[Linguistics (Skill)\|Linguistics]] to communicate with creatures with which you don’t share a language |
...
'Feat rolling' is the practice of retraining a feat that one already has after acquiring or creating a magic item that bestows that same feat thus freeing up a feat slot. It follows retraining a feat as outlined above with a single difference: it does not require retraining with a character if it is done whenever a character acquires a new feat by leveling.
...
---
## Tags
#Sources/PF-Core-Rulebook #Publisher/Paizo #Rule/Core #Rule-System/Pathfinder
