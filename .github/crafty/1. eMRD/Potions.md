...
| |  |  | **Spell** <br>**Level** | **Caster**<br>**Level** |
|---|---|---|---|---|
| **Minor** | **Medium** | **Major** |
| 01–20 | — | — | 0 | 1st |
| 21–60 | 01–20 | — | 1st | 1st |
...
| **Spell** <br>**Level** | **Cleric,**<br>**Druid,** <br>**Wizard** | **Sorcerer** | **Bard** | **Paladin,**<br>**Ranger** |
|---|---|---|---|---|
| 0 | 25 gp | 25 gp | 25 gp | — |
...
**Identifying Potions**: In addition to the standard methods of identification, PCs can sample from each container they find to attempt to determine the nature of the liquid inside with a [[Perception (Skill)|Perception]] check. The DC of this check is equal to 15 + the spell level of the potion (although this DC might be higher for rare or unusual potions).
...
**Source:** PF Core Rulebook, pg. 477-478

The following table includes spells that are appropriate for making into potions as well as their price (for convenience):


| **Potion or Oil** | **Market Price** | **Source** |
|---|---|---|
| *Absorb weapon* (oil) | 750 gp | Complete Adventurer (WotC) 130 |
| *Entangling staff* (oil) | 750 gp | Complete Adventurer (WotC) 130 |
| *Exacting shot* (oil) | 100 gp | Complete Adventurer (WotC) 130 |
| *Healthful rest* (potion) | 50 gp | Complete Adventurer (WotC) 130 |
| *Iron silence* (oil) | 300 gp | Complete Adventurer (WotC) 130 |
| *Nature’s favor* (potion) | 300 gp | Complete Adventurer (WotC) 130 |
| *Sonic weapon* (oil) | 300 gp | Complete Adventurer (WotC) 130 |
| *Train animal* (potion) | 300 gp | Complete Adventurer (WotC) 130 |
| |  |  |


---
## Tags
#Sources/PF-Core-Rulebook #Rule-System/Pathfinder #Special-Item-Type/Magic-Item #Rule/Core #Publisher/Paizo #Rule/OGL
