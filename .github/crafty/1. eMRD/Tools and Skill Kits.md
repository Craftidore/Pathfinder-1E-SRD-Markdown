...
| Astrolabe | 100 gp | 6 lbs. | Pirates of the Inner Sea 19 |
...
| Nautical chart | 25 gp | — | Pirates of the Inner Sea 20 |
| Scale, merchant’s | 2 gp | 1 lb. | PF Core Rulebook |
| Spell component pouch | 5 gp | 2 lbs. | PF Core Rulebook |
| Sextant | 500 gp | 2 lbs. | Pirates of the Inner Sea 20 |
...
**Magnifying Glass**: This simple lens allows a closer look at small objects. It is also useful as a substitute for f lint an dsteel when starting fires. Lighting a fire with a magnifying glass requires bright light, such as sunlight to focus, tinder to ignite, and at least a full-round action.
