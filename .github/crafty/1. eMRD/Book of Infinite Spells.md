...
The *book of infinite spells* can be destroyed when the current page contains the *[[Erase (Spell)|erase]]* spell, by casting the spell on the book itself.

**Source:** PF Core Rulebook, pg. 543


---
## Tags
#Rule-System/Pathfinder #Price-Band/16-001--gp #Special-Item-Type/Artifact #Magic-Item-Slot/None #Sources/PF-Core-Rulebook #Publisher/Paizo #Rule/Core
