...
To qualify to become a thrall of Juiblex, a character must fulfill
...
2nd +2 +3 +3 +3 Corrosive touch

3rd +3 +3 +3 +3 Summon ooze

4th +4 +4 +4 +4 Contagion, alter self

5th +5 +4 +4 +4 Summon minor demon

6th +6 +5 +5 +5 Corrosive spew

7th +7 +5 +5 +5 Summon pudding

8th +8 +6 +6 +6 Polymorph self

9th +9 +6 +6 +6 Summon major demon

10th +10 +7 +7 +7 No discernible anatomy
...
well as the damage from the slime. Because of the corrosive

slime, this attack is not considered unarmed and does
...
Alter Self (Su): At 4th level, a thrall of Juiblex’s form
...
as a summon monster spell cast by a 15th-level caster.
...
saving throw (DC 10 + thrall’s class level + thrall’s Con
...
of Juiblex’s form is so amorphous that it no longer need
