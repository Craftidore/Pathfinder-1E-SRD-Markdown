...
**Class Skills:** An ancient lorekeeper adds [[Knowledge (Skill)|Knowledge]] (arcane) and [[Knowledge (Skill)|Knowledge]] (local) to her list of class skills. Whenever she makes a [[Knowledge (Skill)|Knowledge]] check of any kind about a question regarding elves (creatures of the elf subtype), the ancient lorekeeper adds half her class level on her check. This replaces the bonus skills the ancient lorekeeper gains from her mystery.
