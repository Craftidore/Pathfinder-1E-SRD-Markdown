...
The ten new classes presented in this book are all hybrids of two existing classes from the *Pathfinder RPG Core Rulebook, Pathfinder RPG Advanced Player’s Guide*, and *Pathfinder RPG Ultimate Combat*. The new classes are as follows.
