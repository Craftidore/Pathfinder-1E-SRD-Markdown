...
*Master Mariner (Su):* At 8th level, a Poleiheira adherent can telekinetically control a boat or ship with such skill and finesse that she counts as a number of people equal to her wizard level for the purpose of determining how many crew members are needed to move a water vehicle (*Pathfinder RPG Ultimate Combat* 174). When controlling a ship in this manner, she can substitute [[Spellcraft (Skill)|Spellcraft]] checks for [[Profession (Skill)|Profession]] (sailor) checks. 

**Source:** Blood of the Ancients, pg. 18

Spells and things for books

*[[Amanuensis (Spell)|amanuensis]]*
...
---
## Tags
#Rule-System/Pathfinder #Publisher/Paizo #Rule/Core #Rule/Archetype #Rule/Wizard #Rule/fm3 #Sources/Blood-of-the-Ancients
