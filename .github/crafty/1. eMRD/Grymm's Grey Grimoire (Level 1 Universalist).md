...
RWtopicId: "Topic_17011"
---
# Grymm's Grey Grimoire (Level 1 Universalist)
## Overview
*This is a simple, unadorned spellbook, its pages made of the finest vellum.*
...
*3rd—ablative sphere, blink, create soul gem, deep slumber, detect ship, gentle repose, heroism, mass snake's swiftness, sepia snake sigil, silvered weapon, siphon, slow, stinking cloud,* 

*2nd—beast claws, daggerspell stance, darkness, know weakness, obscure object, phantom trap, repair moderate damage, scintillating scales, shatter, silent table, torc of the pharaoh,* 
...
*3rd—alter fortune, anticipate teleportation, arcane seal, arcane sight, augment object, battlemagic perception, clairaudience/clairvoyance, cloak of illusion, daylight, detect curse, dispel magic, fireball, fly, gaseous form, haste, heart of water, hide in the dark, hold person, illusory script, improved arcane lock, invisibility sphere, lesser craftsmanship, lesser delay teleportation, lightning bolt, masking aura, mind poison, nondetection, phantom steed, repair serious damage, ring of blades, secluded grimoire, secret page, sharing the ancient lore, shrink item, siphon, slow, tiny hut, tongues, twilight knife, unluck,*

2nd—*acid arrow, aiming at the target, arcane lock, attentive alarm, blindness/deafness, blur, cat nap, create treasure map, dagger swarm, darkness, darkvision, detect thoughts, false life, fog cloud, glitterdust, greater alarm, heart of air, investigative mind, invisibility, keen edge, knock, lesser celerity, lesser mind stasis, levitate, locate object, magic mouth, magician's workshop, make whole, masterwork transformation, mirror hideaway, mirror image, mystic surge, power craft, protection from arrows, resist energy, rope trick, scorching ray, see invisibility, smoke conduit, snake's swiftness, soul blast, spectral hand, spider climb, summon swarm, suppress magic, tattoo potion, touch of idiocy, web, whirling weapon, whispercast, whispering wind, wings of cover*

1st—*abundant ammunition, alarm, ancient knowledge, animate tattoo, anticipated attack, appraising touch, arcane sensitivity, burning hands, buzzing bee, charm person, color spray, combat precognition, crafter's fortune, crafter's gift, critical strike, darklight, delay image, detect undead, discern next of kin, disguise self, endure elements, enlarge person, erase, expeditious retreat, feather fall, floating disk, gravity bow, grease, guide craft, handy grapnel, helpful hand, hidden ward, hold portal, identify, infernal healing, instant knowledge, instant locksmith, instant search, ironpage, mage armor, lesser deflect, lesser recharge innate magic, line in the sand, lock gaze, long arm, mage clock, magecraft, magic aura, magic missile, memorize page, metamorphose liquids, minor image, mistsight, nerveskitter, nightshield, obscuring mist, persistent blade, phantom worker, protection from chaos, protection from evil, protection from good, protection from law, ray of clumsiness, ray of enfeeblement, repair light damage, restful sleep, scales of the lizard, scholar's touch, secluded grimoire, shield, shocking grasp, silent image, sleep, spell flower, spirit shape, stunning barrier, tireless, transmute coinage to gem, true casting, true skill, true strike, unseen servant, unseen crafter, vanish, ventriloquism, waterproof, windy escape, wings of swift flying,*

Feats, spells and other things to make it better

Add crafting feats (as well as others) to it as enchantments (cf. the Project rule):


| Abbreviated Spellscript | 1 spell per page |  |
|---|---|---|
| |  |  |
| |  |  |
| |  |  |
...
| 1st: | Spell Mastery > Adept Mastery > Flexible Wizardry > Improved Flexible Wizardry > Signature Spell > Uncanny Forethought |
|---|---|
| bonus: | Scribe Scroll > Alacritous Cogitation > Craft Magic Arms and Armor > Brew Potion |
| flaw: | Collegiate Wizard > Arcane Understanding > Craft Anywhere > |
| flaw: | Mind Over Body > Mental Fortitude > Long Days > Extra Use > |
| flaw (antihero): | Arcane Craftsman (25% cost) > Frugal Crafting > Torchbearer > Extend Spell > Lasting Spell |
| flaw (racial): | Unarmored Defense Proficiency (beginner) > Unarmored Defense Proficiency (Intermediate) > Unarmored Defense Proficiency (Master) |
| archetype: | Craft Wondrous Item (item creation) > Arcane Master Craftsman (+50% reduction in cost) > Legendary Trait > |
| 3rd: | Legendary > Combat Reflexes > Mental Combatant > Improved Initiative |
| bonus: | Extraordinary Artisan (reduce cost 25%) > Extraordinary Artisan (reduce time 25%)  > Spell Thematics |
| 5th: | Improved Arcane Bond > Ioun Bond > Deep Bond (object) > Second Bond > |
...
**Traits:** * Pragmatic Activator,***** *Spark of Creation, Windfall*
...
**Flaws:**
   ...
   Noncombatant (-2 to hit in melee)

**Drawbacks:**

   Xenophobic (-2 penalty on Diplomacy and Sense Motive checks)

**Feats/Virtual Feats (gained through items):** Arcane Craftsman (cost and time), Arcane Master Craftsman (*purple shard ioun stone)*, Collegiate Wizard *(cerulean blue cylinder ioun stone)*, Combat Reflexes (*argent spindle ioun stone*), Craft Anywhere (*purple disc ioun stone*), Craft Construct, Craft Magic Arms and Armor, Craft Wondrous Item (*purple cube ioun stone*), Extraordinary Artisan (cost and time) (*purple isocagon ioun stone)*, Fast Item Creation (*purple octahedron ioun stone*), Frugal Crafting *(purple scalahedron ioun stone)*, Master Artificer (*purple ovoid ioun stone*), Mental Fortitude (argent sphere ioun stone), Mercantile Background (*golden anhedron ioun stone*), Mind Over Body (*argent ovoid ioun stone)*, Scribe Scroll *(purple spindle ioun stone),* Spell Mastery* (light green anhedron ioun stone),* Swift Crafting *(purple briolette ioun stone),* Unarmored Defense Proficiency (intermediate) (*teal ovoid ioun stone)*, 

*Find/add spellbook enchantments*


---
## Tags
#Rule/Spellbook #Rule-System/Pathfinder #Rule/OGL #Rule/3PP #Publisher/Mage-s-Tower #Rule/fm3
