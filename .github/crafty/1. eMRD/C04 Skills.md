...
Since taking 20 assumes that your character will fail many times before succeeding, your character would automatically incur any penalties for failure before he or she could complete the task (hence why it is generally not allowed with skills that carry such penalties). Common “take 20” skills include [[Disable Device (Skill)|Disable Device]] (when used to open locks), [[Escape Artist (Skill)|Escape Artist]], and [[Perception (Skill)|Perception]] (when attempting to find traps).
...
*Armor Check Penalty:* If this notation is included in the skill name line, an armor check penalty applies (see Chapter 6 of the* PF Core Rulebook*) to checks using this skill. If this entry is absent, an armor check penalty does not apply.
...
**Try Again:** Any conditions that apply to successive attempts to use the skill successfully. If the skill doesn’t allow you to attempt the same task more than once, or if failure carries an inherent penalty (such as with the [[Climb (Skill)|Climb]] skill), you can’t take 20. If this paragraph is omitted, the skill can be retried without any inherent penalty other than the additional time required.
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| [[Acrobatics (Skill)\|Acrobatics]] | C | C | — | — | — | C | — | — | C | — | — | Yes | Dex\* |
| [[Appraise (Skill)\|Appraise]] | — | C | C | — | — | — | — | — | C | C | C | Yes | Int |
| [[Bluff (Skill)\|Bluff]] | — | C | — | — | — | — | — | — | C | C | — | Yes | Cha |
| [[Climb (Skill)\|Climb]] | C | C | — | C | C | C | — | C | C | — | — | Yes | Str\* |
| [[Craft (Skill)\|Craft]] | C | C | C | C | C | C | C | C | C | C | C | Yes | Int |
| [[Diplomacy (Skill)\|Diplomacy]] | — | C | C | — | — | — | C | — | C | — | — | Yes | Cha |
| [[Disable Device (Skill)\|Disable Device]] | — | — | — | — | — | — | — | — | C | — | — | No | Dex\* |
| [[Disguise (Skill)\|Disguise]] | — | C | — | — | — | — | — | — | C | — | — | Yes | Cha |
| [[Escape Artist (Skill)\|Escape Artist]] | — | C | — | — | — | C | — | — | C | — | — | Yes | Dex\* |
| [[Fly (Skill)\|Fly]] | — | — | — | C | — | — | — | — | — | C | C | Yes | Dex\* |
| [[Handle Animal (Skill)\|Handle Animal]] | C | — | — | C | C | — | C | C | — | — | — | No | Cha |
| [[Heal (Spell)\|Heal]] | — | — | C | C | — | — | C | C | — | — | — | Yes | Wis |
| [[Intimidate (Skill)\|Intimidate]] | C | C | — | — | C | C | — | C | C | C | — | Yes | Cha |
| [[Knowledge (Domain)\|Knowledge]] (arcana) | — | C | C | — | — | — | — | — | — | C | C | No | Int |
| [[Knowledge (Domain)\|Knowledge]] (dungeoneering) | — | C | — | — | C | — | — | C | C | — | C | No | Int |
| [[Knowledge (Domain)\|Knowledge]] (engineering) | — | C | — | — | C | — | — | — | — | — | C | No | Int |
| [[Knowledge (Domain)\|Knowledge]] (geography) | — | C | — | C | — | — | — | C | — | — | C | No | Int |
| [[Knowledge (Domain)\|Knowledge]] (history) | — | C | C | — | — | C | — | — | — | — | C | No | Int |
| [[Knowledge (Domain)\|Knowledge]] (local) | — | C | — | — | — | — | — | — | C | — | C | No | Int |
| [[Knowledge (Domain)\|Knowledge]] (nature) | C | C | — | C | — | — | — | C | — | — | C | No | Int |
| [[Knowledge (Domain)\|Knowledge]] (nobility) | — | C | C | — | — | — | C | — | — | — | C | No | Int |
| [[Knowledge (Domain)\|Knowledge]] (planes) | — | C | C | — | — | — | — | — | — | — | C | No | Int |
| [[Knowledge (Domain)\|Knowledge]] (religion) | — | C | C | — | — | C | C | — | — | — | C | No | Int |
...
| [[Ride (Skill)\|Ride]] | C | — | — | C | C | C | C | C | — | — | — | Yes | Dex\* |
| [[Sense Motive (Skill)\|Sense Motive]] | — | C | C | — | — | C | C | — | C | — | — | Yes | Wis |
| [[Sleight of Hand (Skill)\|Sleight of Hand]] | — | C | — | — | — | — | — | — | C | — | — | No | Dex\* |
| [[Spellcraft (Skill)\|Spellcraft]] | — | C | C | C | — | — | C | C | — | C | C | No | Int |
| [[Stealth (Skill)\|Stealth]] | — | C | — | — | — | C | — | C | C | — | — | Yes | Dex\* |
| [[Survival (Skill)\|Survival]] | C | — | — | C | C | — | — | C | — | — | — | Yes | Wis |
| [[Swim (Skill)\|Swim]] | C | — | — | C | C | C | — | C | C | — | — | Yes | Str\* |
| [[Use Magic Device (Skill)\|Use Magic Device]] | — | C | — | — | — | — | — | — | C | C | — | No | Cha |
