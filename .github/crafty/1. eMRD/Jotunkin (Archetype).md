...
A jotunkin can end his jotunrage as a free action and is [[Fatigued|fatigued]] after rage for a number of rounds equal to 2 times the number of rounds spent in the jotunrage. A jotunkin cannot enter a new rage while [[Fatigued|fatigued]] or [[Exhausted|exhausted]] but can otherwise enter rage multiple times during a single encounter or combat. If a jotunkin falls [[Unconscious|unconscious]], his jotunrage immediately ends, placing him in peril of death.

Jotunrage does not stack with magical effects that increase size.

This ability replaces rage.

**Fear’s Friend (Ex):** At 3rd level, a jotunkin gains a +1 competence bonus to [[Intimidate (Skill)|Intimidate]] checks. These bonuses increase by +1 every three jotunkin levels thereafter (6th, 9th, 12th, 15th, and 18th level). The jotunkin also receives an insight bonus to saves against fear effects equal to one-half the competence bonus to [[Intimidate (Skill)|Intimidate]] checks (drop fractions).

This ability replaces [[S3.1D-F - Universal Monster Rules D-F (Bestiary 6 Apx)|damage reduction]].
...
---
## Tags
#Rule/3PP #Rule-System/Pathfinder #Rule/Archetype #Rule/Barbarian #Publisher/Spes-Magna-Games
