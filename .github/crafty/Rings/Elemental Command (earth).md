...
*[[Meld Into Stone (Spell)|Meld into stone]]* (unlimited use, wearer only)

*[[Soften Earth and Stone (Spell)|Soften earth and stone]]* (unlimited use)

*[[Stone Shape (Spell)|Stone shape]]* (twice per day)

*[[Stoneskin (Spell)|Stoneskin]]* (once per week, wearer only)

*[[Passwall (Spell)|Passwall]]* (twice per week)

*[[Wall of Stone (Spell)|Wall of stone]]* (once per day)

The ring appears to be a *ring of meld into stone* (allowing the wearer to cast *[[Meld Into Stone (Spell)|meld into stone]]* at will) until the established condition is met.

**Construction**

**Requirements** [[Forge Ring (Feat)|Forge Ring]], *[[Summon Monster VI (Spell)|summon monster VI]]*, all appropriate spells

**Cost** 100,000 gp

**Source:** Core Rulebook, pg. 479-480
