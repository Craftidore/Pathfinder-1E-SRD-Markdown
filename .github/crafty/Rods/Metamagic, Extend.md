...
The wielder can cast up to three spells (from 1st to 6th level) per day that are extended as though using the [[Extend Spell (Feat)|Extend Spell]] feat.

**Construction**

**Requirements** [[Craft Rod (Feat)|Craft Rod]], [[Extend Spell (Feat)|Extend Spell]]
